...
func (f *jsiiProxy_FsxOntapStorageVirtualMachineEndpointsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FsxOntapStorageVirtualMachineEndpointsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
