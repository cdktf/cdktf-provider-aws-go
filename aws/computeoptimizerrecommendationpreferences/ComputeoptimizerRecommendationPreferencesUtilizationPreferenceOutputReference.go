...
func (c *jsiiProxy_ComputeoptimizerRecommendationPreferencesUtilizationPreferenceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeoptimizerRecommendationPreferencesUtilizationPreferenceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
