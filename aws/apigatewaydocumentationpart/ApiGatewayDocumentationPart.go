...
func (j *jsiiProxy_ApiGatewayDocumentationPart) DocumentationPartId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"documentationPartId",
...
func (j *jsiiProxy_ApiGatewayDocumentationPart) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ApiGatewayDocumentationPart) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/api_gateway_documentation_part aws_api_gateway_documentation_part} Resource.
...
func (j *jsiiProxy_ApiGatewayDocumentationPart)SetRegion(val *string) {
...
func (a *jsiiProxy_ApiGatewayDocumentationPart) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
