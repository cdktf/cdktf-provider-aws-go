...
func (d *jsiiProxy_DataAwsOrganizationsDelegatedServicesDelegatedServicesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsOrganizationsDelegatedServicesDelegatedServicesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
