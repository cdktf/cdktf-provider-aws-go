...
func (t *jsiiProxy_TranscribeLanguageModelInputDataConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TranscribeLanguageModelInputDataConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
