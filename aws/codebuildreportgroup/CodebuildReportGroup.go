...
func (j *jsiiProxy_CodebuildReportGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CodebuildReportGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/codebuild_report_group aws_codebuild_report_group} Resource.
...
func (j *jsiiProxy_CodebuildReportGroup)SetRegion(val *string) {
...
func (c *jsiiProxy_CodebuildReportGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
