...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/macie2member/internal"
...
func (m *jsiiProxy_Macie2MemberTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_Macie2MemberTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
