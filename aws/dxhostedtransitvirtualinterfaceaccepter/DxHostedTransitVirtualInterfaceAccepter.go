...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/dx_hosted_transit_virtual_interface_accepter aws_dx_hosted_transit_virtual_interface_accepter}.
...
func (j *jsiiProxy_DxHostedTransitVirtualInterfaceAccepter) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DxHostedTransitVirtualInterfaceAccepter) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/dx_hosted_transit_virtual_interface_accepter aws_dx_hosted_transit_virtual_interface_accepter} Resource.
...
func (j *jsiiProxy_DxHostedTransitVirtualInterfaceAccepter)SetRegion(val *string) {
...
func (d *jsiiProxy_DxHostedTransitVirtualInterfaceAccepter) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
