...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/resources/emr_security_configuration aws_emr_security_configuration}.
...
func (j *jsiiProxy_EmrSecurityConfiguration) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_EmrSecurityConfiguration) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/resources/emr_security_configuration aws_emr_security_configuration} Resource.
...
func (j *jsiiProxy_EmrSecurityConfiguration)SetRegion(val *string) {
...
func (e *jsiiProxy_EmrSecurityConfiguration) ResetRegion() {
	_jsii_.InvokeVoid(
		e,
		"resetRegion",
		nil, // no parameters
