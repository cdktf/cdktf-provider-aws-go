...
func (j *jsiiProxy_RedshiftserverlessNamespace) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_RedshiftserverlessNamespace) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/redshiftserverless_namespace aws_redshiftserverless_namespace} Resource.
...
func (j *jsiiProxy_RedshiftserverlessNamespace)SetRegion(val *string) {
...
func (r *jsiiProxy_RedshiftserverlessNamespace) ResetRegion() {
	_jsii_.InvokeVoid(
		r,
		"resetRegion",
		nil, // no parameters
