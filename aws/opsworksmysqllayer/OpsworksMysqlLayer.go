...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v20/opsworksmysqllayer/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/opsworks_mysql_layer aws_opsworks_mysql_layer} Resource.
...
func OpsworksMysqlLayer_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateOpsworksMysqlLayer_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (o *jsiiProxy_OpsworksMysqlLayer) AddMoveTarget(moveTarget *string) {
