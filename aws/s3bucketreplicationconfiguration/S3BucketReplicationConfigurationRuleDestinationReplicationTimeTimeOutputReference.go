...
func (j *jsiiProxy_S3BucketReplicationConfigurationRuleDestinationReplicationTimeTimeOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRuleDestinationReplicationTimeTimeOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRuleDestinationReplicationTimeTimeOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRuleDestinationReplicationTimeTimeOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewS3BucketReplicationConfigurationRuleDestinationReplicationTimeTimeOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) S3BucketReplicationConfigurationRuleDestinationReplicationTimeTimeOutputReference {
	...
	if err := validateNewS3BucketReplicationConfigurationRuleDestinationReplicationTimeTimeOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRuleDestinationReplicationTimeTimeOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRuleDestinationReplicationTimeTimeOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (s *jsiiProxy_S3BucketReplicationConfigurationRuleDestinationReplicationTimeTimeOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_S3BucketReplicationConfigurationRuleDestinationReplicationTimeTimeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_S3BucketReplicationConfigurationRuleDestinationReplicationTimeTimeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_S3BucketReplicationConfigurationRuleDestinationReplicationTimeTimeOutputReference) ToString() *string {
	var returns *string
