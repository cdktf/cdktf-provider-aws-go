...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/dataawscognitouserpoolsigningcertificate/internal"
...
func (j *jsiiProxy_DataAwsCognitoUserPoolSigningCertificate) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsCognitoUserPoolSigningCertificate) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsCognitoUserPoolSigningCertificate)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsCognitoUserPoolSigningCertificate) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
