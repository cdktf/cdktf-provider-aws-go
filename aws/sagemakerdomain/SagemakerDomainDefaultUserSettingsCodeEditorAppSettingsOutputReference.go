...
type SagemakerDomainDefaultUserSettingsCodeEditorAppSettingsOutputReference interface {
	...
	AppLifecycleManagementInput() *SagemakerDomainDefaultUserSettingsCodeEditorAppSettingsAppLifecycleManagement
	...
	CustomImage() SagemakerDomainDefaultUserSettingsCodeEditorAppSettingsCustomImageList
...
func (j *jsiiProxy_SagemakerDomainDefaultUserSettingsCodeEditorAppSettingsOutputReference) AppLifecycleManagementInput() *SagemakerDomainDefaultUserSettingsCodeEditorAppSettingsAppLifecycleManagement {
...
func (j *jsiiProxy_SagemakerDomainDefaultUserSettingsCodeEditorAppSettingsOutputReference) CustomImage() SagemakerDomainDefaultUserSettingsCodeEditorAppSettingsCustomImageList {
	var returns SagemakerDomainDefaultUserSettingsCodeEditorAppSettingsCustomImageList
	_jsii_.Get(
		j,
		"customImage",
		&returns,
...
func (j *jsiiProxy_SagemakerDomainDefaultUserSettingsCodeEditorAppSettingsOutputReference) CustomImageInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"customImageInput",
...
func (s *jsiiProxy_SagemakerDomainDefaultUserSettingsCodeEditorAppSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerDomainDefaultUserSettingsCodeEditorAppSettingsOutputReference) PutCustomImage(value interface{}) {
...
func (s *jsiiProxy_SagemakerDomainDefaultUserSettingsCodeEditorAppSettingsOutputReference) ResetCustomImage() {
	_jsii_.InvokeVoid(
		s,
		"resetCustomImage",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerDomainDefaultUserSettingsCodeEditorAppSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
