...
func (c *jsiiProxy_CodegurureviewerRepositoryAssociationRepositoryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodegurureviewerRepositoryAssociationRepositoryOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
