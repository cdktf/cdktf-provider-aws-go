...
func (s *jsiiProxy_SecurityhubInsightFiltersResourceAwsEc2InstanceImageIdList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SecurityhubInsightFiltersResourceAwsEc2InstanceImageIdList) Resolve(context cdktf.IResolveContext) interface{} {
