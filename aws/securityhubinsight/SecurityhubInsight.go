...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/securityhub_insight aws_securityhub_insight}.
...
func (j *jsiiProxy_SecurityhubInsight) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SecurityhubInsight) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SecurityhubInsight) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SecurityhubInsight) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/securityhub_insight aws_securityhub_insight} Resource.
func NewSecurityhubInsight(scope constructs.Construct, id *string, config *SecurityhubInsightConfig) SecurityhubInsight {
	_init_.Initialize()

	if err := validateNewSecurityhubInsightParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SecurityhubInsight)SetRegion(val *string) {
...
func SecurityhubInsight_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSecurityhubInsight_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SecurityhubInsight) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SecurityhubInsight) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SecurityhubInsight) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
