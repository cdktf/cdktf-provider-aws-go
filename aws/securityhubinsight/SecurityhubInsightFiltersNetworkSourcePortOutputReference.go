...
func (s *jsiiProxy_SecurityhubInsightFiltersNetworkSourcePortOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SecurityhubInsightFiltersNetworkSourcePortOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
