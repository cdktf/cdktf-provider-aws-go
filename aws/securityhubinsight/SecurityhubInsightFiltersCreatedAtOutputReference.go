...
func (s *jsiiProxy_SecurityhubInsightFiltersCreatedAtOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SecurityhubInsightFiltersCreatedAtOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
