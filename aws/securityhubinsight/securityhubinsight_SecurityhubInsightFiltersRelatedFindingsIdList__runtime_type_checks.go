...
func (s *jsiiProxy_SecurityhubInsightFiltersRelatedFindingsIdList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_SecurityhubInsightFiltersRelatedFindingsIdList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_SecurityhubInsightFiltersRelatedFindingsIdList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
