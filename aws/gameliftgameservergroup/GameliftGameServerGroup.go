...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/gameliftgameservergroup/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/gamelift_game_server_group aws_gamelift_game_server_group}.
...
func (j *jsiiProxy_GameliftGameServerGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_GameliftGameServerGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/gamelift_game_server_group aws_gamelift_game_server_group} Resource.
...
func (j *jsiiProxy_GameliftGameServerGroup)SetRegion(val *string) {
...
func (g *jsiiProxy_GameliftGameServerGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		g,
		"resetRegion",
		nil, // no parameters
