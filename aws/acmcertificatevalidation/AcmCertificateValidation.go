...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/acmcertificatevalidation/internal"
...
func (j *jsiiProxy_AcmCertificateValidation) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AcmCertificateValidation) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/resources/acm_certificate_validation aws_acm_certificate_validation} Resource.
...
func (j *jsiiProxy_AcmCertificateValidation)SetRegion(val *string) {
...
func AcmCertificateValidation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAcmCertificateValidation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AcmCertificateValidation) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AcmCertificateValidation) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
