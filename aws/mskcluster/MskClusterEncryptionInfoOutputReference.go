...
func (m *jsiiProxy_MskClusterEncryptionInfoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MskClusterEncryptionInfoOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
