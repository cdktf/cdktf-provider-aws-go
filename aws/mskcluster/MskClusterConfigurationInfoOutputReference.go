...
func (m *jsiiProxy_MskClusterConfigurationInfoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MskClusterConfigurationInfoOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
