...
func (c *jsiiProxy_CognitoUserPoolUsernameConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CognitoUserPoolUsernameConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
