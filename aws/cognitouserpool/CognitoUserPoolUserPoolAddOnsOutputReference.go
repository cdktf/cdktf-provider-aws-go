...
func (c *jsiiProxy_CognitoUserPoolUserPoolAddOnsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CognitoUserPoolUserPoolAddOnsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
