...
func (c *jsiiProxy_CognitoUserPoolPasswordPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CognitoUserPoolPasswordPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
