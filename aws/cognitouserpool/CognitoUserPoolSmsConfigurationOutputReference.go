...
func (c *jsiiProxy_CognitoUserPoolSmsConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CognitoUserPoolSmsConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
