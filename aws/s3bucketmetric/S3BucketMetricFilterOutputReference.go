...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/s3bucketmetric/internal"
...
func (s *jsiiProxy_S3BucketMetricFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_S3BucketMetricFilterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
