...
func (a *jsiiProxy_AppfabricIngestionDestinationDestinationConfigurationAuditLogDestinationS3BucketList) Resolve(_context cdktf.IResolveContext) interface{} {
