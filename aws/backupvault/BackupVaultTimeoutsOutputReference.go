...
func NewBackupVaultTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) BackupVaultTimeoutsOutputReference {
	...
	if err := validateNewBackupVaultTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (b *jsiiProxy_BackupVaultTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BackupVaultTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
