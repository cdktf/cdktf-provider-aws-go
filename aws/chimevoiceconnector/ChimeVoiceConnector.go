...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/chimevoiceconnector/internal"
...
func (j *jsiiProxy_ChimeVoiceConnector) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ChimeVoiceConnector) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ChimeVoiceConnector)SetRegion(val *string) {
...
func (c *jsiiProxy_ChimeVoiceConnector) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
