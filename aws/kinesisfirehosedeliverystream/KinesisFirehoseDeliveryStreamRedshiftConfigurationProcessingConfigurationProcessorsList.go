...
func (k *jsiiProxy_KinesisFirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessorsList) Resolve(context cdktf.IResolveContext) interface{} {
