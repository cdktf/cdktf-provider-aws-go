...
func (k *jsiiProxy_KinesisFirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfigurationProcessorsParametersList) Resolve(context cdktf.IResolveContext) interface{} {
