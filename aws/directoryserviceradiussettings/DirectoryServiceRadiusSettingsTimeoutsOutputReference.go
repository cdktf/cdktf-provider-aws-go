...
func (d *jsiiProxy_DirectoryServiceRadiusSettingsTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DirectoryServiceRadiusSettingsTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
