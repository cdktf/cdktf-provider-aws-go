...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v19/dbparametergroup/internal"
...
func (j *jsiiProxy_DbParameterGroup) SkipDestroyInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"skipDestroyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.83.0/docs/resources/db_parameter_group aws_db_parameter_group} Resource.
...
func (j *jsiiProxy_DbParameterGroup)SetSkipDestroy(val interface{}) {
...
func (d *jsiiProxy_DbParameterGroup) ResetSkipDestroy() {
	_jsii_.InvokeVoid(
		d,
		"resetSkipDestroy",
		nil, // no parameters
