...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/iotcertificate/internal"
...
func (j *jsiiProxy_IotCertificate) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_IotCertificate) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/resources/iot_certificate aws_iot_certificate} Resource.
...
func (j *jsiiProxy_IotCertificate)SetRegion(val *string) {
...
func (i *jsiiProxy_IotCertificate) ResetRegion() {
	_jsii_.InvokeVoid(
		i,
		"resetRegion",
		nil, // no parameters
