...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsWafv2WebAcl)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-aws.dataAwsWafv2WebAcl.DataAwsWafv2WebAclConfig",
		reflect.TypeOf((*DataAwsWafv2WebAclConfig)(nil)).Elem(),
	)
}
