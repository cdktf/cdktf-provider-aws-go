...
func (l *jsiiProxy_LbListenerRuleTransformHostHeaderRewriteConfigRewriteOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LbListenerRuleTransformHostHeaderRewriteConfigRewriteOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
