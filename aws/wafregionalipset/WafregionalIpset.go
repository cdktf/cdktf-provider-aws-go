...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/wafregionalipset/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/resources/wafregional_ipset aws_wafregional_ipset}.
...
func (j *jsiiProxy_WafregionalIpset) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_WafregionalIpset) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/resources/wafregional_ipset aws_wafregional_ipset} Resource.
...
func (j *jsiiProxy_WafregionalIpset)SetRegion(val *string) {
...
func (w *jsiiProxy_WafregionalIpset) ResetRegion() {
	_jsii_.InvokeVoid(
		w,
		"resetRegion",
		nil, // no parameters
