...
func (j *jsiiProxy_BedrockagentDataSourceDataSourceConfigurationS3ConfigurationList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewBedrockagentDataSourceDataSourceConfigurationS3ConfigurationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BedrockagentDataSourceDataSourceConfigurationS3ConfigurationList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktf/provider-aws.bedrockagentDataSource.BedrockagentDataSourceDataSourceConfigurationS3ConfigurationList",
...
func NewBedrockagentDataSourceDataSourceConfigurationS3ConfigurationList_Override(b BedrockagentDataSourceDataSourceConfigurationS3ConfigurationList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BedrockagentDataSourceDataSourceConfigurationS3ConfigurationList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (b *jsiiProxy_BedrockagentDataSourceDataSourceConfigurationS3ConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BedrockagentDataSourceDataSourceConfigurationS3ConfigurationList) Resolve(_context cdktf.IResolveContext) interface{} {
