...
type SagemakerWorkteamWorkerAccessConfiguration struct {
	// s3_presign block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.87.0/docs/resources/sagemaker_workteam#s3_presign SagemakerWorkteam#s3_presign}
