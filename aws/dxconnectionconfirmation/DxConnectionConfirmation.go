...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/dx_connection_confirmation aws_dx_connection_confirmation}.
...
func (j *jsiiProxy_DxConnectionConfirmation) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DxConnectionConfirmation) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/dx_connection_confirmation aws_dx_connection_confirmation} Resource.
...
func (j *jsiiProxy_DxConnectionConfirmation)SetRegion(val *string) {
...
func (d *jsiiProxy_DxConnectionConfirmation) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
