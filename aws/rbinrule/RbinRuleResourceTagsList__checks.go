...
func (r *jsiiProxy_RbinRuleResourceTagsList) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_RbinRuleResourceTagsList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*RbinRuleResourceTags:
		val := val.(*[]*RbinRuleResourceTags)
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*RbinRuleResourceTags; received %#v (a %T)", val, val)
		}
	}
