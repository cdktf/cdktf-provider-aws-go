...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "lockEndTime", GoGetter: "LockEndTime"},
			_jsii_.MemberProperty{JsiiProperty: "lockState", GoGetter: "LockState"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putExcludeResourceTags", GoMethod: "PutExcludeResourceTags"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetExcludeResourceTags", GoMethod: "ResetExcludeResourceTags"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetResourceTagValue", GoMethod: "ResetResourceTagValue"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "resourceTagKey", GoGetter: "ResourceTagKey"},
			_jsii_.MemberProperty{JsiiProperty: "resourceTagKeyInput", GoGetter: "ResourceTagKeyInput"},
			_jsii_.MemberProperty{JsiiProperty: "resourceTagValue", GoGetter: "ResourceTagValue"},
			_jsii_.MemberProperty{JsiiProperty: "resourceTagValueInput", GoGetter: "ResourceTagValueInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putUnlockDelay", GoMethod: "PutUnlockDelay"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
			_jsii_.MemberProperty{JsiiProperty: "unlockDelay", GoGetter: "UnlockDelay"},
			_jsii_.MemberProperty{JsiiProperty: "unlockDelayInput", GoGetter: "UnlockDelayInput"},
		},
		func() interface{} {
			j := jsiiProxy_RbinRuleLockConfigurationOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
			_jsii_.MemberProperty{JsiiProperty: "unlockDelayUnit", GoGetter: "UnlockDelayUnit"},
			_jsii_.MemberProperty{JsiiProperty: "unlockDelayUnitInput", GoGetter: "UnlockDelayUnitInput"},
			_jsii_.MemberProperty{JsiiProperty: "unlockDelayValue", GoGetter: "UnlockDelayValue"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_RbinRuleResourceTagsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "retentionPeriodUnit", GoGetter: "RetentionPeriodUnit"},
			_jsii_.MemberProperty{JsiiProperty: "retentionPeriodUnitInput", GoGetter: "RetentionPeriodUnitInput"},
			_jsii_.MemberProperty{JsiiProperty: "retentionPeriodValue", GoGetter: "RetentionPeriodValue"},
			_jsii_.MemberProperty{JsiiProperty: "retentionPeriodValueInput", GoGetter: "RetentionPeriodValueInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
