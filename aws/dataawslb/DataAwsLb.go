...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/data-sources/lb aws_lb}.
type DataAwsLb interface {
	...
	IpamPools() DataAwsLbIpamPoolsList
	// Experimental.
...
func (j *jsiiProxy_DataAwsLb) IpamPools() DataAwsLbIpamPoolsList {
	var returns DataAwsLbIpamPoolsList
	_jsii_.Get(
		j,
		"ipamPools",
		&returns,
...
func (j *jsiiProxy_DataAwsLb) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsLb) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/data-sources/lb aws_lb} Data Source.
...
func (j *jsiiProxy_DataAwsLb)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsLb) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
