...
func (j *jsiiProxy_DataAwsLb) SecondaryIpsAutoAssignedPerSubnet() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/data-sources/lb aws_lb} Data Source.
