...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/resources/servicecatalog_tag_option aws_servicecatalog_tag_option}.
...
func (j *jsiiProxy_ServicecatalogTagOption) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ServicecatalogTagOption) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/resources/servicecatalog_tag_option aws_servicecatalog_tag_option} Resource.
...
func (j *jsiiProxy_ServicecatalogTagOption)SetRegion(val *string) {
...
func (s *jsiiProxy_ServicecatalogTagOption) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
