...
func NewDataAwsServiceDiscoveryServiceDnsConfigList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsServiceDiscoveryServiceDnsConfigList {
	...
	if err := validateNewDataAwsServiceDiscoveryServiceDnsConfigListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsServiceDiscoveryServiceDnsConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsServiceDiscoveryServiceDnsConfigList) Resolve(context cdktf.IResolveContext) interface{} {
