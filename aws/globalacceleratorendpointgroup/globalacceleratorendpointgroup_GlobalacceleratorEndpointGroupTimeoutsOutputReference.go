...
import (
	...
	"github.com/hashicorp/cdktf-provider-aws-go/aws/v10/globalacceleratorendpointgroup/internal"
...
func NewGlobalacceleratorEndpointGroupTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GlobalacceleratorEndpointGroupTimeoutsOutputReference {
	...
	if err := validateNewGlobalacceleratorEndpointGroupTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
