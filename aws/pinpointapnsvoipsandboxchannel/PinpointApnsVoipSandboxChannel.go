...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/resources/pinpoint_apns_voip_sandbox_channel aws_pinpoint_apns_voip_sandbox_channel}.
...
func (j *jsiiProxy_PinpointApnsVoipSandboxChannel) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_PinpointApnsVoipSandboxChannel) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/resources/pinpoint_apns_voip_sandbox_channel aws_pinpoint_apns_voip_sandbox_channel} Resource.
...
func (j *jsiiProxy_PinpointApnsVoipSandboxChannel)SetRegion(val *string) {
...
func (p *jsiiProxy_PinpointApnsVoipSandboxChannel) ResetRegion() {
	_jsii_.InvokeVoid(
		p,
		"resetRegion",
		nil, // no parameters
