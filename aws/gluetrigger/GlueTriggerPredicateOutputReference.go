...
func (j *jsiiProxy_GlueTriggerPredicateOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_GlueTriggerPredicateOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GlueTriggerPredicateOutputReference) Conditions() GlueTriggerPredicateConditionsList {
	var returns GlueTriggerPredicateConditionsList
	_jsii_.Get(
		j,
		"conditions",
		&returns,
...
func (j *jsiiProxy_GlueTriggerPredicateOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_GlueTriggerPredicateOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewGlueTriggerPredicateOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GlueTriggerPredicateOutputReference {
	_init_.Initialize()

	if err := validateNewGlueTriggerPredicateOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewGlueTriggerPredicateOutputReference_Override(g GlueTriggerPredicateOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_GlueTriggerPredicateOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_GlueTriggerPredicateOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_GlueTriggerPredicateOutputReference)SetLogical(val *string) {
	if err := j.validateSetLogicalParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (g *jsiiProxy_GlueTriggerPredicateOutputReference) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GlueTriggerPredicateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GlueTriggerPredicateOutputReference) PutConditions(value interface{}) {
...
func (g *jsiiProxy_GlueTriggerPredicateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (g *jsiiProxy_GlueTriggerPredicateOutputReference) ToString() *string {
	var returns *string
