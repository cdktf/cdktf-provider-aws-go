...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v20/gluetrigger/internal"
...
func (g *jsiiProxy_GlueTriggerPredicateOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
