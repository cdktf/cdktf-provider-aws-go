...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v12/vpcpeeringconnection/internal"
...
func (v *jsiiProxy_VpcPeeringConnectionRequesterOutputReference) ResetAllowClassicLinkToRemoteVpc() {
	_jsii_.InvokeVoid(
		v,
		"resetAllowClassicLinkToRemoteVpc",
		nil, // no parameters
...
func (v *jsiiProxy_VpcPeeringConnectionRequesterOutputReference) ResetAllowVpcToRemoteClassicLink() {
	_jsii_.InvokeVoid(
		v,
		"resetAllowVpcToRemoteClassicLink",
		nil, // no parameters
