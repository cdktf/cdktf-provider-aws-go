...
func NewDataAwsOdbCloudVmClusterIormConfigCacheList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsOdbCloudVmClusterIormConfigCacheList {
	...
	_jsii_.Create(
		"@cdktf/provider-aws.dataAwsOdbCloudVmCluster.DataAwsOdbCloudVmClusterIormConfigCacheList",
...
func (d *jsiiProxy_DataAwsOdbCloudVmClusterIormConfigCacheList) Resolve(_context cdktf.IResolveContext) interface{} {
