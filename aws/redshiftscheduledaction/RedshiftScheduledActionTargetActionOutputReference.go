...
func (r *jsiiProxy_RedshiftScheduledActionTargetActionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RedshiftScheduledActionTargetActionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
