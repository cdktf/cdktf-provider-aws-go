...
func (d *jsiiProxy_DefaultSecurityGroup) validatePutEgressParameters(value interface{}) error {
	...
	case *[]*DefaultSecurityGroupEgress:
		value := value.(*[]*DefaultSecurityGroupEgress)
	...
	case []*DefaultSecurityGroupEgress:
		value_ := value.([]*DefaultSecurityGroupEgress)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*DefaultSecurityGroupEgress; received %#v (a %T)", value, value)
		}
	}
...
func (d *jsiiProxy_DefaultSecurityGroup) validatePutIngressParameters(value interface{}) error {
	...
	case *[]*DefaultSecurityGroupIngress:
		value := value.(*[]*DefaultSecurityGroupIngress)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*DefaultSecurityGroupIngress:
		value_ := value.([]*DefaultSecurityGroupIngress)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*DefaultSecurityGroupIngress; received %#v (a %T)", value, value)
		}
	}
