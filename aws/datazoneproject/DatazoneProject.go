...
type DatazoneProject interface {
	...
	FailureReasons() DatazoneProjectFailureReasonsList
	// Experimental.
	...
	PutTimeouts(value *DatazoneProjectTimeouts)
	ResetDescription()
	ResetGlossaryTerms()
...
func (j *jsiiProxy_DatazoneProject) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DatazoneProject) FailureReasons() DatazoneProjectFailureReasonsList {
	var returns DatazoneProjectFailureReasonsList
	_jsii_.Get(
		j,
		"failureReasons",
		&returns,
...
func (j *jsiiProxy_DatazoneProject) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DatazoneProject) SkipDeletionCheckInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DatazoneProject) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DatazoneProject) Timeouts() DatazoneProjectTimeoutsOutputReference {
	var returns DatazoneProjectTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_DatazoneProject) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/datazone_project aws_datazone_project} Resource.
...
func (j *jsiiProxy_DatazoneProject)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DatazoneProject)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DatazoneProject)SetSkipDeletionCheck(val interface{}) {
...
func DatazoneProject_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DatazoneProject) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DatazoneProject) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DatazoneProject) PutTimeouts(value *DatazoneProjectTimeouts) {
...
func (d *jsiiProxy_DatazoneProject) ResetSkipDeletionCheck() {
	_jsii_.InvokeVoid(
		d,
		"resetSkipDeletionCheck",
		nil, // no parameters
...
func (d *jsiiProxy_DatazoneProject) ResetTimeouts() {
	_jsii_.InvokeVoid(
		d,
		"resetTimeouts",
		nil, // no parameters
