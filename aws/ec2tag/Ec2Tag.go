...
func (j *jsiiProxy_Ec2Tag) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Ec2Tag) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/ec2_tag aws_ec2_tag} Resource.
...
func (j *jsiiProxy_Ec2Tag)SetRegion(val *string) {
...
func (e *jsiiProxy_Ec2Tag) ResetRegion() {
	_jsii_.InvokeVoid(
		e,
		"resetRegion",
		nil, // no parameters
