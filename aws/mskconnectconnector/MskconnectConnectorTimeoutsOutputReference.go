...
func (m *jsiiProxy_MskconnectConnectorTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MskconnectConnectorTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
