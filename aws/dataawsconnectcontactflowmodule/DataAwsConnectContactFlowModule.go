...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/dataawsconnectcontactflowmodule/internal"
...
func (j *jsiiProxy_DataAwsConnectContactFlowModule) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsConnectContactFlowModule) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/data-sources/connect_contact_flow_module aws_connect_contact_flow_module} Data Source.
...
func (j *jsiiProxy_DataAwsConnectContactFlowModule)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsConnectContactFlowModule) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
