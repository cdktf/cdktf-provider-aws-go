...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/resources/ssm_patch_baseline aws_ssm_patch_baseline}.
...
func (j *jsiiProxy_SsmPatchBaseline) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SsmPatchBaseline) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/resources/ssm_patch_baseline aws_ssm_patch_baseline} Resource.
...
func (j *jsiiProxy_SsmPatchBaseline)SetRegion(val *string) {
...
func (s *jsiiProxy_SsmPatchBaseline) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
