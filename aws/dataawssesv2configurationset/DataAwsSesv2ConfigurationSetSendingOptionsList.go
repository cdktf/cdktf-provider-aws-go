...
func (d *jsiiProxy_DataAwsSesv2ConfigurationSetSendingOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsSesv2ConfigurationSetSendingOptionsList) Resolve(context cdktf.IResolveContext) interface{} {
