...
func (d *jsiiProxy_DataAwsKinesisStreamStreamModeDetailsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataAwsKinesisStreamStreamModeDetailsList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_DataAwsKinesisStreamStreamModeDetailsList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_DataAwsKinesisStreamStreamModeDetailsList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
