...
func (c *jsiiProxy_CloudwatchEventConnectionAuthParametersApiKeyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudwatchEventConnectionAuthParametersApiKeyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
