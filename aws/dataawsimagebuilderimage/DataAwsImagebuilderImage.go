...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/data-sources/imagebuilder_image aws_imagebuilder_image}.
type DataAwsImagebuilderImage interface {
	...
	ImageScanningConfiguration() DataAwsImagebuilderImageImageScanningConfigurationList
	ImageTestsConfiguration() DataAwsImagebuilderImageImageTestsConfigurationList
	...
	OsVersion() *string
	OutputResources() DataAwsImagebuilderImageOutputResourcesList
	Platform() *string
	// Experimental.
...
func (j *jsiiProxy_DataAwsImagebuilderImage) ContainerRecipeArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"containerRecipeArn",
...
func (j *jsiiProxy_DataAwsImagebuilderImage) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsImagebuilderImage) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsImagebuilderImage) ImageScanningConfiguration() DataAwsImagebuilderImageImageScanningConfigurationList {
	var returns DataAwsImagebuilderImageImageScanningConfigurationList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsImagebuilderImage) ImageTestsConfiguration() DataAwsImagebuilderImageImageTestsConfigurationList {
	var returns DataAwsImagebuilderImageImageTestsConfigurationList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsImagebuilderImage) OutputResources() DataAwsImagebuilderImageOutputResourcesList {
	var returns DataAwsImagebuilderImageOutputResourcesList
	_jsii_.Get(
		j,
		"outputResources",
		&returns,
...
func (j *jsiiProxy_DataAwsImagebuilderImage) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsImagebuilderImage) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/data-sources/imagebuilder_image aws_imagebuilder_image} Data Source.
func NewDataAwsImagebuilderImage(scope constructs.Construct, id *string, config *DataAwsImagebuilderImageConfig) DataAwsImagebuilderImage {
	...
	if err := validateNewDataAwsImagebuilderImageParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsImagebuilderImage)SetRegion(val *string) {
...
func DataAwsImagebuilderImage_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsImagebuilderImage_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsImagebuilderImage) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsImagebuilderImage) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
