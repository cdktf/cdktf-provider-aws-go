...
func (d *jsiiProxy_DaxClusterTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DaxClusterTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
