...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "deleteLambda", GoGetter: "DeleteLambda"},
			_jsii_.MemberProperty{JsiiProperty: "deleteLambdaInput", GoGetter: "DeleteLambdaInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "timeline", GoGetter: "Timeline"},
