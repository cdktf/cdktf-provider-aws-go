...
func (s *jsiiProxy_SyntheticsCanaryArtifactConfigS3EncryptionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SyntheticsCanaryArtifactConfigS3EncryptionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
