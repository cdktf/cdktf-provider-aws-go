...
func (j *jsiiProxy_S3BucketLifecycleConfigurationRuleAbortIncompleteMultipartUploadList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewS3BucketLifecycleConfigurationRuleAbortIncompleteMultipartUploadList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) S3BucketLifecycleConfigurationRuleAbortIncompleteMultipartUploadList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktf/provider-aws.s3BucketLifecycleConfiguration.S3BucketLifecycleConfigurationRuleAbortIncompleteMultipartUploadList",
...
func NewS3BucketLifecycleConfigurationRuleAbortIncompleteMultipartUploadList_Override(s S3BucketLifecycleConfigurationRuleAbortIncompleteMultipartUploadList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_S3BucketLifecycleConfigurationRuleAbortIncompleteMultipartUploadList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (s *jsiiProxy_S3BucketLifecycleConfigurationRuleAbortIncompleteMultipartUploadList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_S3BucketLifecycleConfigurationRuleAbortIncompleteMultipartUploadList) Resolve(_context cdktf.IResolveContext) interface{} {
