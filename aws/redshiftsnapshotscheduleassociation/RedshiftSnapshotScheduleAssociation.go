...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v19/redshiftsnapshotscheduleassociation/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.57.0/docs/resources/redshift_snapshot_schedule_association aws_redshift_snapshot_schedule_association}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.57.0/docs/resources/redshift_snapshot_schedule_association aws_redshift_snapshot_schedule_association} Resource.
...
func RedshiftSnapshotScheduleAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateRedshiftSnapshotScheduleAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RedshiftSnapshotScheduleAssociation) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_RedshiftSnapshotScheduleAssociation) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (r *jsiiProxy_RedshiftSnapshotScheduleAssociation) MoveFromId(id *string) {
...
func (r *jsiiProxy_RedshiftSnapshotScheduleAssociation) MoveToId(id *string) {
