...
func (l *jsiiProxy_LakeformationResourceLfTagsLfTagOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LakeformationResourceLfTagsLfTagOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
