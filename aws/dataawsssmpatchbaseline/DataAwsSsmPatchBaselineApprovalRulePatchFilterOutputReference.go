...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/dataawsssmpatchbaseline/internal"
...
func (d *jsiiProxy_DataAwsSsmPatchBaselineApprovalRulePatchFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsSsmPatchBaselineApprovalRulePatchFilterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
