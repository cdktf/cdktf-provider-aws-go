...
func (d *jsiiProxy_DataAwsSsmPatchBaselineSourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsSsmPatchBaselineSourceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
