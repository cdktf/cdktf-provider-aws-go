...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/data-sources/ssm_patch_baseline aws_ssm_patch_baseline}.
...
func (j *jsiiProxy_DataAwsSsmPatchBaseline) AvailableSecurityUpdatesComplianceStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsSsmPatchBaseline) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsSsmPatchBaseline) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/data-sources/ssm_patch_baseline aws_ssm_patch_baseline} Data Source.
...
func (j *jsiiProxy_DataAwsSsmPatchBaseline)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsSsmPatchBaseline) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
