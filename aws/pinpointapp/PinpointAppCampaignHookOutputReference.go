...
func (p *jsiiProxy_PinpointAppCampaignHookOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PinpointAppCampaignHookOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
