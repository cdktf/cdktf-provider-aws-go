...
func (l *jsiiProxy_LaunchConfigurationMetadataOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LaunchConfigurationMetadataOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
