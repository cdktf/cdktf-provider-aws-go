...
func (j *jsiiProxy_SnsTopic) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SnsTopic) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/resources/sns_topic aws_sns_topic} Resource.
...
func (j *jsiiProxy_SnsTopic)SetRegion(val *string) {
...
func (s *jsiiProxy_SnsTopic) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
