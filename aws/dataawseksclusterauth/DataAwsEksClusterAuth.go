...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/data-sources/eks_cluster_auth aws_eks_cluster_auth}.
...
func (j *jsiiProxy_DataAwsEksClusterAuth) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsEksClusterAuth) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/data-sources/eks_cluster_auth aws_eks_cluster_auth} Data Source.
...
func (j *jsiiProxy_DataAwsEksClusterAuth)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsEksClusterAuth) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
