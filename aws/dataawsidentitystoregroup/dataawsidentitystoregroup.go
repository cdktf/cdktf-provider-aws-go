...
func init() {
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-aws.dataAwsIdentitystoreGroup.DataAwsIdentitystoreGroupFilterList",
		reflect.TypeOf((*DataAwsIdentitystoreGroupFilterList)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsIdentitystoreGroupFilterList{}
