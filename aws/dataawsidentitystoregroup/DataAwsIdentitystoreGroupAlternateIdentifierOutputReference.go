...
func (d *jsiiProxy_DataAwsIdentitystoreGroupAlternateIdentifierOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsIdentitystoreGroupAlternateIdentifierOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
