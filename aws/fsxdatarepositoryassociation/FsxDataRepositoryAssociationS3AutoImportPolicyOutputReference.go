...
func NewFsxDataRepositoryAssociationS3AutoImportPolicyOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) FsxDataRepositoryAssociationS3AutoImportPolicyOutputReference {
	...
	if err := validateNewFsxDataRepositoryAssociationS3AutoImportPolicyOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FsxDataRepositoryAssociationS3AutoImportPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FsxDataRepositoryAssociationS3AutoImportPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
