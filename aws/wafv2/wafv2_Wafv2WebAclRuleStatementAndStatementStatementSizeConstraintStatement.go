...
type Wafv2WebAclRuleStatementAndStatementStatementSizeConstraintStatement struct {
	...
	FieldToMatch *Wafv2WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatch `field:"optional" json:"fieldToMatch" yaml:"fieldToMatch"`
}
