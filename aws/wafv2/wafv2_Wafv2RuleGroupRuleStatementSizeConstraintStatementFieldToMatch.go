...
type Wafv2RuleGroupRuleStatementSizeConstraintStatementFieldToMatch struct {
	...
	AllQueryArguments *Wafv2RuleGroupRuleStatementSizeConstraintStatementFieldToMatchAllQueryArguments `field:"optional" json:"allQueryArguments" yaml:"allQueryArguments"`
	// body block.
	//
	...
	Method *Wafv2RuleGroupRuleStatementSizeConstraintStatementFieldToMatchMethod `field:"optional" json:"method" yaml:"method"`
	// query_string block.
	//
	...
	QueryString *Wafv2RuleGroupRuleStatementSizeConstraintStatementFieldToMatchQueryString `field:"optional" json:"queryString" yaml:"queryString"`
	// single_header block.
	//
	...
	SingleHeader *Wafv2RuleGroupRuleStatementSizeConstraintStatementFieldToMatchSingleHeader `field:"optional" json:"singleHeader" yaml:"singleHeader"`
	...
	SingleQueryArgument *Wafv2RuleGroupRuleStatementSizeConstraintStatementFieldToMatchSingleQueryArgument `field:"optional" json:"singleQueryArgument" yaml:"singleQueryArgument"`
	// uri_path block.
	//
	...
	UriPath *Wafv2RuleGroupRuleStatementSizeConstraintStatementFieldToMatchUriPath `field:"optional" json:"uriPath" yaml:"uriPath"`
}
