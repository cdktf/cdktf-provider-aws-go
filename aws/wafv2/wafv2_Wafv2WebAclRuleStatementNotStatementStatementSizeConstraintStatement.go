...
type Wafv2WebAclRuleStatementNotStatementStatementSizeConstraintStatement struct {
	...
	FieldToMatch *Wafv2WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatch `field:"optional" json:"fieldToMatch" yaml:"fieldToMatch"`
}
