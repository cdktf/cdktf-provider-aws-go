...
func (q *jsiiProxy_QuicksightTemplateSourceEntityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightTemplateSourceEntityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
