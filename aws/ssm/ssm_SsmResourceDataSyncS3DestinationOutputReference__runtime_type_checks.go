...
func (j *jsiiProxy_SsmResourceDataSyncS3DestinationOutputReference) validateSetInternalValueParameters(val *SsmResourceDataSyncS3Destination) error {
...
func (j *jsiiProxy_SsmResourceDataSyncS3DestinationOutputReference) validateSetPrefixParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_SsmResourceDataSyncS3DestinationOutputReference) validateSetRegionParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
