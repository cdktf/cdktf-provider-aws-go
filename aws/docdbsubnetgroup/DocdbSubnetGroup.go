...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/docdb_subnet_group aws_docdb_subnet_group}.
...
func (j *jsiiProxy_DocdbSubnetGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DocdbSubnetGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/docdb_subnet_group aws_docdb_subnet_group} Resource.
...
func (j *jsiiProxy_DocdbSubnetGroup)SetRegion(val *string) {
...
func (d *jsiiProxy_DocdbSubnetGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
