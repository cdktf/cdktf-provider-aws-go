...
func (s *jsiiProxy_SagemakerDataQualityJobDefinitionNetworkConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerDataQualityJobDefinitionNetworkConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
