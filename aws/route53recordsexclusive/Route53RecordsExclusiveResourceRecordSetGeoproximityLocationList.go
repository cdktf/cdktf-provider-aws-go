...
func NewRoute53RecordsExclusiveResourceRecordSetGeoproximityLocationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) Route53RecordsExclusiveResourceRecordSetGeoproximityLocationList {
	...
	_jsii_.Create(
		"@cdktf/provider-aws.route53RecordsExclusive.Route53RecordsExclusiveResourceRecordSetGeoproximityLocationList",
...
func (r *jsiiProxy_Route53RecordsExclusiveResourceRecordSetGeoproximityLocationList) Resolve(_context cdktf.IResolveContext) interface{} {
