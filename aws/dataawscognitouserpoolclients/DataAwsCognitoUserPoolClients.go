...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/dataawscognitouserpoolclients/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/data-sources/cognito_user_pool_clients aws_cognito_user_pool_clients}.
...
func (j *jsiiProxy_DataAwsCognitoUserPoolClients) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsCognitoUserPoolClients) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/data-sources/cognito_user_pool_clients aws_cognito_user_pool_clients} Data Source.
...
func (j *jsiiProxy_DataAwsCognitoUserPoolClients)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsCognitoUserPoolClients) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
