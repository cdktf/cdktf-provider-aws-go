...
func (j *jsiiProxy_ConfigConformancePack) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ConfigConformancePack) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/config_conformance_pack aws_config_conformance_pack} Resource.
...
func (j *jsiiProxy_ConfigConformancePack)SetRegion(val *string) {
...
func ConfigConformancePack_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ConfigConformancePack) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ConfigConformancePack) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
