...
func (d *jsiiProxy_DataAwsLambdaCodeSigningConfigAllowedPublishersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsLambdaCodeSigningConfigAllowedPublishersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
