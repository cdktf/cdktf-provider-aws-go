...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSigningParameters", GoMethod: "ResetSigningParameters"},
			...
			_jsii_.MemberProperty{JsiiProperty: "signingParameters", GoGetter: "SigningParameters"},
			_jsii_.MemberProperty{JsiiProperty: "signingParametersInput", GoGetter: "SigningParametersInput"},
