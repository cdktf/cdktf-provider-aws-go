...
func (j *jsiiProxy_DataAwsKeyPair) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsKeyPair) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/data-sources/key_pair aws_key_pair} Data Source.
...
func (j *jsiiProxy_DataAwsKeyPair)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsKeyPair) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
