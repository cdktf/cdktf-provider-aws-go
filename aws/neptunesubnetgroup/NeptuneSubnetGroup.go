...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/neptunesubnetgroup/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/neptune_subnet_group aws_neptune_subnet_group}.
...
func (j *jsiiProxy_NeptuneSubnetGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_NeptuneSubnetGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/neptune_subnet_group aws_neptune_subnet_group} Resource.
...
func (j *jsiiProxy_NeptuneSubnetGroup)SetRegion(val *string) {
...
func NeptuneSubnetGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateNeptuneSubnetGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (n *jsiiProxy_NeptuneSubnetGroup) AddMoveTarget(moveTarget *string) {
...
func (n *jsiiProxy_NeptuneSubnetGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		n,
		"resetRegion",
		nil, // no parameters
