...
func (o *jsiiProxy_OpsworksApplicationEnvironmentList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_OpsworksApplicationEnvironmentList) validateSetInternalValueParameters(val interface{}) error {
	...
	case *[]*OpsworksApplicationEnvironment:
		val := val.(*[]*OpsworksApplicationEnvironment)
	...
	case []*OpsworksApplicationEnvironment:
		val_ := val.([]*OpsworksApplicationEnvironment)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*OpsworksApplicationEnvironment; received %#v (a %T)", val, val)
		}
	}
