...
func (j *jsiiProxy_GluePartitionStorageDescriptorSerDeInfoOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GluePartitionStorageDescriptorSerDeInfoOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_GluePartitionStorageDescriptorSerDeInfoOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewGluePartitionStorageDescriptorSerDeInfoOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GluePartitionStorageDescriptorSerDeInfoOutputReference {
	...
	if err := validateNewGluePartitionStorageDescriptorSerDeInfoOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GluePartitionStorageDescriptorSerDeInfoOutputReference) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GluePartitionStorageDescriptorSerDeInfoOutputReference) ToString() *string {
	var returns *string
