...
func (j *jsiiProxy_GlueConnection) validateSetConnectionPropertiesParameters(val *map[string]*string) error {
	return nil
}

func (j *jsiiProxy_GlueConnection) validateSetConnectionTypeParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_GlueConnection) validateSetDescriptionParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_GlueConnection) validateSetIdParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_GlueConnection) validateSetLifecycleParameters(val *cdktf.TerraformResourceLifecycle) error {
	return nil
}

func (j *jsiiProxy_GlueConnection) validateSetMatchCriteriaParameters(val *[]*string) error {
	return nil
}

func (j *jsiiProxy_GlueConnection) validateSetNameParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_GlueConnection) validateSetTagsAllParameters(val *map[string]*string) error {
	return nil
}
