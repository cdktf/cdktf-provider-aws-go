...
func (g *jsiiProxy_GuarddutyDetectorDatasourcesKubernetesAuditLogsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GuarddutyDetectorDatasourcesKubernetesAuditLogsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
