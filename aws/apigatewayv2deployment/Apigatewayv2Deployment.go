...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/apigatewayv2_deployment aws_apigatewayv2_deployment}.
...
func (j *jsiiProxy_Apigatewayv2Deployment) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Apigatewayv2Deployment) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/apigatewayv2_deployment aws_apigatewayv2_deployment} Resource.
...
func (j *jsiiProxy_Apigatewayv2Deployment)SetRegion(val *string) {
...
func (a *jsiiProxy_Apigatewayv2Deployment) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
