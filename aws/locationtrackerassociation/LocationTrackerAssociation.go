...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v13/locationtrackerassociation/internal"
...
func (j *jsiiProxy_LocationTrackerAssociation) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_LocationTrackerAssociation)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
