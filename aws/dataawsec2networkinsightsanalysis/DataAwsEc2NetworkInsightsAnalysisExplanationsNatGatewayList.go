...
func (d *jsiiProxy_DataAwsEc2NetworkInsightsAnalysisExplanationsNatGatewayList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsEc2NetworkInsightsAnalysisExplanationsNatGatewayList) Resolve(context cdktf.IResolveContext) interface{} {
