...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v20/organizationsorganizationalunit/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/organizations_organizational_unit aws_organizations_organizational_unit} Resource.
func NewOrganizationsOrganizationalUnit(scope constructs.Construct, id *string, config *OrganizationsOrganizationalUnitConfig) OrganizationsOrganizationalUnit {
	...
	if err := validateNewOrganizationsOrganizationalUnitParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func OrganizationsOrganizationalUnit_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateOrganizationsOrganizationalUnit_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (o *jsiiProxy_OrganizationsOrganizationalUnit) AddMoveTarget(moveTarget *string) {
