...
func (j *jsiiProxy_Ec2TransitGatewayMulticastDomainAssociation) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_Ec2TransitGatewayMulticastDomainAssociation)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
