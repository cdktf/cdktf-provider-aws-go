...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v20/globalacceleratorcustomroutinglistener/internal"
...
func NewGlobalacceleratorCustomRoutingListenerPortRangeList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GlobalacceleratorCustomRoutingListenerPortRangeList {
	...
	_jsii_.Create(
		"@cdktf/provider-aws.globalacceleratorCustomRoutingListener.GlobalacceleratorCustomRoutingListenerPortRangeList",
