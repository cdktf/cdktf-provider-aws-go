...
func (j *jsiiProxy_DataAwsRdsCluster) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsRdsCluster) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/data-sources/rds_cluster aws_rds_cluster} Data Source.
...
func (j *jsiiProxy_DataAwsRdsCluster)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsRdsCluster) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
