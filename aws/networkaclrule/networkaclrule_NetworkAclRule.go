...
import (
	...
	"github.com/hashicorp/cdktf-provider-aws-go/aws/v10/networkaclrule/internal"
...
func (j *jsiiProxy_NetworkAclRule) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_NetworkAclRule)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
