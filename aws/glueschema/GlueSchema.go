...
func (j *jsiiProxy_GlueSchema) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GlueSchema) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GlueSchema) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_GlueSchema) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.20.0/docs/resources/glue_schema aws_glue_schema} Resource.
func NewGlueSchema(scope constructs.Construct, id *string, config *GlueSchemaConfig) GlueSchema {
	_init_.Initialize()

	if err := validateNewGlueSchemaParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_GlueSchema)SetRegion(val *string) {
...
func GlueSchema_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGlueSchema_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GlueSchema) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GlueSchema) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GlueSchema) MoveFromId(id *string) {
...
func (g *jsiiProxy_GlueSchema) MoveToId(id *string) {
...
func (g *jsiiProxy_GlueSchema) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GlueSchema) ResetRegion() {
	_jsii_.InvokeVoid(
		g,
		"resetRegion",
		nil, // no parameters
