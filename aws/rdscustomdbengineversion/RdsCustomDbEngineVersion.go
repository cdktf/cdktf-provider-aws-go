...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/rds_custom_db_engine_version aws_rds_custom_db_engine_version}.
...
func (j *jsiiProxy_RdsCustomDbEngineVersion) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_RdsCustomDbEngineVersion) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/rds_custom_db_engine_version aws_rds_custom_db_engine_version} Resource.
...
func (j *jsiiProxy_RdsCustomDbEngineVersion)SetRegion(val *string) {
...
func (r *jsiiProxy_RdsCustomDbEngineVersion) ResetRegion() {
	_jsii_.InvokeVoid(
		r,
		"resetRegion",
		nil, // no parameters
