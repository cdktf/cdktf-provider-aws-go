...
func (j *jsiiProxy_DataAwsOrganizationsOrganizationNonMasterAccountsOutputReference) JoinedMethod() *string {
	var returns *string
	_jsii_.Get(
		j,
		"joinedMethod",
...
func (j *jsiiProxy_DataAwsOrganizationsOrganizationNonMasterAccountsOutputReference) JoinedTimestamp() *string {
	var returns *string
	_jsii_.Get(
		j,
		"joinedTimestamp",
...
func (j *jsiiProxy_DataAwsOrganizationsOrganizationNonMasterAccountsOutputReference) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (d *jsiiProxy_DataAwsOrganizationsOrganizationNonMasterAccountsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsOrganizationsOrganizationNonMasterAccountsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
