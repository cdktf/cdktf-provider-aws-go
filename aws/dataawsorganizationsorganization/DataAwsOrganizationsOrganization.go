...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v20/dataawsorganizationsorganization/internal"
...
func (j *jsiiProxy_DataAwsOrganizationsOrganization) MasterAccountName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"masterAccountName",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/organizations_organization aws_organizations_organization} Data Source.
func NewDataAwsOrganizationsOrganization(scope constructs.Construct, id *string, config *DataAwsOrganizationsOrganizationConfig) DataAwsOrganizationsOrganization {
	...
	if err := validateNewDataAwsOrganizationsOrganizationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsOrganizationsOrganization_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsOrganizationsOrganization_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
