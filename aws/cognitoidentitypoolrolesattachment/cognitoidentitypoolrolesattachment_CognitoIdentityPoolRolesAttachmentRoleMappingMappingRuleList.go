...
import (
	...
	"github.com/hashicorp/cdktf-provider-aws-go/aws/v10/cognitoidentitypoolrolesattachment/internal"
...
func NewCognitoIdentityPoolRolesAttachmentRoleMappingMappingRuleList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CognitoIdentityPoolRolesAttachmentRoleMappingMappingRuleList {
	...
	if err := validateNewCognitoIdentityPoolRolesAttachmentRoleMappingMappingRuleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
