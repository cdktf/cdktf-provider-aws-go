...
func (j *jsiiProxy_BedrockagentcoreTokenVaultCmkKmsConfigurationList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewBedrockagentcoreTokenVaultCmkKmsConfigurationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BedrockagentcoreTokenVaultCmkKmsConfigurationList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktf/provider-aws.bedrockagentcoreTokenVaultCmk.BedrockagentcoreTokenVaultCmkKmsConfigurationList",
...
func NewBedrockagentcoreTokenVaultCmkKmsConfigurationList_Override(b BedrockagentcoreTokenVaultCmkKmsConfigurationList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BedrockagentcoreTokenVaultCmkKmsConfigurationList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (b *jsiiProxy_BedrockagentcoreTokenVaultCmkKmsConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BedrockagentcoreTokenVaultCmkKmsConfigurationList) Resolve(_context cdktf.IResolveContext) interface{} {
