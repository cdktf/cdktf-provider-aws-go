...
import (
	...
	"github.com/hashicorp/cdktf-provider-aws-go/aws/v10/dataawssecretsmanagersecret/internal"
...
func NewDataAwsSecretsmanagerSecretRotationRulesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsSecretsmanagerSecretRotationRulesList {
	...
	if err := validateNewDataAwsSecretsmanagerSecretRotationRulesListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
