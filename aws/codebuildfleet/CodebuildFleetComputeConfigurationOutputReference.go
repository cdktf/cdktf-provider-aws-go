...
func (c *jsiiProxy_CodebuildFleetComputeConfigurationOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodebuildFleetComputeConfigurationOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
