...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/data-sources/lb_listener aws_lb_listener}.
...
func (j *jsiiProxy_DataAwsLbListener) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsLbListener) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/data-sources/lb_listener aws_lb_listener} Data Source.
...
func (j *jsiiProxy_DataAwsLbListener)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsLbListener) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
