...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/rolesanywhere_profile aws_rolesanywhere_profile} Resource.
...
func (r *jsiiProxy_RolesanywhereProfile) ResetRoleArns() {
	_jsii_.InvokeVoid(
		r,
		"resetRoleArns",
		nil, // no parameters
