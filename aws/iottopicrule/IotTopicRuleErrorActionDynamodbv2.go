...
type IotTopicRuleErrorActionDynamodbv2 struct {
	...
	// put_item block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.76.0/docs/resources/iot_topic_rule#put_item IotTopicRule#put_item}
