...
type IotTopicRuleCloudwatchLogs struct {
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.13.0/docs/resources/iot_topic_rule#log_group_name IotTopicRule#log_group_name}.
