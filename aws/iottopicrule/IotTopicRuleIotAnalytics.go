...
type IotTopicRuleIotAnalytics struct {
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.47.0/docs/resources/iot_topic_rule#channel_name IotTopicRule#channel_name}.
