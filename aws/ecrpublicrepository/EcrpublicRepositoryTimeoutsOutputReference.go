...
func (j *jsiiProxy_EcrpublicRepositoryTimeoutsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_EcrpublicRepositoryTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EcrpublicRepositoryTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_EcrpublicRepositoryTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_EcrpublicRepositoryTimeoutsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewEcrpublicRepositoryTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) EcrpublicRepositoryTimeoutsOutputReference {
	...
	if err := validateNewEcrpublicRepositoryTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_EcrpublicRepositoryTimeoutsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_EcrpublicRepositoryTimeoutsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_EcrpublicRepositoryTimeoutsOutputReference)SetInternalValue(val interface{}) {
...
func (e *jsiiProxy_EcrpublicRepositoryTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (e *jsiiProxy_EcrpublicRepositoryTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EcrpublicRepositoryTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (e *jsiiProxy_EcrpublicRepositoryTimeoutsOutputReference) ToString() *string {
	var returns *string
