...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "concurrentJobsInput", GoGetter: "ConcurrentJobsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetConcurrentJobs", GoMethod: "ResetConcurrentJobs"},
