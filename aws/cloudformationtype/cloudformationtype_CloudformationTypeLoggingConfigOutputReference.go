...
import (
	...
	"github.com/hashicorp/cdktf-provider-aws-go/aws/v10/cloudformationtype/internal"
...
func NewCloudformationTypeLoggingConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CloudformationTypeLoggingConfigOutputReference {
	...
	if err := validateNewCloudformationTypeLoggingConfigOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CloudformationTypeLoggingConfigOutputReference)SetLogRoleArn(val *string) {
	if err := j.validateSetLogRoleArnParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
