...
func (j *jsiiProxy_ChimeVoiceConnectorTerminationCredentials) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ChimeVoiceConnectorTerminationCredentials) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/chime_voice_connector_termination_credentials aws_chime_voice_connector_termination_credentials} Resource.
...
func (j *jsiiProxy_ChimeVoiceConnectorTerminationCredentials)SetRegion(val *string) {
...
func (c *jsiiProxy_ChimeVoiceConnectorTerminationCredentials) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
