...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.20.0/docs/resources/detective_invitation_accepter aws_detective_invitation_accepter}.
...
func (j *jsiiProxy_DetectiveInvitationAccepter) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DetectiveInvitationAccepter) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.20.0/docs/resources/detective_invitation_accepter aws_detective_invitation_accepter} Resource.
...
func (j *jsiiProxy_DetectiveInvitationAccepter)SetRegion(val *string) {
...
func (d *jsiiProxy_DetectiveInvitationAccepter) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
