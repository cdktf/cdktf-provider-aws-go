...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/resources/connect_user aws_connect_user}.
...
func (j *jsiiProxy_ConnectUser) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ConnectUser) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/resources/connect_user aws_connect_user} Resource.
...
func (j *jsiiProxy_ConnectUser)SetRegion(val *string) {
...
func (c *jsiiProxy_ConnectUser) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
