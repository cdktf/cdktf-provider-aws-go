...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v13/connectuser/internal"
...
func (j *jsiiProxy_ConnectUser) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ConnectUser)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
