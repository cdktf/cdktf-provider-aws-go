...
func (d *jsiiProxy_DataexchangeEventActionActionExportRevisionToS3RevisionDestinationList) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
