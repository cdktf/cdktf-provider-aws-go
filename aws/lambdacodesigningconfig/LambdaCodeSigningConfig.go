...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/lambda_code_signing_config aws_lambda_code_signing_config}.
...
func (j *jsiiProxy_LambdaCodeSigningConfig) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_LambdaCodeSigningConfig) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_LambdaCodeSigningConfig) Tags() *map[string]*string {
...
func (j *jsiiProxy_LambdaCodeSigningConfig) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_LambdaCodeSigningConfig) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_LambdaCodeSigningConfig) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/lambda_code_signing_config aws_lambda_code_signing_config} Resource.
...
func (j *jsiiProxy_LambdaCodeSigningConfig)SetRegion(val *string) {
...
func (j *jsiiProxy_LambdaCodeSigningConfig)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_LambdaCodeSigningConfig)SetTagsAll(val *map[string]*string) {
...
func (l *jsiiProxy_LambdaCodeSigningConfig) ResetRegion() {
	_jsii_.InvokeVoid(
		l,
		"resetRegion",
		nil, // no parameters
...
func (l *jsiiProxy_LambdaCodeSigningConfig) ResetTagsAll() {
	_jsii_.InvokeVoid(
		l,
		"resetTagsAll",
		nil, // no parameters
