...
func (j *jsiiProxy_DataAwsEcsService) AvailabilityZoneRebalancing() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsEcsService) LoadBalancer() DataAwsEcsServiceLoadBalancerList {
	var returns DataAwsEcsServiceLoadBalancerList
	_jsii_.Get(
		j,
		"loadBalancer",
		&returns,
...
func (j *jsiiProxy_DataAwsEcsService) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsEcsService) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/data-sources/ecs_service aws_ecs_service} Data Source.
...
func (j *jsiiProxy_DataAwsEcsService)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsEcsService) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
