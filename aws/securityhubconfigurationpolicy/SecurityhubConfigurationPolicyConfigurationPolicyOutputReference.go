...
func (s *jsiiProxy_SecurityhubConfigurationPolicyConfigurationPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SecurityhubConfigurationPolicyConfigurationPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
