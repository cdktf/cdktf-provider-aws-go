...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/s3bucketserversideencryptionconfiguration/internal"
...
func (s *jsiiProxy_S3BucketServerSideEncryptionConfigurationRuleApplyServerSideEncryptionByDefaultAOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_S3BucketServerSideEncryptionConfigurationRuleApplyServerSideEncryptionByDefaultAOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
