...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/schemasschema/internal"
...
func (j *jsiiProxy_SchemasSchema) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SchemasSchema) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/schemas_schema aws_schemas_schema} Resource.
...
func (j *jsiiProxy_SchemasSchema)SetRegion(val *string) {
...
func (s *jsiiProxy_SchemasSchema) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
