...
func (c *jsiiProxy_CloudwatchEventTargetBatchTargetOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudwatchEventTargetBatchTargetOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
