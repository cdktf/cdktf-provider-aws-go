...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v13/kmscustomkeystore/internal"
...
func (j *jsiiProxy_KmsCustomKeyStore) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_KmsCustomKeyStore)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
