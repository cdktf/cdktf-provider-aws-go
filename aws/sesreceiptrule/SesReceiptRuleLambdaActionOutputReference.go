...
func (s *jsiiProxy_SesReceiptRuleLambdaActionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SesReceiptRuleLambdaActionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
