...
func (c *jsiiProxy_ConfigConfigRuleScopeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConfigConfigRuleScopeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
