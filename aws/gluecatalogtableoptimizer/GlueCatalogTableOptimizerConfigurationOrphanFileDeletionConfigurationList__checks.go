...
func (g *jsiiProxy_GlueCatalogTableOptimizerConfigurationOrphanFileDeletionConfigurationList) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
