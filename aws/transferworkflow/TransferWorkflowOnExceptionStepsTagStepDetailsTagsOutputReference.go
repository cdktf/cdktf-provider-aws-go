...
func (t *jsiiProxy_TransferWorkflowOnExceptionStepsTagStepDetailsTagsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TransferWorkflowOnExceptionStepsTagStepDetailsTagsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
