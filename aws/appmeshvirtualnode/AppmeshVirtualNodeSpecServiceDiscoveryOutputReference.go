...
func (a *jsiiProxy_AppmeshVirtualNodeSpecServiceDiscoveryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppmeshVirtualNodeSpecServiceDiscoveryOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
