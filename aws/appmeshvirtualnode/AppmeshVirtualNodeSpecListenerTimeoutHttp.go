...
type AppmeshVirtualNodeSpecListenerTimeoutHttp struct {
	...
	// per_request block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.94.0/docs/resources/appmesh_virtual_node#per_request AppmeshVirtualNode#per_request}
