...
func (s *jsiiProxy_SsmMaintenanceWindowTargetTargetsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SsmMaintenanceWindowTargetTargetsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
