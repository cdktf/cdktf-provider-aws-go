...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v20/dataawsdxgateway/internal"
...
func (j *jsiiProxy_DataAwsDxGateway) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/dx_gateway aws_dx_gateway} Data Source.
