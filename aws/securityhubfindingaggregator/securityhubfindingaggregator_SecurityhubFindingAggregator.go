...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v11/securityhubfindingaggregator/internal"
...
func (j *jsiiProxy_SecurityhubFindingAggregator) Connection() interface{} {
...
func (j *jsiiProxy_SecurityhubFindingAggregator) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SecurityhubFindingAggregator) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SecurityhubFindingAggregator) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func NewSecurityhubFindingAggregator(scope constructs.Construct, id *string, config *SecurityhubFindingAggregatorConfig) SecurityhubFindingAggregator {
	...
	if err := validateNewSecurityhubFindingAggregatorParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SecurityhubFindingAggregator)SetConnection(val interface{}) {
...
func (j *jsiiProxy_SecurityhubFindingAggregator)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SecurityhubFindingAggregator)SetId(val *string) {
...
func (j *jsiiProxy_SecurityhubFindingAggregator)SetLinkingMode(val *string) {
	if err := j.validateSetLinkingModeParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_SecurityhubFindingAggregator)SetProvisioners(val *[]interface{}) {
...
func (j *jsiiProxy_SecurityhubFindingAggregator)SetSpecifiedRegions(val *[]*string) {
	if err := j.validateSetSpecifiedRegionsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func SecurityhubFindingAggregator_IsConstruct(x interface{}) *bool {
	...
	if err := validateSecurityhubFindingAggregator_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SecurityhubFindingAggregator_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSecurityhubFindingAggregator_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SecurityhubFindingAggregator_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSecurityhubFindingAggregator_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SecurityhubFindingAggregator) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
