...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/resources/iot_thing_type aws_iot_thing_type}.
...
func (j *jsiiProxy_IotThingType) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_IotThingType) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/resources/iot_thing_type aws_iot_thing_type} Resource.
...
func (j *jsiiProxy_IotThingType)SetRegion(val *string) {
...
func (i *jsiiProxy_IotThingType) ResetRegion() {
	_jsii_.InvokeVoid(
		i,
		"resetRegion",
		nil, // no parameters
