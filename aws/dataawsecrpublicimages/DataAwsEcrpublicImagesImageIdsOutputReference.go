...
func (d *jsiiProxy_DataAwsEcrpublicImagesImageIdsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsEcrpublicImagesImageIdsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
