...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTagPolicyCompliance", GoMethod: "ResetTagPolicyCompliance"},
			...
			_jsii_.MemberProperty{JsiiProperty: "tagPolicyCompliance", GoGetter: "TagPolicyCompliance"},
			_jsii_.MemberProperty{JsiiProperty: "tagPolicyComplianceInput", GoGetter: "TagPolicyComplianceInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "tokenBucketRateLimiterCapacity", GoGetter: "TokenBucketRateLimiterCapacity"},
			_jsii_.MemberProperty{JsiiProperty: "tokenBucketRateLimiterCapacityInput", GoGetter: "TokenBucketRateLimiterCapacityInput"},
