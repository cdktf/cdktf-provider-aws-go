...
func (b *jsiiProxy_BudgetsBudgetActionActionThresholdOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BudgetsBudgetActionActionThresholdOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
