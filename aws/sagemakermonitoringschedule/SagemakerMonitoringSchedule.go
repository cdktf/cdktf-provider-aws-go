...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v13/sagemakermonitoringschedule/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://www.terraform.io/docs/providers/aws/r/sagemaker_monitoring_schedule aws_sagemaker_monitoring_schedule}.
...
func (j *jsiiProxy_SagemakerMonitoringSchedule) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://www.terraform.io/docs/providers/aws/r/sagemaker_monitoring_schedule aws_sagemaker_monitoring_schedule} Resource.
...
func (j *jsiiProxy_SagemakerMonitoringSchedule)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
