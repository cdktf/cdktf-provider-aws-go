...
func (s *jsiiProxy_S3BucketWebsiteConfigurationRoutingRuleRedirectOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_S3BucketWebsiteConfigurationRoutingRuleRedirectOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
