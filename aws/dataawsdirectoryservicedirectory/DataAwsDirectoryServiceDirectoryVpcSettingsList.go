...
func NewDataAwsDirectoryServiceDirectoryVpcSettingsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsDirectoryServiceDirectoryVpcSettingsList {
	...
	if err := validateNewDataAwsDirectoryServiceDirectoryVpcSettingsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsDirectoryServiceDirectoryVpcSettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsDirectoryServiceDirectoryVpcSettingsList) Resolve(context cdktf.IResolveContext) interface{} {
