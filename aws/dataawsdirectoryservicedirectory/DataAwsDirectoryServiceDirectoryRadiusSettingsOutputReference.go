...
func (d *jsiiProxy_DataAwsDirectoryServiceDirectoryRadiusSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsDirectoryServiceDirectoryRadiusSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
