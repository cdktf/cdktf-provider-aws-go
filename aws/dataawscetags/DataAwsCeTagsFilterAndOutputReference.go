...
func (d *jsiiProxy_DataAwsCeTagsFilterAndOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsCeTagsFilterAndOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
