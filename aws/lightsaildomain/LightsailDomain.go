...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/lightsaildomain/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/resources/lightsail_domain aws_lightsail_domain}.
...
func (j *jsiiProxy_LightsailDomain) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_LightsailDomain) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/resources/lightsail_domain aws_lightsail_domain} Resource.
...
func (j *jsiiProxy_LightsailDomain)SetRegion(val *string) {
...
func (l *jsiiProxy_LightsailDomain) ResetRegion() {
	_jsii_.InvokeVoid(
		l,
		"resetRegion",
		nil, // no parameters
