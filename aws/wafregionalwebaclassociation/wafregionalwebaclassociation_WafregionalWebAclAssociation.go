...
import (
	...
	"github.com/hashicorp/cdktf-provider-aws-go/aws/v10/wafregionalwebaclassociation/internal"
...
func NewWafregionalWebAclAssociation(scope constructs.Construct, id *string, config *WafregionalWebAclAssociationConfig) WafregionalWebAclAssociation {
	...
	if err := validateNewWafregionalWebAclAssociationParameters(scope, id, config); err != nil {
		panic(err)
	}
