...
import (
	...
	"github.com/hashicorp/cdktf-provider-aws-go/aws/v10/opsworksnodejsapplayer/internal"
...
type OpsworksNodejsAppLayerCloudwatchConfigurationOutputReference interface {
	...
	LogStreams() OpsworksNodejsAppLayerCloudwatchConfigurationLogStreamsList
...
func (j *jsiiProxy_OpsworksNodejsAppLayerCloudwatchConfigurationOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_OpsworksNodejsAppLayerCloudwatchConfigurationOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_OpsworksNodejsAppLayerCloudwatchConfigurationOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_OpsworksNodejsAppLayerCloudwatchConfigurationOutputReference) LogStreams() OpsworksNodejsAppLayerCloudwatchConfigurationLogStreamsList {
	var returns OpsworksNodejsAppLayerCloudwatchConfigurationLogStreamsList
	_jsii_.Get(
		j,
		"logStreams",
		&returns,
...
func (j *jsiiProxy_OpsworksNodejsAppLayerCloudwatchConfigurationOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_OpsworksNodejsAppLayerCloudwatchConfigurationOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (o *jsiiProxy_OpsworksNodejsAppLayerCloudwatchConfigurationOutputReference) ComputeFqn() *string {
	var returns *string
...
func (o *jsiiProxy_OpsworksNodejsAppLayerCloudwatchConfigurationOutputReference) PutLogStreams(value interface{}) {
...
func (o *jsiiProxy_OpsworksNodejsAppLayerCloudwatchConfigurationOutputReference) ToString() *string {
	var returns *string
