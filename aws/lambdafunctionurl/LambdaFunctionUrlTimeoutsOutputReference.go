...
func (l *jsiiProxy_LambdaFunctionUrlTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LambdaFunctionUrlTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
