...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/data-sources/kms_secret aws_kms_secret}.
...
func (j *jsiiProxy_DataAwsKmsSecret) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsKmsSecret) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/data-sources/kms_secret aws_kms_secret} Data Source.
...
func (j *jsiiProxy_DataAwsKmsSecret)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsKmsSecret) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
