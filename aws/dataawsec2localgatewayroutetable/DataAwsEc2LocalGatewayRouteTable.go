...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawsec2localgatewayroutetable/internal"
...
func (j *jsiiProxy_DataAwsEc2LocalGatewayRouteTable) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataAwsEc2LocalGatewayRouteTable)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
