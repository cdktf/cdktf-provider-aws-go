...
func (g *jsiiProxy_GuarddutyInviteAccepterTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GuarddutyInviteAccepterTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
