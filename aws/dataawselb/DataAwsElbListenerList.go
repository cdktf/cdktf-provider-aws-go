...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/dataawselb/internal"
...
func (d *jsiiProxy_DataAwsElbListenerList) Resolve(context cdktf.IResolveContext) interface{} {
