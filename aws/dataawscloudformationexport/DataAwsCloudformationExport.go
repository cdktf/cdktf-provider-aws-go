...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/data-sources/cloudformation_export aws_cloudformation_export}.
...
func (j *jsiiProxy_DataAwsCloudformationExport) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsCloudformationExport) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/data-sources/cloudformation_export aws_cloudformation_export} Data Source.
...
func (j *jsiiProxy_DataAwsCloudformationExport)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsCloudformationExport) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
