...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "graphNamePrefix", GoGetter: "GraphNamePrefix"},
			_jsii_.MemberProperty{JsiiProperty: "graphNamePrefixInput", GoGetter: "GraphNamePrefixInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetGraphNamePrefix", GoMethod: "ResetGraphNamePrefix"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_NeptunegraphGraphTimeoutsOutputReference{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_NeptunegraphGraphVectorSearchConfigurationList{}
