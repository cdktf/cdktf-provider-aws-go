...
func (s *jsiiProxy_SagemakerAppImageConfigKernelGatewayImageConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerAppImageConfigKernelGatewayImageConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
