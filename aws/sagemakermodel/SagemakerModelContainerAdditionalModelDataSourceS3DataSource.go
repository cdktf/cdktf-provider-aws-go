...
type SagemakerModelContainerAdditionalModelDataSourceS3DataSource struct {
	...
	ModelAccessConfig *SagemakerModelContainerAdditionalModelDataSourceS3DataSourceModelAccessConfig `field:"optional" json:"modelAccessConfig" yaml:"modelAccessConfig"`
}
