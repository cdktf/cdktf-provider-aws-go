...
func (s *jsiiProxy_SagemakerModelContainerModelDataSourceS3DataSourceList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (s *jsiiProxy_SagemakerModelContainerModelDataSourceS3DataSourceList) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_SagemakerModelContainerModelDataSourceS3DataSourceList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_SagemakerModelContainerModelDataSourceS3DataSourceList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
