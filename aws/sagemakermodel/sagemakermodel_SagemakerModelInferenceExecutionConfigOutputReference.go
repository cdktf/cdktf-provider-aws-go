...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v12/sagemakermodel/internal"
...
func (s *jsiiProxy_SagemakerModelInferenceExecutionConfigOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
