...
func (s *jsiiProxy_SagemakerModelVpcConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerModelVpcConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
