...
func (l *jsiiProxy_LakeformationDataCellsFilterTableDataRowFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LakeformationDataCellsFilterTableDataRowFilterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
