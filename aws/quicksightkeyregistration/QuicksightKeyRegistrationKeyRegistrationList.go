...
func (j *jsiiProxy_QuicksightKeyRegistrationKeyRegistrationList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_QuicksightKeyRegistrationKeyRegistrationList) InternalValue() interface{} {
...
func (j *jsiiProxy_QuicksightKeyRegistrationKeyRegistrationList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_QuicksightKeyRegistrationKeyRegistrationList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_QuicksightKeyRegistrationKeyRegistrationList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_QuicksightKeyRegistrationKeyRegistrationList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_QuicksightKeyRegistrationKeyRegistrationList)SetWrapsSet(val *bool) {
...
func (q *jsiiProxy_QuicksightKeyRegistrationKeyRegistrationList) ComputeFqn() *string {
	var returns *string
...
func (q *jsiiProxy_QuicksightKeyRegistrationKeyRegistrationList) Get(index *float64) QuicksightKeyRegistrationKeyRegistrationOutputReference {
	if err := q.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns QuicksightKeyRegistrationKeyRegistrationOutputReference
...
func (q *jsiiProxy_QuicksightKeyRegistrationKeyRegistrationList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (q *jsiiProxy_QuicksightKeyRegistrationKeyRegistrationList) ToString() *string {
	var returns *string
