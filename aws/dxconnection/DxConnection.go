...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/dxconnection/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/resources/dx_connection aws_dx_connection}.
...
func (j *jsiiProxy_DxConnection) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DxConnection) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/resources/dx_connection aws_dx_connection} Resource.
...
func (j *jsiiProxy_DxConnection)SetRegion(val *string) {
...
func (d *jsiiProxy_DxConnection) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
