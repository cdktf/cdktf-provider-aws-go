...
func (w *jsiiProxy_WorkspacesIpGroupRulesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WorkspacesIpGroupRulesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
