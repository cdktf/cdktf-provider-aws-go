...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/ses_receipt_rule_set aws_ses_receipt_rule_set}.
...
func (j *jsiiProxy_SesReceiptRuleSet) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SesReceiptRuleSet) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/ses_receipt_rule_set aws_ses_receipt_rule_set} Resource.
...
func (j *jsiiProxy_SesReceiptRuleSet)SetRegion(val *string) {
...
func (s *jsiiProxy_SesReceiptRuleSet) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
