...
func (p *jsiiProxy_PipesPipeTargetParametersEventbridgeEventBusParametersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PipesPipeTargetParametersEventbridgeEventBusParametersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
