...
type PipesPipeConfig struct {
	...
	SourceParameters *PipesPipeSourceParameters `field:"required" json:"sourceParameters" yaml:"sourceParameters"`
	...
	TargetParameters *PipesPipeTargetParameters `field:"required" json:"targetParameters" yaml:"targetParameters"`
