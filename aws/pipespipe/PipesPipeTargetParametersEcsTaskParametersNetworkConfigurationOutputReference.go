...
func (p *jsiiProxy_PipesPipeTargetParametersEcsTaskParametersNetworkConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PipesPipeTargetParametersEcsTaskParametersNetworkConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
