...
func (c *jsiiProxy_ConfigConfigurationRecorderRecordingGroupRecordingStrategyOutputReference) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
