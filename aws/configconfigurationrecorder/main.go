...
func init() {
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_ConfigConfigurationRecorderRecordingGroupExclusionByResourceTypesList{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_ConfigConfigurationRecorderRecordingGroupExclusionByResourceTypesOutputReference{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_ConfigConfigurationRecorderRecordingGroupRecordingStrategyOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
