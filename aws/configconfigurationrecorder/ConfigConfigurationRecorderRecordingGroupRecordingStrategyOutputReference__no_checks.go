...
func (c *jsiiProxy_ConfigConfigurationRecorderRecordingGroupRecordingStrategyOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	return nil
}

func (c *jsiiProxy_ConfigConfigurationRecorderRecordingGroupRecordingStrategyOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_ConfigConfigurationRecorderRecordingGroupRecordingStrategyOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	return nil
}
...
func validateNewConfigConfigurationRecorderRecordingGroupRecordingStrategyOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) error {
	return nil
}
