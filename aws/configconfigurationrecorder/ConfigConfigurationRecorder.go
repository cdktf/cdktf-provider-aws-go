...
func NewConfigConfigurationRecorder(scope constructs.Construct, id *string, config *ConfigConfigurationRecorderConfig) ConfigConfigurationRecorder {
	...
	if err := validateNewConfigConfigurationRecorderParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ConfigConfigurationRecorder_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateConfigConfigurationRecorder_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ConfigConfigurationRecorder) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ConfigConfigurationRecorder) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ConfigConfigurationRecorder) MoveFromId(id *string) {
...
func (c *jsiiProxy_ConfigConfigurationRecorder) MoveToId(id *string) {
...
func (c *jsiiProxy_ConfigConfigurationRecorder) PutRecordingGroup(value *ConfigConfigurationRecorderRecordingGroup) {
	if err := c.validatePutRecordingGroupParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
