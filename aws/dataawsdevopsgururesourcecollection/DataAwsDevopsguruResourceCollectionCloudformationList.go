...
func (j *jsiiProxy_DataAwsDevopsguruResourceCollectionCloudformationList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsDevopsguruResourceCollectionCloudformationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsDevopsguruResourceCollectionCloudformationList {
	_init_.Initialize()
...
func NewDataAwsDevopsguruResourceCollectionCloudformationList_Override(d DataAwsDevopsguruResourceCollectionCloudformationList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsDevopsguruResourceCollectionCloudformationList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsDevopsguruResourceCollectionCloudformationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsDevopsguruResourceCollectionCloudformationList) Resolve(_context cdktf.IResolveContext) interface{} {
