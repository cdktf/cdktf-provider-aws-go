...
func (j *jsiiProxy_QuicksightFolder) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_QuicksightFolder) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/resources/quicksight_folder aws_quicksight_folder} Resource.
...
func (j *jsiiProxy_QuicksightFolder)SetRegion(val *string) {
...
func (q *jsiiProxy_QuicksightFolder) ResetRegion() {
	_jsii_.InvokeVoid(
		q,
		"resetRegion",
		nil, // no parameters
