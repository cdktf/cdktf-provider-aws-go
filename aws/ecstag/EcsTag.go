...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/ecstag/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/ecs_tag aws_ecs_tag}.
...
func (j *jsiiProxy_EcsTag) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_EcsTag) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/ecs_tag aws_ecs_tag} Resource.
...
func (j *jsiiProxy_EcsTag)SetRegion(val *string) {
...
func (e *jsiiProxy_EcsTag) ResetRegion() {
	_jsii_.InvokeVoid(
		e,
		"resetRegion",
		nil, // no parameters
