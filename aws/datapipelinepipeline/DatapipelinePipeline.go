...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/datapipelinepipeline/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/resources/datapipeline_pipeline aws_datapipeline_pipeline}.
...
func (j *jsiiProxy_DatapipelinePipeline) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DatapipelinePipeline) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/resources/datapipeline_pipeline aws_datapipeline_pipeline} Resource.
...
func (d *jsiiProxy_DatapipelinePipeline) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
