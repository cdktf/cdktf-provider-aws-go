...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/sagemakerimage/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/sagemaker_image aws_sagemaker_image}.
...
func (j *jsiiProxy_SagemakerImage) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SagemakerImage) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/sagemaker_image aws_sagemaker_image} Resource.
...
func (j *jsiiProxy_SagemakerImage)SetRegion(val *string) {
...
func (s *jsiiProxy_SagemakerImage) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
