...
func (j *jsiiProxy_ChimeVoiceConnectorLogging) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ChimeVoiceConnectorLogging) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/resources/chime_voice_connector_logging aws_chime_voice_connector_logging} Resource.
...
func (j *jsiiProxy_ChimeVoiceConnectorLogging)SetRegion(val *string) {
...
func (c *jsiiProxy_ChimeVoiceConnectorLogging) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
