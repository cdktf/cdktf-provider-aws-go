...
func (c *jsiiProxy_CustomerprofilesDomainRuleBasedMatchingExportingConfigS3ExportingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CustomerprofilesDomainRuleBasedMatchingExportingConfigS3ExportingOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
