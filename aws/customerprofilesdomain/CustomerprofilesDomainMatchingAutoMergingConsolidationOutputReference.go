...
func (c *jsiiProxy_CustomerprofilesDomainMatchingAutoMergingConsolidationOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CustomerprofilesDomainMatchingAutoMergingConsolidationOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
