...
func (c *jsiiProxy_CloudformationStackSetInstanceOperationPreferencesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudformationStackSetInstanceOperationPreferencesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
