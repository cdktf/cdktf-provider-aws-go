...
func (c *jsiiProxy_CloudformationStackSetInstanceTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudformationStackSetInstanceTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
