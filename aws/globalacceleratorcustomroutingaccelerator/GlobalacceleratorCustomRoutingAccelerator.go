...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v13/globalacceleratorcustomroutingaccelerator/internal"
...
func (j *jsiiProxy_GlobalacceleratorCustomRoutingAccelerator) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_GlobalacceleratorCustomRoutingAccelerator)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
