...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/dataawsefsaccesspoints/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/data-sources/efs_access_points aws_efs_access_points}.
...
func (j *jsiiProxy_DataAwsEfsAccessPoints) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsEfsAccessPoints) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/data-sources/efs_access_points aws_efs_access_points} Data Source.
...
func (j *jsiiProxy_DataAwsEfsAccessPoints)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsEfsAccessPoints) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
