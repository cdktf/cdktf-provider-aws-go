...
import (
	...
	"github.com/hashicorp/cdktf-provider-aws-go/aws/v10/elasticsearchdomain/internal"
...
func NewElasticsearchDomainNodeToNodeEncryptionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ElasticsearchDomainNodeToNodeEncryptionOutputReference {
	...
	if err := validateNewElasticsearchDomainNodeToNodeEncryptionOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
