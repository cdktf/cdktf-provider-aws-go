...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/dbproxyendpoint/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/resources/db_proxy_endpoint aws_db_proxy_endpoint}.
...
func (j *jsiiProxy_DbProxyEndpoint) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DbProxyEndpoint) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/resources/db_proxy_endpoint aws_db_proxy_endpoint} Resource.
...
func (j *jsiiProxy_DbProxyEndpoint)SetRegion(val *string) {
...
func (d *jsiiProxy_DbProxyEndpoint) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
