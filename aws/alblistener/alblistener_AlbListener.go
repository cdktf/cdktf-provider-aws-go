...
import (
	...
	"github.com/hashicorp/cdktf-provider-aws-go/aws/v10/alblistener/internal"
...
func (j *jsiiProxy_AlbListener) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_AlbListener)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
