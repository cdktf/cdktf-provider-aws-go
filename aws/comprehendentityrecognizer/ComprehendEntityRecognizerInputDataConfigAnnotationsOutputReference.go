...
func (c *jsiiProxy_ComprehendEntityRecognizerInputDataConfigAnnotationsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComprehendEntityRecognizerInputDataConfigAnnotationsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
