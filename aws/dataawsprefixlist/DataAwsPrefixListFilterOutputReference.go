...
func (d *jsiiProxy_DataAwsPrefixListFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsPrefixListFilterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
