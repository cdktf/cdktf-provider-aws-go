...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/kmsreplicakey/internal"
...
func (j *jsiiProxy_KmsReplicaKey) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_KmsReplicaKey) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/kms_replica_key aws_kms_replica_key} Resource.
...
func (j *jsiiProxy_KmsReplicaKey)SetRegion(val *string) {
...
func (k *jsiiProxy_KmsReplicaKey) ResetRegion() {
	_jsii_.InvokeVoid(
		k,
		"resetRegion",
		nil, // no parameters
