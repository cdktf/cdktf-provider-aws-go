...
func (j *jsiiProxy_VpcDhcpOptions) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_VpcDhcpOptions) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/vpc_dhcp_options aws_vpc_dhcp_options} Resource.
...
func (j *jsiiProxy_VpcDhcpOptions)SetRegion(val *string) {
...
func (v *jsiiProxy_VpcDhcpOptions) ResetRegion() {
	_jsii_.InvokeVoid(
		v,
		"resetRegion",
		nil, // no parameters
