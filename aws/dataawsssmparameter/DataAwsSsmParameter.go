...
func (j *jsiiProxy_DataAwsSsmParameter) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsSsmParameter) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/data-sources/ssm_parameter aws_ssm_parameter} Data Source.
...
func (j *jsiiProxy_DataAwsSsmParameter)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsSsmParameter) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
