...
func (r *jsiiProxy_RouteTable) validatePutRouteParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*RouteTableRoute; received %#v (a %T)", value, value)
		}
	}
