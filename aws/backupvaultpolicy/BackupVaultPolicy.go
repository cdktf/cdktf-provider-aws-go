...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/backupvaultpolicy/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.20.0/docs/resources/backup_vault_policy aws_backup_vault_policy}.
...
func (j *jsiiProxy_BackupVaultPolicy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_BackupVaultPolicy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.20.0/docs/resources/backup_vault_policy aws_backup_vault_policy} Resource.
...
func (j *jsiiProxy_BackupVaultPolicy)SetRegion(val *string) {
...
func (b *jsiiProxy_BackupVaultPolicy) ResetRegion() {
	_jsii_.InvokeVoid(
		b,
		"resetRegion",
		nil, // no parameters
