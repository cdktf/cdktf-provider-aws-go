...
type DataAwsWorkspacesDirectory interface {
	...
	CertificateBasedAuthProperties() DataAwsWorkspacesDirectoryCertificateBasedAuthPropertiesList
	// Experimental.
...
func (j *jsiiProxy_DataAwsWorkspacesDirectory) CertificateBasedAuthProperties() DataAwsWorkspacesDirectoryCertificateBasedAuthPropertiesList {
	var returns DataAwsWorkspacesDirectoryCertificateBasedAuthPropertiesList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsWorkspacesDirectory) SamlProperties() DataAwsWorkspacesDirectorySamlPropertiesList {
	var returns DataAwsWorkspacesDirectorySamlPropertiesList
	_jsii_.Get(
		j,
		"samlProperties",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/data-sources/workspaces_directory aws_workspaces_directory} Data Source.
