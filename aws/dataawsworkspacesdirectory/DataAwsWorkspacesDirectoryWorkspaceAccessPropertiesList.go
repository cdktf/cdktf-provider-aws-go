...
func NewDataAwsWorkspacesDirectoryWorkspaceAccessPropertiesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsWorkspacesDirectoryWorkspaceAccessPropertiesList {
	...
	if err := validateNewDataAwsWorkspacesDirectoryWorkspaceAccessPropertiesListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsWorkspacesDirectoryWorkspaceAccessPropertiesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsWorkspacesDirectoryWorkspaceAccessPropertiesList) Resolve(context cdktf.IResolveContext) interface{} {
