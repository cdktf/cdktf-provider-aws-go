...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/dmscertificate/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/resources/dms_certificate aws_dms_certificate}.
...
func (j *jsiiProxy_DmsCertificate) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DmsCertificate) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/resources/dms_certificate aws_dms_certificate} Resource.
...
func (j *jsiiProxy_DmsCertificate)SetRegion(val *string) {
...
func (d *jsiiProxy_DmsCertificate) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
