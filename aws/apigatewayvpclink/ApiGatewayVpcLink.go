...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/apigatewayvpclink/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/resources/api_gateway_vpc_link aws_api_gateway_vpc_link}.
...
func (j *jsiiProxy_ApiGatewayVpcLink) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ApiGatewayVpcLink) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/resources/api_gateway_vpc_link aws_api_gateway_vpc_link} Resource.
...
func (j *jsiiProxy_ApiGatewayVpcLink)SetRegion(val *string) {
...
func (a *jsiiProxy_ApiGatewayVpcLink) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
