...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/dataawscodestarconnectionsconnection/internal"
...
func (j *jsiiProxy_DataAwsCodestarconnectionsConnection) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsCodestarconnectionsConnection) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.25.0/docs/data-sources/codestarconnections_connection aws_codestarconnections_connection} Data Source.
...
func (j *jsiiProxy_DataAwsCodestarconnectionsConnection)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsCodestarconnectionsConnection) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
