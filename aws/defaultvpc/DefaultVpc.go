...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v12/defaultvpc/internal"
...
func (j *jsiiProxy_DefaultVpc) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DefaultVpc)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
