...
func (j *jsiiProxy_IotCertificate) CaPem() *string {
	var returns *string
	_jsii_.Get(
		j,
		"caPem",
...
func (j *jsiiProxy_IotCertificate) CaPemInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"caPemInput",
...
func (j *jsiiProxy_IotCertificate) CertificatePemInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"certificatePemInput",
...
func (j *jsiiProxy_IotCertificate) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IotCertificate) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewIotCertificate(scope constructs.Construct, id *string, config *IotCertificateConfig) IotCertificate {
	...
	if err := validateNewIotCertificateParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IotCertificate) ResetCaPem() {
	_jsii_.InvokeVoid(
		i,
		"resetCaPem",
		nil, // no parameters
...
func (i *jsiiProxy_IotCertificate) ResetCertificatePem() {
	_jsii_.InvokeVoid(
		i,
		"resetCertificatePem",
		nil, // no parameters
...
func (i *jsiiProxy_IotCertificate) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
