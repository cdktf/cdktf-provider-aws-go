...
func (a *jsiiProxy_AcmpcaCertificateAuthorityRevocationConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AcmpcaCertificateAuthorityRevocationConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
