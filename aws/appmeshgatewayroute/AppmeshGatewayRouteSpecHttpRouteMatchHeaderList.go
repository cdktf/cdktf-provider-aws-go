...
func (a *jsiiProxy_AppmeshGatewayRouteSpecHttpRouteMatchHeaderList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AppmeshGatewayRouteSpecHttpRouteMatchHeaderList) Resolve(context cdktf.IResolveContext) interface{} {
