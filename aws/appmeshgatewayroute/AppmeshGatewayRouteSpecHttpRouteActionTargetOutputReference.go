...
func (a *jsiiProxy_AppmeshGatewayRouteSpecHttpRouteActionTargetOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppmeshGatewayRouteSpecHttpRouteActionTargetOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
