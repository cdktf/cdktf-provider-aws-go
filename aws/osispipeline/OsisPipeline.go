...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/resources/osis_pipeline aws_osis_pipeline}.
...
func (j *jsiiProxy_OsisPipeline) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_OsisPipeline) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/resources/osis_pipeline aws_osis_pipeline} Resource.
...
func (j *jsiiProxy_OsisPipeline)SetRegion(val *string) {
...
func (o *jsiiProxy_OsisPipeline) ResetRegion() {
	_jsii_.InvokeVoid(
		o,
		"resetRegion",
		nil, // no parameters
