...
func (o *jsiiProxy_OsisPipelineLogPublishingOptionsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OsisPipelineLogPublishingOptionsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
