...
func (a *jsiiProxy_AppstreamImageBuilderDomainJoinInfoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppstreamImageBuilderDomainJoinInfoOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
