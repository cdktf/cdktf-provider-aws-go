...
func (d *jsiiProxy_DxGatewayAssociationTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DxGatewayAssociationTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
