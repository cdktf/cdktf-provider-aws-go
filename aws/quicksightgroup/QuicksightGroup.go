...
func (j *jsiiProxy_QuicksightGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_QuicksightGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/quicksight_group aws_quicksight_group} Resource.
...
func (j *jsiiProxy_QuicksightGroup)SetRegion(val *string) {
...
func (q *jsiiProxy_QuicksightGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		q,
		"resetRegion",
		nil, // no parameters
