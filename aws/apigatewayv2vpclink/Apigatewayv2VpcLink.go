...
func (j *jsiiProxy_Apigatewayv2VpcLink) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Apigatewayv2VpcLink) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.20.0/docs/resources/apigatewayv2_vpc_link aws_apigatewayv2_vpc_link} Resource.
...
func (j *jsiiProxy_Apigatewayv2VpcLink)SetRegion(val *string) {
...
func (a *jsiiProxy_Apigatewayv2VpcLink) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
