...
import (
	...
	"github.com/hashicorp/cdktf-provider-aws-go/aws/v10/sesemailidentity/internal"
...
func (j *jsiiProxy_SesEmailIdentity) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (s *jsiiProxy_SesEmailIdentity) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
