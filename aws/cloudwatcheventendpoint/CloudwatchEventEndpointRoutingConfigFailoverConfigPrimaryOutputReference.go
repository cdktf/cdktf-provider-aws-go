...
func (j *jsiiProxy_CloudwatchEventEndpointRoutingConfigFailoverConfigPrimaryOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewCloudwatchEventEndpointRoutingConfigFailoverConfigPrimaryOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CloudwatchEventEndpointRoutingConfigFailoverConfigPrimaryOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktf/provider-aws.cloudwatchEventEndpoint.CloudwatchEventEndpointRoutingConfigFailoverConfigPrimaryOutputReference",
...
func NewCloudwatchEventEndpointRoutingConfigFailoverConfigPrimaryOutputReference_Override(c CloudwatchEventEndpointRoutingConfigFailoverConfigPrimaryOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudwatchEventEndpointRoutingConfigFailoverConfigPrimaryOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudwatchEventEndpointRoutingConfigFailoverConfigPrimaryOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudwatchEventEndpointRoutingConfigFailoverConfigPrimaryOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (c *jsiiProxy_CloudwatchEventEndpointRoutingConfigFailoverConfigPrimaryOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudwatchEventEndpointRoutingConfigFailoverConfigPrimaryOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
