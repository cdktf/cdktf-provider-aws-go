...
func (d *jsiiProxy_DataAwsEc2ClientVpnEndpointClientConnectOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsEc2ClientVpnEndpointClientConnectOptionsList) Resolve(context cdktf.IResolveContext) interface{} {
