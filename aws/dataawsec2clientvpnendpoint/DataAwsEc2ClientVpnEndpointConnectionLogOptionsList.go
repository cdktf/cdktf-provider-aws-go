...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/dataawsec2clientvpnendpoint/internal"
...
func (d *jsiiProxy_DataAwsEc2ClientVpnEndpointConnectionLogOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsEc2ClientVpnEndpointConnectionLogOptionsList) Resolve(context cdktf.IResolveContext) interface{} {
