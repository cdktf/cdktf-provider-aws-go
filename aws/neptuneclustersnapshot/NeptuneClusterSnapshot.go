...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/neptune_cluster_snapshot aws_neptune_cluster_snapshot}.
...
func (j *jsiiProxy_NeptuneClusterSnapshot) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_NeptuneClusterSnapshot) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/neptune_cluster_snapshot aws_neptune_cluster_snapshot} Resource.
...
func (j *jsiiProxy_NeptuneClusterSnapshot)SetRegion(val *string) {
...
func (n *jsiiProxy_NeptuneClusterSnapshot) ResetRegion() {
	_jsii_.InvokeVoid(
		n,
		"resetRegion",
		nil, // no parameters
