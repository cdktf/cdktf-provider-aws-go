...
func (j *jsiiProxy_Route53RecordAliasList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*Route53RecordAlias; received %#v (a %T)", val, val)
		}
	}
