...
func (j *jsiiProxy_DataAwsRoute53Zone) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsRoute53Zone) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsRoute53Zone(scope constructs.Construct, id *string, config *DataAwsRoute53ZoneConfig) DataAwsRoute53Zone {
	...
	if err := validateNewDataAwsRoute53ZoneParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsRoute53Zone) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
