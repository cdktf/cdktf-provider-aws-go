...
func (c *jsiiProxy_CodedeployDeploymentGroupAutoRollbackConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodedeployDeploymentGroupAutoRollbackConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
