...
func (c *jsiiProxy_CodedeployDeploymentGroupTriggerConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodedeployDeploymentGroupTriggerConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
