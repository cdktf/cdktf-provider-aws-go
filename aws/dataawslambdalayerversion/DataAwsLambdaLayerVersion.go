...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v19/dataawslambdalayerversion/internal"
...
func (j *jsiiProxy_DataAwsLambdaLayerVersion) CodeSha256() *string {
	var returns *string
	_jsii_.Get(
		j,
		"codeSha256",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.72.0/docs/data-sources/lambda_layer_version aws_lambda_layer_version} Data Source.
