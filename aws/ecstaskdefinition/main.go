...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTrackLatest", GoMethod: "ResetTrackLatest"},
			...
			_jsii_.MemberProperty{JsiiProperty: "trackLatest", GoGetter: "TrackLatest"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "configureAtLaunchInput", GoGetter: "ConfigureAtLaunchInput"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
