...
import (
	...
	"github.com/hashicorp/cdktf-provider-aws-go/aws/v10/ecstaskdefinition/internal"
...
func NewEcsTaskDefinitionRuntimePlatformOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) EcsTaskDefinitionRuntimePlatformOutputReference {
	...
	if err := validateNewEcsTaskDefinitionRuntimePlatformOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
