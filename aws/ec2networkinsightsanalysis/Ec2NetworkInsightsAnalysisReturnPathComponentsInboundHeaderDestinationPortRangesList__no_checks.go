...
func (e *jsiiProxy_Ec2NetworkInsightsAnalysisReturnPathComponentsInboundHeaderDestinationPortRangesList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (e *jsiiProxy_Ec2NetworkInsightsAnalysisReturnPathComponentsInboundHeaderDestinationPortRangesList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
