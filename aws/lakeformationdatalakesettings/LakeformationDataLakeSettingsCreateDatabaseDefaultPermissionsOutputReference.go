...
func (l *jsiiProxy_LakeformationDataLakeSettingsCreateDatabaseDefaultPermissionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LakeformationDataLakeSettingsCreateDatabaseDefaultPermissionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
