...
import (
	...
	"github.com/hashicorp/cdktf-provider-aws-go/aws/v10/codestarconnectionshost/internal"
...
func (j *jsiiProxy_CodestarconnectionsHostVpcConfigurationOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CodestarconnectionsHostVpcConfigurationOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CodestarconnectionsHostVpcConfigurationOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewCodestarconnectionsHostVpcConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CodestarconnectionsHostVpcConfigurationOutputReference {
	...
	if err := validateNewCodestarconnectionsHostVpcConfigurationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewCodestarconnectionsHostVpcConfigurationOutputReference_Override(c CodestarconnectionsHostVpcConfigurationOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (c *jsiiProxy_CodestarconnectionsHostVpcConfigurationOutputReference) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_CodestarconnectionsHostVpcConfigurationOutputReference) ToString() *string {
	var returns *string
