...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/data-sources/signer_signing_job aws_signer_signing_job}.
...
func (j *jsiiProxy_DataAwsSignerSigningJob) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsSignerSigningJob) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/data-sources/signer_signing_job aws_signer_signing_job} Data Source.
...
func (j *jsiiProxy_DataAwsSignerSigningJob)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsSignerSigningJob) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
