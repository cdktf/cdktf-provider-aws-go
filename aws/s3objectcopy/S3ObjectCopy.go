...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/s3_object_copy aws_s3_object_copy}.
type S3ObjectCopy interface {
	...
	PutOverrideProvider(value *S3ObjectCopyOverrideProvider)
	ResetAcl()
...
func (j *jsiiProxy_S3ObjectCopy) OverrideProvider() S3ObjectCopyOverrideProviderOutputReference {
	var returns S3ObjectCopyOverrideProviderOutputReference
	_jsii_.Get(
		j,
		"overrideProvider",
		&returns,
...
func (j *jsiiProxy_S3ObjectCopy) OverrideProviderInput() *S3ObjectCopyOverrideProvider {
...
func (j *jsiiProxy_S3ObjectCopy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_S3ObjectCopy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/s3_object_copy aws_s3_object_copy} Resource.
...
func (j *jsiiProxy_S3ObjectCopy)SetRegion(val *string) {
...
func (s *jsiiProxy_S3ObjectCopy) PutOverrideProvider(value *S3ObjectCopyOverrideProvider) {
...
func (s *jsiiProxy_S3ObjectCopy) ResetOverrideProvider() {
	_jsii_.InvokeVoid(
		s,
		"resetOverrideProvider",
		nil, // no parameters
...
func (s *jsiiProxy_S3ObjectCopy) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
