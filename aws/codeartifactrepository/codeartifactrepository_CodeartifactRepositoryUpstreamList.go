...
import (
	...
	"github.com/hashicorp/cdktf-provider-aws-go/aws/v10/codeartifactrepository/internal"
...
func NewCodeartifactRepositoryUpstreamList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CodeartifactRepositoryUpstreamList {
	...
	if err := validateNewCodeartifactRepositoryUpstreamListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
