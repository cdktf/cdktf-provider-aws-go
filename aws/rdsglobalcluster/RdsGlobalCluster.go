...
func (j *jsiiProxy_RdsGlobalCluster) Endpoint() *string {
	var returns *string
	_jsii_.Get(
		j,
		"endpoint",
...
func (j *jsiiProxy_RdsGlobalCluster) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_RdsGlobalCluster) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/rds_global_cluster aws_rds_global_cluster} Resource.
...
func (j *jsiiProxy_RdsGlobalCluster)SetRegion(val *string) {
...
func (r *jsiiProxy_RdsGlobalCluster) ResetRegion() {
	_jsii_.InvokeVoid(
		r,
		"resetRegion",
		nil, // no parameters
