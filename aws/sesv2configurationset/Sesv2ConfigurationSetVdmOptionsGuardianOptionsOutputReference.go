...
func (s *jsiiProxy_Sesv2ConfigurationSetVdmOptionsGuardianOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_Sesv2ConfigurationSetVdmOptionsGuardianOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
