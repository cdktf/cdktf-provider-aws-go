...
func NewStoragegatewayGatewayTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) StoragegatewayGatewayTimeoutsOutputReference {
	...
	if err := validateNewStoragegatewayGatewayTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_StoragegatewayGatewayTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StoragegatewayGatewayTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
