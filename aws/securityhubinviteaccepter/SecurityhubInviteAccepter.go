...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/securityhub_invite_accepter aws_securityhub_invite_accepter}.
...
func (j *jsiiProxy_SecurityhubInviteAccepter) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SecurityhubInviteAccepter) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/securityhub_invite_accepter aws_securityhub_invite_accepter} Resource.
...
func (j *jsiiProxy_SecurityhubInviteAccepter)SetRegion(val *string) {
...
func (s *jsiiProxy_SecurityhubInviteAccepter) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
