...
func (n *jsiiProxy_NetworkmanagerVpcAttachmentOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkmanagerVpcAttachmentOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
