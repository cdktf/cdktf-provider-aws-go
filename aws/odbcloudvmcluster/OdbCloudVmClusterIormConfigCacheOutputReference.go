...
func (o *jsiiProxy_OdbCloudVmClusterIormConfigCacheOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OdbCloudVmClusterIormConfigCacheOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
