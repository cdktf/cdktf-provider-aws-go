...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/data-sources/quicksight_theme aws_quicksight_theme}.
...
func (j *jsiiProxy_DataAwsQuicksightTheme) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsQuicksightTheme) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/data-sources/quicksight_theme aws_quicksight_theme} Data Source.
...
func (j *jsiiProxy_DataAwsQuicksightTheme)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsQuicksightTheme) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
