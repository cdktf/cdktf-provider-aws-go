...
func (j *jsiiProxy_DataAwsQuicksightThemeConfigurationUiColorPaletteList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsQuicksightThemeConfigurationUiColorPaletteList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsQuicksightThemeConfigurationUiColorPaletteList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktf/provider-aws.dataAwsQuicksightTheme.DataAwsQuicksightThemeConfigurationUiColorPaletteList",
...
func NewDataAwsQuicksightThemeConfigurationUiColorPaletteList_Override(d DataAwsQuicksightThemeConfigurationUiColorPaletteList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsQuicksightThemeConfigurationUiColorPaletteList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsQuicksightThemeConfigurationUiColorPaletteList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsQuicksightThemeConfigurationUiColorPaletteList) Resolve(_context cdktf.IResolveContext) interface{} {
