...
import (
	...
	"github.com/hashicorp/cdktf-provider-aws-go/aws/v10/dataawslaunchconfiguration/internal"
...
func NewDataAwsLaunchConfigurationEphemeralBlockDeviceOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAwsLaunchConfigurationEphemeralBlockDeviceOutputReference {
	...
	if err := validateNewDataAwsLaunchConfigurationEphemeralBlockDeviceOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
