...
func (i *jsiiProxy_ImagebuilderLifecyclePolicyPolicyDetailOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (i *jsiiProxy_ImagebuilderLifecyclePolicyPolicyDetailOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
