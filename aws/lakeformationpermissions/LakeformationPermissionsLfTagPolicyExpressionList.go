...
func (l *jsiiProxy_LakeformationPermissionsLfTagPolicyExpressionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LakeformationPermissionsLfTagPolicyExpressionList) Resolve(context cdktf.IResolveContext) interface{} {
