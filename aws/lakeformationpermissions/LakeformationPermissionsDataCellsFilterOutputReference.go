...
func (l *jsiiProxy_LakeformationPermissionsDataCellsFilterOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LakeformationPermissionsDataCellsFilterOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
