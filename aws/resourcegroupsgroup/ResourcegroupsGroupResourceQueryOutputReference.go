...
func (r *jsiiProxy_ResourcegroupsGroupResourceQueryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_ResourcegroupsGroupResourceQueryOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
