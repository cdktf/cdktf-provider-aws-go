...
type ResourcegroupsGroupConfiguration struct {
	...
	// parameters block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.16.0/docs/resources/resourcegroups_group#parameters ResourcegroupsGroup#parameters}
