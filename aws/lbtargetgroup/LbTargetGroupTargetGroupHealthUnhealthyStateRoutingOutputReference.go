...
func (l *jsiiProxy_LbTargetGroupTargetGroupHealthUnhealthyStateRoutingOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LbTargetGroupTargetGroupHealthUnhealthyStateRoutingOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
