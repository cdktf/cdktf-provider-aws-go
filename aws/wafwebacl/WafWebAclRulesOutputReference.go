...
func (w *jsiiProxy_WafWebAclRulesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WafWebAclRulesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
