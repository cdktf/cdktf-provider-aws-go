...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v16/wafwebacl/internal"
...
func (w *jsiiProxy_WafWebAclDefaultActionOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
