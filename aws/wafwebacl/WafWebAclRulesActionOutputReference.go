...
func (w *jsiiProxy_WafWebAclRulesActionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WafWebAclRulesActionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
