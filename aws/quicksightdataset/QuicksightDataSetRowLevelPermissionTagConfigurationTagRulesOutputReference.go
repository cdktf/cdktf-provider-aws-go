...
func (q *jsiiProxy_QuicksightDataSetRowLevelPermissionTagConfigurationTagRulesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSetRowLevelPermissionTagConfigurationTagRulesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
