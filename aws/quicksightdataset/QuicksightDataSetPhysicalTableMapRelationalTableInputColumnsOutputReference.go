...
func (q *jsiiProxy_QuicksightDataSetPhysicalTableMapRelationalTableInputColumnsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSetPhysicalTableMapRelationalTableInputColumnsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
