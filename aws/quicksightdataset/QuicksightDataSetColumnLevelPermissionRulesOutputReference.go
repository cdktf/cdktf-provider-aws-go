...
func (q *jsiiProxy_QuicksightDataSetColumnLevelPermissionRulesOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSetColumnLevelPermissionRulesOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
