...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v19/bedrockcustommodel/internal"
...
func (j *jsiiProxy_BedrockCustomModelValidationMetricsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_BedrockCustomModelValidationMetricsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_BedrockCustomModelValidationMetricsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_BedrockCustomModelValidationMetricsList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_BedrockCustomModelValidationMetricsList)SetWrapsSet(val *bool) {
...
func (b *jsiiProxy_BedrockCustomModelValidationMetricsList) ComputeFqn() *string {
	var returns *string
...
func (b *jsiiProxy_BedrockCustomModelValidationMetricsList) Get(index *float64) BedrockCustomModelValidationMetricsOutputReference {
	if err := b.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns BedrockCustomModelValidationMetricsOutputReference
...
func (b *jsiiProxy_BedrockCustomModelValidationMetricsList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (b *jsiiProxy_BedrockCustomModelValidationMetricsList) ToString() *string {
	var returns *string
