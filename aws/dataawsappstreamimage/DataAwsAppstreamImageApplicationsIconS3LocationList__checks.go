...
func (d *jsiiProxy_DataAwsAppstreamImageApplicationsIconS3LocationList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_DataAwsAppstreamImageApplicationsIconS3LocationList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_DataAwsAppstreamImageApplicationsIconS3LocationList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
