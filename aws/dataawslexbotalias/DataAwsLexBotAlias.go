...
func (j *jsiiProxy_DataAwsLexBotAlias) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsLexBotAlias) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/data-sources/lex_bot_alias aws_lex_bot_alias} Data Source.
...
func (j *jsiiProxy_DataAwsLexBotAlias)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsLexBotAlias) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
