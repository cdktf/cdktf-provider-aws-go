...
func (t *jsiiProxy_TransferServerWorkflowDetailsOnUploadOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TransferServerWorkflowDetailsOnUploadOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
