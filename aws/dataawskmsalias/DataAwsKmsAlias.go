...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/dataawskmsalias/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/data-sources/kms_alias aws_kms_alias}.
...
func (j *jsiiProxy_DataAwsKmsAlias) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsKmsAlias) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/data-sources/kms_alias aws_kms_alias} Data Source.
...
func (j *jsiiProxy_DataAwsKmsAlias)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsKmsAlias) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
