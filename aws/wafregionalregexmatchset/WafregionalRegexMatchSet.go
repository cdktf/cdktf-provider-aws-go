...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/wafregionalregexmatchset/internal"
...
func (j *jsiiProxy_WafregionalRegexMatchSet) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_WafregionalRegexMatchSet) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/resources/wafregional_regex_match_set aws_wafregional_regex_match_set} Resource.
...
func (j *jsiiProxy_WafregionalRegexMatchSet)SetRegion(val *string) {
...
func WafregionalRegexMatchSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateWafregionalRegexMatchSet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WafregionalRegexMatchSet) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WafregionalRegexMatchSet) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (w *jsiiProxy_WafregionalRegexMatchSet) MoveFromId(id *string) {
...
func (w *jsiiProxy_WafregionalRegexMatchSet) MoveToId(id *string) {
...
func (w *jsiiProxy_WafregionalRegexMatchSet) ResetRegion() {
	_jsii_.InvokeVoid(
		w,
		"resetRegion",
		nil, // no parameters
