...
func (b *jsiiProxy_BackupSelectionConditionOutputReference) validatePutStringEqualsParameters(value interface{}) error {
	...
	case []*BackupSelectionConditionStringEquals:
		value_ := value.([]*BackupSelectionConditionStringEquals)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (b *jsiiProxy_BackupSelectionConditionOutputReference) validatePutStringLikeParameters(value interface{}) error {
	...
	case []*BackupSelectionConditionStringLike:
		value_ := value.([]*BackupSelectionConditionStringLike)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (b *jsiiProxy_BackupSelectionConditionOutputReference) validatePutStringNotEqualsParameters(value interface{}) error {
	...
	case []*BackupSelectionConditionStringNotEquals:
		value_ := value.([]*BackupSelectionConditionStringNotEquals)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (b *jsiiProxy_BackupSelectionConditionOutputReference) validatePutStringNotLikeParameters(value interface{}) error {
	...
	case []*BackupSelectionConditionStringNotLike:
		value_ := value.([]*BackupSelectionConditionStringNotLike)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
