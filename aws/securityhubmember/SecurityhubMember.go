...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/securityhubmember/internal"
...
func (j *jsiiProxy_SecurityhubMember) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SecurityhubMember) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/securityhub_member aws_securityhub_member} Resource.
...
func (j *jsiiProxy_SecurityhubMember)SetRegion(val *string) {
...
func (s *jsiiProxy_SecurityhubMember) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
