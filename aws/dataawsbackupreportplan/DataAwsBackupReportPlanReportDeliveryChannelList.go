...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v18/dataawsbackupreportplan/internal"
...
func (d *jsiiProxy_DataAwsBackupReportPlanReportDeliveryChannelList) Resolve(_context cdktf.IResolveContext) interface{} {
