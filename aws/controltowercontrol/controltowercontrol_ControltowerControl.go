...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v11/controltowercontrol/internal"
...
func (j *jsiiProxy_ControltowerControl) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ControltowerControl)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
