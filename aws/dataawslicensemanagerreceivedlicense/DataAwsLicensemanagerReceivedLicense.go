...
func (j *jsiiProxy_DataAwsLicensemanagerReceivedLicense) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsLicensemanagerReceivedLicense) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/data-sources/licensemanager_received_license aws_licensemanager_received_license} Data Source.
...
func (j *jsiiProxy_DataAwsLicensemanagerReceivedLicense)SetRegion(val *string) {
...
func DataAwsLicensemanagerReceivedLicense_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsLicensemanagerReceivedLicense_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsLicensemanagerReceivedLicense) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsLicensemanagerReceivedLicense) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsLicensemanagerReceivedLicense) ToHclTerraform() interface{} {
	var returns interface{}
