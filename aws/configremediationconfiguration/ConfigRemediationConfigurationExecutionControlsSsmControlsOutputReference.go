...
func (c *jsiiProxy_ConfigRemediationConfigurationExecutionControlsSsmControlsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConfigRemediationConfigurationExecutionControlsSsmControlsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
