...
func (c *jsiiProxy_ConfigRemediationConfigurationParameterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConfigRemediationConfigurationParameterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
