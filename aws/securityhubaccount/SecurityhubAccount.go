...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/securityhubaccount/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/securityhub_account aws_securityhub_account}.
...
func (j *jsiiProxy_SecurityhubAccount) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SecurityhubAccount) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/securityhub_account aws_securityhub_account} Resource.
...
func (j *jsiiProxy_SecurityhubAccount)SetRegion(val *string) {
...
func (s *jsiiProxy_SecurityhubAccount) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
