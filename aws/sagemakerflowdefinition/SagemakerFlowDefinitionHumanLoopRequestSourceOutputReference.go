...
func (s *jsiiProxy_SagemakerFlowDefinitionHumanLoopRequestSourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SagemakerFlowDefinitionHumanLoopRequestSourceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
