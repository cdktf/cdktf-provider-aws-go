...
func (d *jsiiProxy_DataAwsLakeformationPermissionsTableWithColumnsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsLakeformationPermissionsTableWithColumnsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
