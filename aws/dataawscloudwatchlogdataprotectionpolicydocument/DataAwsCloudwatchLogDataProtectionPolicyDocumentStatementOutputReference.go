...
func (d *jsiiProxy_DataAwsCloudwatchLogDataProtectionPolicyDocumentStatementOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsCloudwatchLogDataProtectionPolicyDocumentStatementOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
