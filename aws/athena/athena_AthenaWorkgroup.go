...
func (j *jsiiProxy_AthenaWorkgroup) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AthenaWorkgroup) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewAthenaWorkgroup(scope constructs.Construct, id *string, config *AthenaWorkgroupConfig) AthenaWorkgroup {
	...
	if err := validateNewAthenaWorkgroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AthenaWorkgroup) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
