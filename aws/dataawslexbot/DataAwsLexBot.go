...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/data-sources/lex_bot aws_lex_bot}.
...
func (j *jsiiProxy_DataAwsLexBot) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsLexBot) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/data-sources/lex_bot aws_lex_bot} Data Source.
...
func (j *jsiiProxy_DataAwsLexBot)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsLexBot) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
