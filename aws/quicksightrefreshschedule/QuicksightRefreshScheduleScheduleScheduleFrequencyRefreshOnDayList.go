...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v14/quicksightrefreshschedule/internal"
...
func NewQuicksightRefreshScheduleScheduleScheduleFrequencyRefreshOnDayList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) QuicksightRefreshScheduleScheduleScheduleFrequencyRefreshOnDayList {
	...
	_jsii_.Create(
		"@cdktf/provider-aws.quicksightRefreshSchedule.QuicksightRefreshScheduleScheduleScheduleFrequencyRefreshOnDayList",
...
func (q *jsiiProxy_QuicksightRefreshScheduleScheduleScheduleFrequencyRefreshOnDayList) Resolve(_context cdktf.IResolveContext) interface{} {
