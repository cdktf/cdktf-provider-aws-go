...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/dataawsacmpcacertificate/internal"
...
func (j *jsiiProxy_DataAwsAcmpcaCertificate) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsAcmpcaCertificate) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/data-sources/acmpca_certificate aws_acmpca_certificate} Data Source.
...
func (j *jsiiProxy_DataAwsAcmpcaCertificate)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsAcmpcaCertificate) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
