...
func (k *jsiiProxy_KinesisAnalyticsApplicationReferenceDataSourcesSchemaRecordFormatMappingParametersJsonOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KinesisAnalyticsApplicationReferenceDataSourcesSchemaRecordFormatMappingParametersJsonOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
