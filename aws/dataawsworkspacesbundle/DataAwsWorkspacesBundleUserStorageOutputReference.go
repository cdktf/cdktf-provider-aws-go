...
func (d *jsiiProxy_DataAwsWorkspacesBundleUserStorageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsWorkspacesBundleUserStorageOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
