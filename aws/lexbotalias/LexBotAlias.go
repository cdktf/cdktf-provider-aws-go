...
func (j *jsiiProxy_LexBotAlias) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_LexBotAlias) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/resources/lex_bot_alias aws_lex_bot_alias} Resource.
...
func (j *jsiiProxy_LexBotAlias)SetRegion(val *string) {
...
func (l *jsiiProxy_LexBotAlias) ResetRegion() {
	_jsii_.InvokeVoid(
		l,
		"resetRegion",
		nil, // no parameters
