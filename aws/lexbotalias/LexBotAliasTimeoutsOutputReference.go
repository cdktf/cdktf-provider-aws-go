...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/lexbotalias/internal"
...
func (l *jsiiProxy_LexBotAliasTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LexBotAliasTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
