...
func (l *jsiiProxy_LexBotClarificationPromptMessageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LexBotClarificationPromptMessageOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
