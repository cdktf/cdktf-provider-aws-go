...
import (
	...
	"github.com/hashicorp/cdktf-provider-aws-go/aws/v10/lexbot/internal"
...
func NewLexBotClarificationPromptMessageList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LexBotClarificationPromptMessageList {
	...
	if err := validateNewLexBotClarificationPromptMessageListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
