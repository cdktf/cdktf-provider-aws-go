...
import (
	...
	"github.com/hashicorp/cdktf-provider-aws-go/aws/v10/lblistenercertificate/internal"
...
func (j *jsiiProxy_LbListenerCertificate) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_LbListenerCertificate)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
