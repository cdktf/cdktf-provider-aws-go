...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/lblistenercertificate/internal"
...
func (j *jsiiProxy_LbListenerCertificate) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_LbListenerCertificate) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/lb_listener_certificate aws_lb_listener_certificate} Resource.
...
func (j *jsiiProxy_LbListenerCertificate)SetRegion(val *string) {
...
func (l *jsiiProxy_LbListenerCertificate) ResetRegion() {
	_jsii_.InvokeVoid(
		l,
		"resetRegion",
		nil, // no parameters
