...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v19/dataawstransferserver/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.91.0/docs/data-sources/transfer_server aws_transfer_server}.
...
func (j *jsiiProxy_DataAwsTransferServer) Tags() *map[string]*string {
...
func (j *jsiiProxy_DataAwsTransferServer) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.91.0/docs/data-sources/transfer_server aws_transfer_server} Data Source.
...
func (j *jsiiProxy_DataAwsTransferServer)SetTags(val *map[string]*string) {
...
func (d *jsiiProxy_DataAwsTransferServer) ResetTags() {
	_jsii_.InvokeVoid(
		d,
		"resetTags",
		nil, // no parameters
