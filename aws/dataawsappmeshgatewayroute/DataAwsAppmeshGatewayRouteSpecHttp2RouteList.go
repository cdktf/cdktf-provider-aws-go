...
func NewDataAwsAppmeshGatewayRouteSpecHttp2RouteList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsAppmeshGatewayRouteSpecHttp2RouteList {
	...
	_jsii_.Create(
		"@cdktf/provider-aws.dataAwsAppmeshGatewayRoute.DataAwsAppmeshGatewayRouteSpecHttp2RouteList",
...
func (d *jsiiProxy_DataAwsAppmeshGatewayRouteSpecHttp2RouteList) Resolve(context cdktf.IResolveContext) interface{} {
