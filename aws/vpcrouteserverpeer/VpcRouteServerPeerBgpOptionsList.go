...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/vpcrouteserverpeer/internal"
...
func (v *jsiiProxy_VpcRouteServerPeerBgpOptionsList) Resolve(context cdktf.IResolveContext) interface{} {
