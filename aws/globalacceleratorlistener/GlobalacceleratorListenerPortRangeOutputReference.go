...
func (g *jsiiProxy_GlobalacceleratorListenerPortRangeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GlobalacceleratorListenerPortRangeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
