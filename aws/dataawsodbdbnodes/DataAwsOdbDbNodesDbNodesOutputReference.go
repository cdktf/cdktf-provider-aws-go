...
func (d *jsiiProxy_DataAwsOdbDbNodesDbNodesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsOdbDbNodesDbNodesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
