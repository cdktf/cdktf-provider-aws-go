...
func (j *jsiiProxy_LexSlotType) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_LexSlotType) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/lex_slot_type aws_lex_slot_type} Resource.
...
func (j *jsiiProxy_LexSlotType)SetRegion(val *string) {
...
func (l *jsiiProxy_LexSlotType) ResetRegion() {
	_jsii_.InvokeVoid(
		l,
		"resetRegion",
		nil, // no parameters
