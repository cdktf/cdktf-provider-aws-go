...
func (l *jsiiProxy_LexSlotTypeEnumerationValueOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LexSlotTypeEnumerationValueOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
