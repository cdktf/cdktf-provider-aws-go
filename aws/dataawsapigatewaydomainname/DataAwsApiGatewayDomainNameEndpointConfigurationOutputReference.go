...
func (j *jsiiProxy_DataAwsApiGatewayDomainNameEndpointConfigurationOutputReference) IpAddressType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipAddressType",
...
func (d *jsiiProxy_DataAwsApiGatewayDomainNameEndpointConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsApiGatewayDomainNameEndpointConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
