...
func (d *jsiiProxy_DirectoryServiceDirectoryTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DirectoryServiceDirectoryTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
