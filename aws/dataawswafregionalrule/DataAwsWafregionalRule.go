...
func (j *jsiiProxy_DataAwsWafregionalRule) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsWafregionalRule) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataAwsWafregionalRule)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsWafregionalRule) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
