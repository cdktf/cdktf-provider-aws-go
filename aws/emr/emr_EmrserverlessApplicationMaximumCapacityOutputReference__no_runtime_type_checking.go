...
func (j *jsiiProxy_EmrserverlessApplicationMaximumCapacityOutputReference) validateSetInternalValueParameters(val *EmrserverlessApplicationMaximumCapacity) error {
	return nil
}
