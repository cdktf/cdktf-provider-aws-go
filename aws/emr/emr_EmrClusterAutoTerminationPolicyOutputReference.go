...
func (j *jsiiProxy_EmrClusterAutoTerminationPolicyOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_EmrClusterAutoTerminationPolicyOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EmrClusterAutoTerminationPolicyOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_EmrClusterAutoTerminationPolicyOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewEmrClusterAutoTerminationPolicyOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) EmrClusterAutoTerminationPolicyOutputReference {
	...
	if err := validateNewEmrClusterAutoTerminationPolicyOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_EmrClusterAutoTerminationPolicyOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_EmrClusterAutoTerminationPolicyOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (e *jsiiProxy_EmrClusterAutoTerminationPolicyOutputReference) ComputeFqn() *string {
	var returns *string
...
func (e *jsiiProxy_EmrClusterAutoTerminationPolicyOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (e *jsiiProxy_EmrClusterAutoTerminationPolicyOutputReference) ToString() *string {
	var returns *string
