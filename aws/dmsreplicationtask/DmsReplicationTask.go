...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/resources/dms_replication_task aws_dms_replication_task}.
...
func (j *jsiiProxy_DmsReplicationTask) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DmsReplicationTask) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/resources/dms_replication_task aws_dms_replication_task} Resource.
...
func (j *jsiiProxy_DmsReplicationTask)SetRegion(val *string) {
...
func (d *jsiiProxy_DmsReplicationTask) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
