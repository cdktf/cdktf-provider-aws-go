...
func (j *jsiiProxy_DataAwsConnectContactFlow) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsConnectContactFlow) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/data-sources/connect_contact_flow aws_connect_contact_flow} Data Source.
...
func (j *jsiiProxy_DataAwsConnectContactFlow)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsConnectContactFlow) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
