...
func (j *jsiiProxy_DataAwsRdsEngineVersion) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsRdsEngineVersion) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/data-sources/rds_engine_version aws_rds_engine_version} Data Source.
...
func (j *jsiiProxy_DataAwsRdsEngineVersion)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsRdsEngineVersion) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
