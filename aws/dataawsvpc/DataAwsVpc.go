...
func (j *jsiiProxy_DataAwsVpc) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsVpc) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/data-sources/vpc aws_vpc} Data Source.
...
func (j *jsiiProxy_DataAwsVpc)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsVpc) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
