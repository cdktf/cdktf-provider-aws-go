...
func (c *jsiiProxy_CodebuildProjectBuildBatchConfigRestrictionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodebuildProjectBuildBatchConfigRestrictionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
