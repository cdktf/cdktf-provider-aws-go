...
func (c *jsiiProxy_CodebuildProjectVpcConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodebuildProjectVpcConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
