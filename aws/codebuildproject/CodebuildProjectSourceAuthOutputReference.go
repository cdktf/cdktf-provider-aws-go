...
func (c *jsiiProxy_CodebuildProjectSourceAuthOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodebuildProjectSourceAuthOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
