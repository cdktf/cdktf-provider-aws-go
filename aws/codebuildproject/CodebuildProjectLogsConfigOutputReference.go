...
func (c *jsiiProxy_CodebuildProjectLogsConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodebuildProjectLogsConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
