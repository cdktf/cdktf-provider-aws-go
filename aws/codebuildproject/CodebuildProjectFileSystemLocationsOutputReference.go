...
func (c *jsiiProxy_CodebuildProjectFileSystemLocationsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodebuildProjectFileSystemLocationsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
