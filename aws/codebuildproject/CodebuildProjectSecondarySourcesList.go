...
func NewCodebuildProjectSecondarySourcesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CodebuildProjectSecondarySourcesList {
	...
	if err := validateNewCodebuildProjectSecondarySourcesListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CodebuildProjectSecondarySourcesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CodebuildProjectSecondarySourcesList) Resolve(context cdktf.IResolveContext) interface{} {
