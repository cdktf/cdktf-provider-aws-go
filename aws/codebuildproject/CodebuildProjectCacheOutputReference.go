...
func (c *jsiiProxy_CodebuildProjectCacheOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodebuildProjectCacheOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
