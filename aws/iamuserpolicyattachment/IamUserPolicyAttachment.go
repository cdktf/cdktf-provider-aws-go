...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v20/iamuserpolicyattachment/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/iam_user_policy_attachment aws_iam_user_policy_attachment}.
...
func (j *jsiiProxy_IamUserPolicyAttachment) Connection() interface{} {
...
func (j *jsiiProxy_IamUserPolicyAttachment) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IamUserPolicyAttachment) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_IamUserPolicyAttachment) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/iam_user_policy_attachment aws_iam_user_policy_attachment} Resource.
func NewIamUserPolicyAttachment(scope constructs.Construct, id *string, config *IamUserPolicyAttachmentConfig) IamUserPolicyAttachment {
	...
	if err := validateNewIamUserPolicyAttachmentParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_IamUserPolicyAttachment)SetConnection(val interface{}) {
...
func (j *jsiiProxy_IamUserPolicyAttachment)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IamUserPolicyAttachment)SetId(val *string) {
...
func (j *jsiiProxy_IamUserPolicyAttachment)SetProvisioners(val *[]interface{}) {
...
func IamUserPolicyAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIamUserPolicyAttachment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func IamUserPolicyAttachment_IsConstruct(x interface{}) *bool {
	...
	if err := validateIamUserPolicyAttachment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func IamUserPolicyAttachment_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIamUserPolicyAttachment_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func IamUserPolicyAttachment_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIamUserPolicyAttachment_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (i *jsiiProxy_IamUserPolicyAttachment) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IamUserPolicyAttachment) HasResourceMove() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_IamUserPolicyAttachment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_IamUserPolicyAttachment) MoveFromId(id *string) {
...
func (i *jsiiProxy_IamUserPolicyAttachment) MoveTo(moveTarget *string, index interface{}) {
...
func (i *jsiiProxy_IamUserPolicyAttachment) MoveToId(id *string) {
...
func (i *jsiiProxy_IamUserPolicyAttachment) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
...
func (i *jsiiProxy_IamUserPolicyAttachment) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (i *jsiiProxy_IamUserPolicyAttachment) ToHclTerraform() interface{} {
	var returns interface{}
