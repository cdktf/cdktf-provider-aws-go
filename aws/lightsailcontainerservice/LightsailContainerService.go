...
func (j *jsiiProxy_LightsailContainerService) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_LightsailContainerService) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/lightsail_container_service aws_lightsail_container_service} Resource.
...
func (j *jsiiProxy_LightsailContainerService)SetRegion(val *string) {
...
func (l *jsiiProxy_LightsailContainerService) ResetRegion() {
	_jsii_.InvokeVoid(
		l,
		"resetRegion",
		nil, // no parameters
