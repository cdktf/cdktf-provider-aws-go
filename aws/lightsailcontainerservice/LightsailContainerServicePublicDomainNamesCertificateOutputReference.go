...
func (l *jsiiProxy_LightsailContainerServicePublicDomainNamesCertificateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LightsailContainerServicePublicDomainNamesCertificateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
