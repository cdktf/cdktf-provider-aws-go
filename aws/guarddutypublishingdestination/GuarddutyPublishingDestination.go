...
func (j *jsiiProxy_GuarddutyPublishingDestination) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_GuarddutyPublishingDestination) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/guardduty_publishing_destination aws_guardduty_publishing_destination} Resource.
...
func (j *jsiiProxy_GuarddutyPublishingDestination)SetRegion(val *string) {
...
func (g *jsiiProxy_GuarddutyPublishingDestination) ResetRegion() {
	_jsii_.InvokeVoid(
		g,
		"resetRegion",
		nil, // no parameters
