...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "internetGatewayBlockMode", GoGetter: "InternetGatewayBlockMode"},
			_jsii_.MemberProperty{JsiiProperty: "internetGatewayBlockModeInput", GoGetter: "InternetGatewayBlockModeInput"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_VpcBlockPublicAccessOptionsTimeoutsOutputReference{}
