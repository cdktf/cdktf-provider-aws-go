...
func (j *jsiiProxy_TransferSshKey) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_TransferSshKey) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/resources/transfer_ssh_key aws_transfer_ssh_key} Resource.
...
func (j *jsiiProxy_TransferSshKey)SetRegion(val *string) {
...
func (t *jsiiProxy_TransferSshKey) ResetRegion() {
	_jsii_.InvokeVoid(
		t,
		"resetRegion",
		nil, // no parameters
