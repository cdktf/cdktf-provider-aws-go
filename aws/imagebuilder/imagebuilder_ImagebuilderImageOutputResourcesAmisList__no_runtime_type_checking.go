...
func (i *jsiiProxy_ImagebuilderImageOutputResourcesAmisList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_ImagebuilderImageOutputResourcesAmisList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_ImagebuilderImageOutputResourcesAmisList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
