...
func (j *jsiiProxy_SsoadminManagedPolicyAttachment) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SsoadminManagedPolicyAttachment) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/ssoadmin_managed_policy_attachment aws_ssoadmin_managed_policy_attachment} Resource.
...
func (j *jsiiProxy_SsoadminManagedPolicyAttachment)SetRegion(val *string) {
...
func (s *jsiiProxy_SsoadminManagedPolicyAttachment) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
