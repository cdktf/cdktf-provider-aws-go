...
func (t *jsiiProxy_TransferAccessPosixProfileOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TransferAccessPosixProfileOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
