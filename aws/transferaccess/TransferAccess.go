...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.73.0/docs/resources/transfer_access aws_transfer_access}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.73.0/docs/resources/transfer_access aws_transfer_access} Resource.
...
func TransferAccess_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (t *jsiiProxy_TransferAccess) ImportFrom(id *string, provider cdktf.TerraformProvider) {
