...
func (d *jsiiProxy_DxPublicVirtualInterfaceTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DxPublicVirtualInterfaceTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
