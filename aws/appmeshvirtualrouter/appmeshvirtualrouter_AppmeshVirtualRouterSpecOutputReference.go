...
import (
	...
	"github.com/hashicorp/cdktf-provider-aws-go/aws/v10/appmeshvirtualrouter/internal"
...
func (a *jsiiProxy_AppmeshVirtualRouterSpecOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
