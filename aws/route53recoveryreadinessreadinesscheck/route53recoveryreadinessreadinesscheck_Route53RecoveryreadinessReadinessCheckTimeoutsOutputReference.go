...
import (
	...
	"github.com/hashicorp/cdktf-provider-aws-go/aws/v10/route53recoveryreadinessreadinesscheck/internal"
...
func (j *jsiiProxy_Route53RecoveryreadinessReadinessCheckTimeoutsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_Route53RecoveryreadinessReadinessCheckTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Route53RecoveryreadinessReadinessCheckTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_Route53RecoveryreadinessReadinessCheckTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Route53RecoveryreadinessReadinessCheckTimeoutsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewRoute53RecoveryreadinessReadinessCheckTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) Route53RecoveryreadinessReadinessCheckTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewRoute53RecoveryreadinessReadinessCheckTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewRoute53RecoveryreadinessReadinessCheckTimeoutsOutputReference_Override(r Route53RecoveryreadinessReadinessCheckTimeoutsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_Route53RecoveryreadinessReadinessCheckTimeoutsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_Route53RecoveryreadinessReadinessCheckTimeoutsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_Route53RecoveryreadinessReadinessCheckTimeoutsOutputReference)SetInternalValue(val interface{}) {
...
func (r *jsiiProxy_Route53RecoveryreadinessReadinessCheckTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (r *jsiiProxy_Route53RecoveryreadinessReadinessCheckTimeoutsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (r *jsiiProxy_Route53RecoveryreadinessReadinessCheckTimeoutsOutputReference) ToString() *string {
	var returns *string
