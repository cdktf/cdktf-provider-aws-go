...
func (c *jsiiProxy_CodepipelineTriggerGitConfigurationPushBranchesOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodepipelineTriggerGitConfigurationPushBranchesOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
