...
func (r *jsiiProxy_RedshiftdataStatementTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RedshiftdataStatementTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
