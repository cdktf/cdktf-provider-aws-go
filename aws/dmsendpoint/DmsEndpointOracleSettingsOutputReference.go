...
func (d *jsiiProxy_DmsEndpointOracleSettingsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DmsEndpointOracleSettingsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
