...
func (g *jsiiProxy_GameliftAliasRoutingStrategyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GameliftAliasRoutingStrategyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
