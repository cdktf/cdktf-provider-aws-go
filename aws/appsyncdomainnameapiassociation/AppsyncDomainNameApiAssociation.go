...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/resources/appsync_domain_name_api_association aws_appsync_domain_name_api_association}.
...
func (j *jsiiProxy_AppsyncDomainNameApiAssociation) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AppsyncDomainNameApiAssociation) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/resources/appsync_domain_name_api_association aws_appsync_domain_name_api_association} Resource.
...
func (j *jsiiProxy_AppsyncDomainNameApiAssociation)SetRegion(val *string) {
...
func (a *jsiiProxy_AppsyncDomainNameApiAssociation) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
