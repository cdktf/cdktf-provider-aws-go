...
func (j *jsiiProxy_ApprunnerObservabilityConfiguration) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ApprunnerObservabilityConfiguration) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/resources/apprunner_observability_configuration aws_apprunner_observability_configuration} Resource.
...
func (j *jsiiProxy_ApprunnerObservabilityConfiguration)SetRegion(val *string) {
...
func (a *jsiiProxy_ApprunnerObservabilityConfiguration) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
