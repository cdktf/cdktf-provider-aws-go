...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v12/wafregionalratebasedrule/internal"
...
func NewWafregionalRateBasedRule(scope constructs.Construct, id *string, config *WafregionalRateBasedRuleConfig) WafregionalRateBasedRule {
	...
	if err := validateNewWafregionalRateBasedRuleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func WafregionalRateBasedRule_IsConstruct(x interface{}) *bool {
	...
	if err := validateWafregionalRateBasedRule_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WafregionalRateBasedRule_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWafregionalRateBasedRule_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WafregionalRateBasedRule_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWafregionalRateBasedRule_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
