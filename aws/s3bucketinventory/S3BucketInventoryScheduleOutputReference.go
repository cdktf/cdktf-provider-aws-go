...
func (s *jsiiProxy_S3BucketInventoryScheduleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_S3BucketInventoryScheduleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
