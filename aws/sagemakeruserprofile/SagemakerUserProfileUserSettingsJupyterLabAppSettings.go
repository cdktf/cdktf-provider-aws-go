...
type SagemakerUserProfileUserSettingsJupyterLabAppSettings struct {
	...
	// emr_settings block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.25.0/docs/resources/sagemaker_user_profile#emr_settings SagemakerUserProfile#emr_settings}
