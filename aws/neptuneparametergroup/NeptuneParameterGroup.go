...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/resources/neptune_parameter_group aws_neptune_parameter_group}.
...
func (j *jsiiProxy_NeptuneParameterGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_NeptuneParameterGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/resources/neptune_parameter_group aws_neptune_parameter_group} Resource.
...
func (j *jsiiProxy_NeptuneParameterGroup)SetRegion(val *string) {
...
func (n *jsiiProxy_NeptuneParameterGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		n,
		"resetRegion",
		nil, // no parameters
