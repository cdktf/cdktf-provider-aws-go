...
import (
	...
	"github.com/hashicorp/cdktf-provider-aws-go/aws/v10/ec2networkinsightspath/internal"
...
func (j *jsiiProxy_Ec2NetworkInsightsPath) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_Ec2NetworkInsightsPath)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
