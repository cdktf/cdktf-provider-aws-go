...
func (a *jsiiProxy_ApprunnerServiceNetworkConfigurationEgressConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApprunnerServiceNetworkConfigurationEgressConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
