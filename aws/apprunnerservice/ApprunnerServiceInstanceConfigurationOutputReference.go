...
func (a *jsiiProxy_ApprunnerServiceInstanceConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApprunnerServiceInstanceConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
