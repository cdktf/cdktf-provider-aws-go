...
func (d *jsiiProxy_DynamodbTableLocalSecondaryIndexOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DynamodbTableLocalSecondaryIndexOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
