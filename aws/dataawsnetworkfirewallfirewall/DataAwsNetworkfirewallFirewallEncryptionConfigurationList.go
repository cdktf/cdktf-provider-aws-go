...
func NewDataAwsNetworkfirewallFirewallEncryptionConfigurationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsNetworkfirewallFirewallEncryptionConfigurationList {
	...
	if err := validateNewDataAwsNetworkfirewallFirewallEncryptionConfigurationListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsNetworkfirewallFirewallEncryptionConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsNetworkfirewallFirewallEncryptionConfigurationList) Resolve(context cdktf.IResolveContext) interface{} {
