...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/data-sources/eks_node_group aws_eks_node_group}.
...
func (j *jsiiProxy_DataAwsEksNodeGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsEksNodeGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/data-sources/eks_node_group aws_eks_node_group} Data Source.
...
func (j *jsiiProxy_DataAwsEksNodeGroup)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsEksNodeGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
