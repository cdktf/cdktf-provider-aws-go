...
func (r *jsiiProxy_RedshiftClusterIamRolesTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RedshiftClusterIamRolesTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
