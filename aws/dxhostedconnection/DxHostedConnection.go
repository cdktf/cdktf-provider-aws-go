...
func (j *jsiiProxy_DxHostedConnection) ConnectionRegion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"connectionRegion",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/resources/dx_hosted_connection aws_dx_hosted_connection} Resource.
