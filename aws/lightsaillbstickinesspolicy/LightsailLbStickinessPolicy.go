...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/lightsaillbstickinesspolicy/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/lightsail_lb_stickiness_policy aws_lightsail_lb_stickiness_policy}.
...
func (j *jsiiProxy_LightsailLbStickinessPolicy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_LightsailLbStickinessPolicy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/lightsail_lb_stickiness_policy aws_lightsail_lb_stickiness_policy} Resource.
...
func (j *jsiiProxy_LightsailLbStickinessPolicy)SetRegion(val *string) {
...
func (l *jsiiProxy_LightsailLbStickinessPolicy) ResetRegion() {
	_jsii_.InvokeVoid(
		l,
		"resetRegion",
		nil, // no parameters
