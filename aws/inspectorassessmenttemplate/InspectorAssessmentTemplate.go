...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/inspectorassessmenttemplate/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/inspector_assessment_template aws_inspector_assessment_template}.
...
func (j *jsiiProxy_InspectorAssessmentTemplate) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_InspectorAssessmentTemplate) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/inspector_assessment_template aws_inspector_assessment_template} Resource.
...
func (j *jsiiProxy_InspectorAssessmentTemplate)SetRegion(val *string) {
...
func (i *jsiiProxy_InspectorAssessmentTemplate) ResetRegion() {
	_jsii_.InvokeVoid(
		i,
		"resetRegion",
		nil, // no parameters
