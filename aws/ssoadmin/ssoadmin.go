...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-aws.ssoadmin.SsoadminCustomerManagedPolicyAttachmentConfig",
		reflect.TypeOf((*SsoadminCustomerManagedPolicyAttachmentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-aws.ssoadmin.SsoadminCustomerManagedPolicyAttachmentCustomerManagedPolicyReference",
