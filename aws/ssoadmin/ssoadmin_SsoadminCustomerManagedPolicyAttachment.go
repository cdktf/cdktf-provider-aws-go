...
func (j *jsiiProxy_SsoadminCustomerManagedPolicyAttachment) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func NewSsoadminCustomerManagedPolicyAttachment(scope constructs.Construct, id *string, config *SsoadminCustomerManagedPolicyAttachmentConfig) SsoadminCustomerManagedPolicyAttachment {
	...
	_jsii_.Create(
		"@cdktf/provider-aws.ssoadmin.SsoadminCustomerManagedPolicyAttachment",
...
func (j *jsiiProxy_SsoadminCustomerManagedPolicyAttachment)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
