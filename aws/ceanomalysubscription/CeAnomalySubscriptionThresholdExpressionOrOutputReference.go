...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/ceanomalysubscription/internal"
...
func (c *jsiiProxy_CeAnomalySubscriptionThresholdExpressionOrOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CeAnomalySubscriptionThresholdExpressionOrOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
