...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v19/devicefarmdevicepool/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.90.0/docs/resources/devicefarm_device_pool aws_devicefarm_device_pool}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.90.0/docs/resources/devicefarm_device_pool aws_devicefarm_device_pool} Resource.
func NewDevicefarmDevicePool(scope constructs.Construct, id *string, config *DevicefarmDevicePoolConfig) DevicefarmDevicePool {
	_init_.Initialize()

	if err := validateNewDevicefarmDevicePoolParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DevicefarmDevicePool_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDevicefarmDevicePool_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DevicefarmDevicePool) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DevicefarmDevicePool) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DevicefarmDevicePool) MoveFromId(id *string) {
...
func (d *jsiiProxy_DevicefarmDevicePool) MoveToId(id *string) {
