...
func (e *jsiiProxy_ElbListenerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_ElbListenerOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
