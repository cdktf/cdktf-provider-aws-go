...
func NewOrganizationsOrganizationRootsPolicyTypesOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) OrganizationsOrganizationRootsPolicyTypesOutputReference {
	...
	if err := validateNewOrganizationsOrganizationRootsPolicyTypesOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (o *jsiiProxy_OrganizationsOrganizationRootsPolicyTypesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OrganizationsOrganizationRootsPolicyTypesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
