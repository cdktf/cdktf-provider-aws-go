...
func (r *jsiiProxy_RdsClusterS3ImportOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RdsClusterS3ImportOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
