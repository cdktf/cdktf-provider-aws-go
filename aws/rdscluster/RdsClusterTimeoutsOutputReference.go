...
func (r *jsiiProxy_RdsClusterTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RdsClusterTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
