...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/dataawscognitouserpools/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/data-sources/cognito_user_pools aws_cognito_user_pools}.
...
func (j *jsiiProxy_DataAwsCognitoUserPools) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsCognitoUserPools) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/data-sources/cognito_user_pools aws_cognito_user_pools} Data Source.
...
func (j *jsiiProxy_DataAwsCognitoUserPools)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsCognitoUserPools) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
