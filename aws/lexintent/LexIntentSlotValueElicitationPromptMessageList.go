...
func NewLexIntentSlotValueElicitationPromptMessageList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LexIntentSlotValueElicitationPromptMessageList {
	...
	if err := validateNewLexIntentSlotValueElicitationPromptMessageListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LexIntentSlotValueElicitationPromptMessageList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LexIntentSlotValueElicitationPromptMessageList) Resolve(context cdktf.IResolveContext) interface{} {
