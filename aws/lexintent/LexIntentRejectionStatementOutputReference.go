...
func (l *jsiiProxy_LexIntentRejectionStatementOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LexIntentRejectionStatementOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
