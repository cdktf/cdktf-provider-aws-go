...
func (l *jsiiProxy_LexIntentFollowUpPromptPromptMessageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LexIntentFollowUpPromptPromptMessageOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
