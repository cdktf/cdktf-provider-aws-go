...
func (b *jsiiProxy_BatchSchedulingPolicyFairSharePolicyShareDistributionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BatchSchedulingPolicyFairSharePolicyShareDistributionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
