...
func (k *jsiiProxy_KendraIndexCapacityUnitsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KendraIndexCapacityUnitsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
