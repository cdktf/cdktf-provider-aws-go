...
func (q *jsiiProxy_QuicksightDataSourceSslPropertiesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSourceSslPropertiesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
