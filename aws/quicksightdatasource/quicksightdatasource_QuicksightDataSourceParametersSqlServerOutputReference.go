...
import (
	...
	"github.com/hashicorp/cdktf-provider-aws-go/aws/v10/quicksightdatasource/internal"
...
func NewQuicksightDataSourceParametersSqlServerOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) QuicksightDataSourceParametersSqlServerOutputReference {
	...
	if err := validateNewQuicksightDataSourceParametersSqlServerOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
