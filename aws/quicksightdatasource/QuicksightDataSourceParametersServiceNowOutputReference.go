...
func (q *jsiiProxy_QuicksightDataSourceParametersServiceNowOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSourceParametersServiceNowOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
