...
type QuicksightDataSourceParametersMysql struct {
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.56.1/docs/resources/quicksight_data_source#database QuicksightDataSource#database}.
