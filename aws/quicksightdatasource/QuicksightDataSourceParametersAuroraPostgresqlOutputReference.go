...
func (q *jsiiProxy_QuicksightDataSourceParametersAuroraPostgresqlOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSourceParametersAuroraPostgresqlOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
