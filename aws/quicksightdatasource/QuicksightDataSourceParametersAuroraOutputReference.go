...
func (q *jsiiProxy_QuicksightDataSourceParametersAuroraOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightDataSourceParametersAuroraOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
