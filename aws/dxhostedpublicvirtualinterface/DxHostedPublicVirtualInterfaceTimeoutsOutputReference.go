...
func (d *jsiiProxy_DxHostedPublicVirtualInterfaceTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DxHostedPublicVirtualInterfaceTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
