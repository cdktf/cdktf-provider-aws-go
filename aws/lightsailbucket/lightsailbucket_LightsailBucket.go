...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v11/lightsailbucket/internal"
...
func (j *jsiiProxy_LightsailBucket) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_LightsailBucket) AvailabilityZone() *string {
	var returns *string
	_jsii_.Get(
		j,
		"availabilityZone",
...
func (j *jsiiProxy_LightsailBucket) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_LightsailBucket) CreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdAt",
...
func (j *jsiiProxy_LightsailBucket) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_LightsailBucket) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_LightsailBucket) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_LightsailBucket) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_LightsailBucket) SupportCode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"supportCode",
...
func (j *jsiiProxy_LightsailBucket) Tags() *map[string]*string {
...
func (j *jsiiProxy_LightsailBucket) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_LightsailBucket) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_LightsailBucket) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://www.terraform.io/docs/providers/aws/r/lightsail_bucket aws_lightsail_bucket} Resource.
...
func (j *jsiiProxy_LightsailBucket)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func (l *jsiiProxy_LightsailBucket) ResetId() {
	_jsii_.InvokeVoid(
		l,
		"resetId",
		nil, // no parameters
...
func (l *jsiiProxy_LightsailBucket) ResetTagsAll() {
	_jsii_.InvokeVoid(
		l,
		"resetTagsAll",
		nil, // no parameters
