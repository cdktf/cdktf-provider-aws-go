...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/lightsailbucket/internal"
...
func (j *jsiiProxy_LightsailBucket) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/resources/lightsail_bucket aws_lightsail_bucket} Resource.
...
func (j *jsiiProxy_LightsailBucket)SetRegion(val *string) {
...
func (l *jsiiProxy_LightsailBucket) ResetRegion() {
	_jsii_.InvokeVoid(
		l,
		"resetRegion",
		nil, // no parameters
