...
func (a *jsiiProxy_AppflowFlowDestinationFlowConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppflowFlowDestinationFlowConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
