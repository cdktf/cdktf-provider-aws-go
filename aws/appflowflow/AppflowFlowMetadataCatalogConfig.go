...
type AppflowFlowMetadataCatalogConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.87.0/docs/resources/appflow_flow#glue_data_catalog AppflowFlow#glue_data_catalog}
