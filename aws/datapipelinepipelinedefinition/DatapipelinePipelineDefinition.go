...
func (j *jsiiProxy_DatapipelinePipelineDefinition) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DatapipelinePipelineDefinition) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/datapipeline_pipeline_definition aws_datapipeline_pipeline_definition} Resource.
...
func (j *jsiiProxy_DatapipelinePipelineDefinition)SetRegion(val *string) {
...
func (d *jsiiProxy_DatapipelinePipelineDefinition) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
