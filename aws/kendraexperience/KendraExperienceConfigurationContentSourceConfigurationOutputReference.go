...
func (k *jsiiProxy_KendraExperienceConfigurationContentSourceConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KendraExperienceConfigurationContentSourceConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
