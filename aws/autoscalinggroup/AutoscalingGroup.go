...
func (j *jsiiProxy_AutoscalingGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AutoscalingGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/autoscaling_group aws_autoscaling_group} Resource.
...
func (j *jsiiProxy_AutoscalingGroup)SetRegion(val *string) {
...
func (a *jsiiProxy_AutoscalingGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
