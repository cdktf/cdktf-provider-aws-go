...
func (a *jsiiProxy_AutoscalingGroupWarmPoolOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AutoscalingGroupWarmPoolOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
