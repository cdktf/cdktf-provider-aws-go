...
func (d *jsiiProxy_DataAwsElasticsearchDomainClusterConfigColdStorageOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsElasticsearchDomainClusterConfigColdStorageOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
