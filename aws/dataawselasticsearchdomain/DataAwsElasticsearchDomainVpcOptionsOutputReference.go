...
func (d *jsiiProxy_DataAwsElasticsearchDomainVpcOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsElasticsearchDomainVpcOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
