...
func (d *jsiiProxy_DataAwsElasticsearchDomainLogPublishingOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsElasticsearchDomainLogPublishingOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
