...
func (j *jsiiProxy_PrometheusQueryLoggingConfigurationDestinationFiltersList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewPrometheusQueryLoggingConfigurationDestinationFiltersList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PrometheusQueryLoggingConfigurationDestinationFiltersList {
	_init_.Initialize()
...
func NewPrometheusQueryLoggingConfigurationDestinationFiltersList_Override(p PrometheusQueryLoggingConfigurationDestinationFiltersList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PrometheusQueryLoggingConfigurationDestinationFiltersList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (p *jsiiProxy_PrometheusQueryLoggingConfigurationDestinationFiltersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PrometheusQueryLoggingConfigurationDestinationFiltersList) Resolve(_context cdktf.IResolveContext) interface{} {
