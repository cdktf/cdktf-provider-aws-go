...
func (c *jsiiProxy_CognitoIdentityPoolCognitoIdentityProvidersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CognitoIdentityPoolCognitoIdentityProvidersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
