...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/bedrockagent_knowledge_base aws_bedrockagent_knowledge_base} Resource.
func NewBedrockagentKnowledgeBase(scope constructs.Construct, id *string, config *BedrockagentKnowledgeBaseConfig) BedrockagentKnowledgeBase {
	...
	_jsii_.Create(
		"@cdktf/provider-aws.bedrockagentKnowledgeBase.BedrockagentKnowledgeBase",
