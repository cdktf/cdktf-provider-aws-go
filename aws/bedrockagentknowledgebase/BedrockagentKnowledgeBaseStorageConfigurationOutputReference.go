...
func (b *jsiiProxy_BedrockagentKnowledgeBaseStorageConfigurationOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BedrockagentKnowledgeBaseStorageConfigurationOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
