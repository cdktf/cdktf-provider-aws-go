...
func (r *jsiiProxy_RedshiftParameterGroupParameterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RedshiftParameterGroupParameterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
