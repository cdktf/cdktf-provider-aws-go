...
func (v *jsiiProxy_VpclatticeResourceConfigurationResourceConfigurationDefinitionDnsResourceList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
