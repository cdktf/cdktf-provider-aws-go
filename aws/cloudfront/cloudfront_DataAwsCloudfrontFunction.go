...
func (j *jsiiProxy_DataAwsCloudfrontFunction) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCloudfrontFunction) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsCloudfrontFunction(scope constructs.Construct, id *string, config *DataAwsCloudfrontFunctionConfig) DataAwsCloudfrontFunction {
	...
	if err := validateNewDataAwsCloudfrontFunctionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsCloudfrontFunction) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
