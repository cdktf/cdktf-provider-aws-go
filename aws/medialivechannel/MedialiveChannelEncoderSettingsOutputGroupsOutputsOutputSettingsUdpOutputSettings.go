...
type MedialiveChannelEncoderSettingsOutputGroupsOutputsOutputSettingsUdpOutputSettings struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.63.0/docs/resources/medialive_channel#container_settings MedialiveChannel#container_settings}
	...
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.63.0/docs/resources/medialive_channel#buffer_msec MedialiveChannel#buffer_msec}.
	BufferMsec *float64 `field:"optional" json:"bufferMsec" yaml:"bufferMsec"`
	// fec_output_settings block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.63.0/docs/resources/medialive_channel#fec_output_settings MedialiveChannel#fec_output_settings}
