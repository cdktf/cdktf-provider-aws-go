...
func (s *jsiiProxy_SecuritylakeDataLakeConfigurationReplicationConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SecuritylakeDataLakeConfigurationReplicationConfigurationList) Resolve(context cdktf.IResolveContext) interface{} {
