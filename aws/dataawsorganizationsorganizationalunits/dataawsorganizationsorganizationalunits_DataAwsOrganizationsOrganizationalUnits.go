...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v11/dataawsorganizationsorganizationalunits/internal"
...
func NewDataAwsOrganizationsOrganizationalUnits(scope constructs.Construct, id *string, config *DataAwsOrganizationsOrganizationalUnitsConfig) DataAwsOrganizationsOrganizationalUnits {
	...
	if err := validateNewDataAwsOrganizationsOrganizationalUnitsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsOrganizationsOrganizationalUnits_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsOrganizationsOrganizationalUnits_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsOrganizationsOrganizationalUnits_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsOrganizationsOrganizationalUnits_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsOrganizationsOrganizationalUnits_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsOrganizationsOrganizationalUnits_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
