...
func (j *jsiiProxy_Wafv2WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPatternList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewWafv2WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPatternList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) Wafv2WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPatternList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktf/provider-aws.wafv2WebAcl.Wafv2WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPatternList",
...
func NewWafv2WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPatternList_Override(w Wafv2WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPatternList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_Wafv2WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPatternList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (w *jsiiProxy_Wafv2WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPatternList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_Wafv2WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPatternList) Resolve(_context cdktf.IResolveContext) interface{} {
