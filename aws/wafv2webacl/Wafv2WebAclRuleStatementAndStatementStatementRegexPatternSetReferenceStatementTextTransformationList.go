...
func (w *jsiiProxy_Wafv2WebAclRuleStatementAndStatementStatementRegexPatternSetReferenceStatementTextTransformationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
