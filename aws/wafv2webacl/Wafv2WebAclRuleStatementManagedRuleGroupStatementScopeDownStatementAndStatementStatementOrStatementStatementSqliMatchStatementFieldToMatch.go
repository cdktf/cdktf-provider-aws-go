...
type Wafv2WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementAndStatementStatementOrStatementStatementSqliMatchStatementFieldToMatch struct {
	...
	Ja3Fingerprint *Wafv2WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementAndStatementStatementOrStatementStatementSqliMatchStatementFieldToMatchJa3Fingerprint `field:"optional" json:"ja3Fingerprint" yaml:"ja3Fingerprint"`
	// json_body block.
	//
