...
type Wafv2WebAclRuleStatementGeoMatchStatementOutputReference interface {
	...
	ForwardedIpConfig() Wafv2WebAclRuleStatementGeoMatchStatementForwardedIpConfigOutputReference
	ForwardedIpConfigInput() *Wafv2WebAclRuleStatementGeoMatchStatementForwardedIpConfig
	// Experimental.
	Fqn() *string
	InternalValue() *Wafv2WebAclRuleStatementGeoMatchStatement
	SetInternalValue(val *Wafv2WebAclRuleStatementGeoMatchStatement)
	// Experimental.
	...
	PutForwardedIpConfig(value *Wafv2WebAclRuleStatementGeoMatchStatementForwardedIpConfig)
...
func (j *jsiiProxy_Wafv2WebAclRuleStatementGeoMatchStatementOutputReference) ForwardedIpConfig() Wafv2WebAclRuleStatementGeoMatchStatementForwardedIpConfigOutputReference {
...
func (j *jsiiProxy_Wafv2WebAclRuleStatementGeoMatchStatementOutputReference) ForwardedIpConfigInput() *Wafv2WebAclRuleStatementGeoMatchStatementForwardedIpConfig {
...
func (j *jsiiProxy_Wafv2WebAclRuleStatementGeoMatchStatementOutputReference) InternalValue() *Wafv2WebAclRuleStatementGeoMatchStatement {
...
func (j *jsiiProxy_Wafv2WebAclRuleStatementGeoMatchStatementOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewWafv2WebAclRuleStatementGeoMatchStatementOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) Wafv2WebAclRuleStatementGeoMatchStatementOutputReference {
	_init_.Initialize()

	if err := validateNewWafv2WebAclRuleStatementGeoMatchStatementOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_Wafv2WebAclRuleStatementGeoMatchStatementOutputReference{}

	_jsii_.Create(
		"@cdktf/provider-aws.wafv2WebAcl.Wafv2WebAclRuleStatementGeoMatchStatementOutputReference",
...
func NewWafv2WebAclRuleStatementGeoMatchStatementOutputReference_Override(w Wafv2WebAclRuleStatementGeoMatchStatementOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_Wafv2WebAclRuleStatementGeoMatchStatementOutputReference)SetInternalValue(val *Wafv2WebAclRuleStatementGeoMatchStatement) {
...
func (j *jsiiProxy_Wafv2WebAclRuleStatementGeoMatchStatementOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (w *jsiiProxy_Wafv2WebAclRuleStatementGeoMatchStatementOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_Wafv2WebAclRuleStatementGeoMatchStatementOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (w *jsiiProxy_Wafv2WebAclRuleStatementGeoMatchStatementOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (w *jsiiProxy_Wafv2WebAclRuleStatementGeoMatchStatementOutputReference) PutForwardedIpConfig(value *Wafv2WebAclRuleStatementGeoMatchStatementForwardedIpConfig) {
...
func (w *jsiiProxy_Wafv2WebAclRuleStatementGeoMatchStatementOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
