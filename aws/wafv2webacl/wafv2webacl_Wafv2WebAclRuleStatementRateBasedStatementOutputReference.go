...
type Wafv2WebAclRuleStatementRateBasedStatementOutputReference interface {
	...
	ForwardedIpConfig() Wafv2WebAclRuleStatementRateBasedStatementForwardedIpConfigOutputReference
	ForwardedIpConfigInput() *Wafv2WebAclRuleStatementRateBasedStatementForwardedIpConfig
	// Experimental.
	Fqn() *string
	InternalValue() *Wafv2WebAclRuleStatementRateBasedStatement
	SetInternalValue(val *Wafv2WebAclRuleStatementRateBasedStatement)
	Limit() *float64
	SetLimit(val *float64)
	LimitInput() *float64
	ScopeDownStatement() Wafv2WebAclRuleStatementRateBasedStatementScopeDownStatementOutputReference
	ScopeDownStatementInput() *Wafv2WebAclRuleStatementRateBasedStatementScopeDownStatement
	// Experimental.
	...
	PutForwardedIpConfig(value *Wafv2WebAclRuleStatementRateBasedStatementForwardedIpConfig)
	PutScopeDownStatement(value *Wafv2WebAclRuleStatementRateBasedStatementScopeDownStatement)
...
func (j *jsiiProxy_Wafv2WebAclRuleStatementRateBasedStatementOutputReference) ForwardedIpConfig() Wafv2WebAclRuleStatementRateBasedStatementForwardedIpConfigOutputReference {
...
func (j *jsiiProxy_Wafv2WebAclRuleStatementRateBasedStatementOutputReference) ForwardedIpConfigInput() *Wafv2WebAclRuleStatementRateBasedStatementForwardedIpConfig {
	var returns *Wafv2WebAclRuleStatementRateBasedStatementForwardedIpConfig
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Wafv2WebAclRuleStatementRateBasedStatementOutputReference) InternalValue() *Wafv2WebAclRuleStatementRateBasedStatement {
...
func (j *jsiiProxy_Wafv2WebAclRuleStatementRateBasedStatementOutputReference) ScopeDownStatement() Wafv2WebAclRuleStatementRateBasedStatementScopeDownStatementOutputReference {
...
func (j *jsiiProxy_Wafv2WebAclRuleStatementRateBasedStatementOutputReference) ScopeDownStatementInput() *Wafv2WebAclRuleStatementRateBasedStatementScopeDownStatement {
...
func (j *jsiiProxy_Wafv2WebAclRuleStatementRateBasedStatementOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewWafv2WebAclRuleStatementRateBasedStatementOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) Wafv2WebAclRuleStatementRateBasedStatementOutputReference {
	_init_.Initialize()

	if err := validateNewWafv2WebAclRuleStatementRateBasedStatementOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_Wafv2WebAclRuleStatementRateBasedStatementOutputReference{}

	_jsii_.Create(
		"@cdktf/provider-aws.wafv2WebAcl.Wafv2WebAclRuleStatementRateBasedStatementOutputReference",
...
func NewWafv2WebAclRuleStatementRateBasedStatementOutputReference_Override(w Wafv2WebAclRuleStatementRateBasedStatementOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_Wafv2WebAclRuleStatementRateBasedStatementOutputReference)SetInternalValue(val *Wafv2WebAclRuleStatementRateBasedStatement) {
...
func (j *jsiiProxy_Wafv2WebAclRuleStatementRateBasedStatementOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (w *jsiiProxy_Wafv2WebAclRuleStatementRateBasedStatementOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_Wafv2WebAclRuleStatementRateBasedStatementOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (w *jsiiProxy_Wafv2WebAclRuleStatementRateBasedStatementOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (w *jsiiProxy_Wafv2WebAclRuleStatementRateBasedStatementOutputReference) PutForwardedIpConfig(value *Wafv2WebAclRuleStatementRateBasedStatementForwardedIpConfig) {
...
func (w *jsiiProxy_Wafv2WebAclRuleStatementRateBasedStatementOutputReference) PutScopeDownStatement(value *Wafv2WebAclRuleStatementRateBasedStatementScopeDownStatement) {
...
func (w *jsiiProxy_Wafv2WebAclRuleStatementRateBasedStatementOutputReference) ResetAggregateKeyType() {
	_jsii_.InvokeVoid(
		w,
		"resetAggregateKeyType",
		nil, // no parameters
...
func (w *jsiiProxy_Wafv2WebAclRuleStatementRateBasedStatementOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
