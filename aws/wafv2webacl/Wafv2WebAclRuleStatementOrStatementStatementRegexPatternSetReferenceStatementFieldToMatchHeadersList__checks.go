...
func (w *jsiiProxy_Wafv2WebAclRuleStatementOrStatementStatementRegexPatternSetReferenceStatementFieldToMatchHeadersList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
