...
func (w *jsiiProxy_Wafv2WebAclRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchOutputReference) validatePutHeadersParameters(value interface{}) error {
	...
	case *[]*Wafv2WebAclRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchHeaders:
		value := value.(*[]*Wafv2WebAclRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchHeaders)
	...
	case []*Wafv2WebAclRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchHeaders:
		value_ := value.([]*Wafv2WebAclRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchHeaders)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*Wafv2WebAclRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchHeaders; received %#v (a %T)", value, value)
		}
	}
