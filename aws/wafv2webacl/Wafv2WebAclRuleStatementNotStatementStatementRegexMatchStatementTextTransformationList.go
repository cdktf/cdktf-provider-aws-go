...
func (w *jsiiProxy_Wafv2WebAclRuleStatementNotStatementStatementRegexMatchStatementTextTransformationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
