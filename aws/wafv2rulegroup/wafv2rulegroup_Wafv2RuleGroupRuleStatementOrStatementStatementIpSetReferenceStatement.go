...
type Wafv2RuleGroupRuleStatementOrStatementStatementIpSetReferenceStatement struct {
	...
	IpSetForwardedIpConfig *Wafv2RuleGroupRuleStatementOrStatementStatementIpSetReferenceStatementIpSetForwardedIpConfig `field:"optional" json:"ipSetForwardedIpConfig" yaml:"ipSetForwardedIpConfig"`
}
