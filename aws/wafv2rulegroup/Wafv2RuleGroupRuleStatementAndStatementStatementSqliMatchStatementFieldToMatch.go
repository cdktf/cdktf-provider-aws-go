...
type Wafv2RuleGroupRuleStatementAndStatementStatementSqliMatchStatementFieldToMatch struct {
	...
	Ja3Fingerprint *Wafv2RuleGroupRuleStatementAndStatementStatementSqliMatchStatementFieldToMatchJa3Fingerprint `field:"optional" json:"ja3Fingerprint" yaml:"ja3Fingerprint"`
	// json_body block.
	//
