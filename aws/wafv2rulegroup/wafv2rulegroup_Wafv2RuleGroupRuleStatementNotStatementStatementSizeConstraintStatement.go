...
type Wafv2RuleGroupRuleStatementNotStatementStatementSizeConstraintStatement struct {
	...
	FieldToMatch *Wafv2RuleGroupRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatch `field:"optional" json:"fieldToMatch" yaml:"fieldToMatch"`
}
