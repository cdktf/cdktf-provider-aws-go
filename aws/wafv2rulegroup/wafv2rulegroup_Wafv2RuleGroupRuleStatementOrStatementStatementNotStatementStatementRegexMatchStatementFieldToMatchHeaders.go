...
type Wafv2RuleGroupRuleStatementOrStatementStatementNotStatementStatementRegexMatchStatementFieldToMatchHeaders struct {
	// match_pattern block.
	//
	...
	MatchPattern *Wafv2RuleGroupRuleStatementOrStatementStatementNotStatementStatementRegexMatchStatementFieldToMatchHeadersMatchPattern `field:"required" json:"matchPattern" yaml:"matchPattern"`
