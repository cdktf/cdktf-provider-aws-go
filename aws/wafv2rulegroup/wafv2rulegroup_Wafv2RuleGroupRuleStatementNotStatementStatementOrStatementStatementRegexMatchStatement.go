...
type Wafv2RuleGroupRuleStatementNotStatementStatementOrStatementStatementRegexMatchStatement struct {
	...
	FieldToMatch *Wafv2RuleGroupRuleStatementNotStatementStatementOrStatementStatementRegexMatchStatementFieldToMatch `field:"optional" json:"fieldToMatch" yaml:"fieldToMatch"`
}
