...
func (w *jsiiProxy_Wafv2RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesMatchPatternList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
