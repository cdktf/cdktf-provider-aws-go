...
type Wafv2RuleGroupRuleStatementNotStatementStatementRegexMatchStatement struct {
	...
	FieldToMatch *Wafv2RuleGroupRuleStatementNotStatementStatementRegexMatchStatementFieldToMatch `field:"optional" json:"fieldToMatch" yaml:"fieldToMatch"`
}
