...
type Wafv2RuleGroupRuleStatementNotStatementStatementNotStatementStatementSizeConstraintStatement struct {
	...
	FieldToMatch *Wafv2RuleGroupRuleStatementNotStatementStatementNotStatementStatementSizeConstraintStatementFieldToMatch `field:"optional" json:"fieldToMatch" yaml:"fieldToMatch"`
}
