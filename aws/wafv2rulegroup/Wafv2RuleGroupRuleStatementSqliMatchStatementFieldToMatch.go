...
type Wafv2RuleGroupRuleStatementSqliMatchStatementFieldToMatch struct {
	...
	AllQueryArguments *Wafv2RuleGroupRuleStatementSqliMatchStatementFieldToMatchAllQueryArguments `field:"optional" json:"allQueryArguments" yaml:"allQueryArguments"`
	// body block.
	//
	...
	Body *Wafv2RuleGroupRuleStatementSqliMatchStatementFieldToMatchBody `field:"optional" json:"body" yaml:"body"`
	// cookies block.
	//
	...
	Cookies *Wafv2RuleGroupRuleStatementSqliMatchStatementFieldToMatchCookies `field:"optional" json:"cookies" yaml:"cookies"`
	// headers block.
	//
	...
	Ja3Fingerprint *Wafv2RuleGroupRuleStatementSqliMatchStatementFieldToMatchJa3Fingerprint `field:"optional" json:"ja3Fingerprint" yaml:"ja3Fingerprint"`
	// json_body block.
	//
	...
	JsonBody *Wafv2RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBody `field:"optional" json:"jsonBody" yaml:"jsonBody"`
	// method block.
	//
	...
	Method *Wafv2RuleGroupRuleStatementSqliMatchStatementFieldToMatchMethod `field:"optional" json:"method" yaml:"method"`
	// query_string block.
	//
	...
	QueryString *Wafv2RuleGroupRuleStatementSqliMatchStatementFieldToMatchQueryString `field:"optional" json:"queryString" yaml:"queryString"`
	// single_header block.
	//
	...
	SingleHeader *Wafv2RuleGroupRuleStatementSqliMatchStatementFieldToMatchSingleHeader `field:"optional" json:"singleHeader" yaml:"singleHeader"`
	...
	SingleQueryArgument *Wafv2RuleGroupRuleStatementSqliMatchStatementFieldToMatchSingleQueryArgument `field:"optional" json:"singleQueryArgument" yaml:"singleQueryArgument"`
	// uri_path block.
	//
	...
	UriPath *Wafv2RuleGroupRuleStatementSqliMatchStatementFieldToMatchUriPath `field:"optional" json:"uriPath" yaml:"uriPath"`
}
