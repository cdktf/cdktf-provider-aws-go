...
type Wafv2RuleGroupRuleStatementNotStatementStatementXssMatchStatementFieldToMatch struct {
	...
	Ja3Fingerprint *Wafv2RuleGroupRuleStatementNotStatementStatementXssMatchStatementFieldToMatchJa3Fingerprint `field:"optional" json:"ja3Fingerprint" yaml:"ja3Fingerprint"`
	// json_body block.
	//
