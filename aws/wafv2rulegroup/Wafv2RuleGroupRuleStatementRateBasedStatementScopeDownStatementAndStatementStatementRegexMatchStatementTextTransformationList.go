...
func (w *jsiiProxy_Wafv2RuleGroupRuleStatementRateBasedStatementScopeDownStatementAndStatementStatementRegexMatchStatementTextTransformationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
