...
type Wafv2RuleGroupRuleStatementAndStatementStatementByteMatchStatement struct {
	...
	FieldToMatch *Wafv2RuleGroupRuleStatementAndStatementStatementByteMatchStatementFieldToMatch `field:"optional" json:"fieldToMatch" yaml:"fieldToMatch"`
}
