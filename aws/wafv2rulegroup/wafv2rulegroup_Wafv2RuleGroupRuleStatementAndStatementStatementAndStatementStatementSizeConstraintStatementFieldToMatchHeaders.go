...
type Wafv2RuleGroupRuleStatementAndStatementStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaders struct {
	// match_pattern block.
	//
	...
	MatchPattern *Wafv2RuleGroupRuleStatementAndStatementStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeadersMatchPattern `field:"required" json:"matchPattern" yaml:"matchPattern"`
