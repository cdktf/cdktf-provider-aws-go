...
import (
	...
	"github.com/hashicorp/cdktf-provider-aws-go/aws/v10/s3bucketownershipcontrols/internal"
...
func (j *jsiiProxy_S3BucketOwnershipControlsRuleOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3BucketOwnershipControlsRuleOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_S3BucketOwnershipControlsRuleOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (s *jsiiProxy_S3BucketOwnershipControlsRuleOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_S3BucketOwnershipControlsRuleOutputReference) ToString() *string {
	var returns *string
