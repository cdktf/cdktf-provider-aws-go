...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v19/fmsresourceset/internal"
...
type FmsResourceSet interface {
	...
	PutResourceSet(value interface{})
	PutTimeouts(value *FmsResourceSetTimeouts)
...
func (j *jsiiProxy_FmsResourceSet) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_FmsResourceSet) ResourceSetInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"resourceSetInput",
...
func (j *jsiiProxy_FmsResourceSet) Tags() *map[string]*string {
...
func (j *jsiiProxy_FmsResourceSet) TagsAll() cdktf.StringMap {
...
func (j *jsiiProxy_FmsResourceSet) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_FmsResourceSet) Timeouts() FmsResourceSetTimeoutsOutputReference {
	var returns FmsResourceSetTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_FmsResourceSet) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.59.0/docs/resources/fms_resource_set aws_fms_resource_set} Resource.
...
func (j *jsiiProxy_FmsResourceSet)SetTags(val *map[string]*string) {
...
func (f *jsiiProxy_FmsResourceSet) PutResourceSet(value interface{}) {
	if err := f.validatePutResourceSetParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		f,
...
func (f *jsiiProxy_FmsResourceSet) PutTimeouts(value *FmsResourceSetTimeouts) {
...
func (f *jsiiProxy_FmsResourceSet) ResetResourceSet() {
	_jsii_.InvokeVoid(
		f,
		"resetResourceSet",
		nil, // no parameters
...
func (f *jsiiProxy_FmsResourceSet) ResetTimeouts() {
	_jsii_.InvokeVoid(
		f,
		"resetTimeouts",
		nil, // no parameters
