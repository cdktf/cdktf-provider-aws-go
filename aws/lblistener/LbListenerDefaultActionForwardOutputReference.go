...
func (l *jsiiProxy_LbListenerDefaultActionForwardOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LbListenerDefaultActionForwardOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
