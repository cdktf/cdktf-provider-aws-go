...
func (c *jsiiProxy_ConnectInstanceStorageConfigStorageConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConnectInstanceStorageConfigStorageConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
