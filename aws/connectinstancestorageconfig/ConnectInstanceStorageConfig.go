...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/connect_instance_storage_config aws_connect_instance_storage_config}.
...
func (j *jsiiProxy_ConnectInstanceStorageConfig) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ConnectInstanceStorageConfig) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/connect_instance_storage_config aws_connect_instance_storage_config} Resource.
...
func (j *jsiiProxy_ConnectInstanceStorageConfig)SetRegion(val *string) {
...
func (c *jsiiProxy_ConnectInstanceStorageConfig) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
