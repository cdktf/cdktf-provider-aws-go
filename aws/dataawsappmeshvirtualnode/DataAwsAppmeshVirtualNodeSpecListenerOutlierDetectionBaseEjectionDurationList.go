...
func (d *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerOutlierDetectionBaseEjectionDurationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerOutlierDetectionBaseEjectionDurationList) Resolve(context cdktf.IResolveContext) interface{} {
