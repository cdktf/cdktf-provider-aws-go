...
func (d *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerTimeoutGrpcIdleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerTimeoutGrpcIdleList) Resolve(context cdktf.IResolveContext) interface{} {
