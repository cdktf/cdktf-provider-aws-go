...
func NewSecurityhubInsightFiltersFindingProviderFieldsSeverityLabelList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SecurityhubInsightFiltersFindingProviderFieldsSeverityLabelList {
	...
	_jsii_.Create(
		"@cdktf/provider-aws.securityhub.SecurityhubInsightFiltersFindingProviderFieldsSeverityLabelList",
...
func (s *jsiiProxy_SecurityhubInsightFiltersFindingProviderFieldsSeverityLabelList) Resolve(_context cdktf.IResolveContext) interface{} {
