...
func (j *jsiiProxy_SecurityhubMember) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SecurityhubMember) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewSecurityhubMember(scope constructs.Construct, id *string, config *SecurityhubMemberConfig) SecurityhubMember {
	...
	if err := validateNewSecurityhubMemberParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SecurityhubMember) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
