...
func (i *jsiiProxy_ImagebuilderImageWorkflowOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (i *jsiiProxy_ImagebuilderImageWorkflowOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
