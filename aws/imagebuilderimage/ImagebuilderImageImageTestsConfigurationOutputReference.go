...
func (i *jsiiProxy_ImagebuilderImageImageTestsConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_ImagebuilderImageImageTestsConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
