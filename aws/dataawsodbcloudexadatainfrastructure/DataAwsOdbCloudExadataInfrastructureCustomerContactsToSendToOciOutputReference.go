...
func (d *jsiiProxy_DataAwsOdbCloudExadataInfrastructureCustomerContactsToSendToOciOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsOdbCloudExadataInfrastructureCustomerContactsToSendToOciOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
