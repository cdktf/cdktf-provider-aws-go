...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/quicksightgroupmembership/internal"
...
func (j *jsiiProxy_QuicksightGroupMembership) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_QuicksightGroupMembership) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/resources/quicksight_group_membership aws_quicksight_group_membership} Resource.
...
func (j *jsiiProxy_QuicksightGroupMembership)SetRegion(val *string) {
...
func (q *jsiiProxy_QuicksightGroupMembership) ResetRegion() {
	_jsii_.InvokeVoid(
		q,
		"resetRegion",
		nil, // no parameters
