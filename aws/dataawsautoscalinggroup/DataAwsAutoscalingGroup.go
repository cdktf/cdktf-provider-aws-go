...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/data-sources/autoscaling_group aws_autoscaling_group}.
...
func (j *jsiiProxy_DataAwsAutoscalingGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsAutoscalingGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/data-sources/autoscaling_group aws_autoscaling_group} Data Source.
...
func (j *jsiiProxy_DataAwsAutoscalingGroup)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsAutoscalingGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
