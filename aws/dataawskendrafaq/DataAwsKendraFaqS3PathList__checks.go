...
func (d *jsiiProxy_DataAwsKendraFaqS3PathList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataAwsKendraFaqS3PathList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
