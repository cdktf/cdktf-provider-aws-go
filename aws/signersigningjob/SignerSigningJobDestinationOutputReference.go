...
func (s *jsiiProxy_SignerSigningJobDestinationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SignerSigningJobDestinationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
