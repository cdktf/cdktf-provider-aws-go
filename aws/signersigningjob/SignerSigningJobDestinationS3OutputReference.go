...
func (s *jsiiProxy_SignerSigningJobDestinationS3OutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SignerSigningJobDestinationS3OutputReference) Resolve(context cdktf.IResolveContext) interface{} {
