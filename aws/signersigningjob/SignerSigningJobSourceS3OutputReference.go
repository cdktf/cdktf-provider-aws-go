...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v12/signersigningjob/internal"
...
func (s *jsiiProxy_SignerSigningJobSourceS3OutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
