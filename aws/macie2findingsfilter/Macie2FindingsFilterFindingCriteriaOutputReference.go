...
func (m *jsiiProxy_Macie2FindingsFilterFindingCriteriaOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_Macie2FindingsFilterFindingCriteriaOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
