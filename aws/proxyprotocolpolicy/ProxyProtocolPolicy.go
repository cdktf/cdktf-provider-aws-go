...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/resources/proxy_protocol_policy aws_proxy_protocol_policy}.
...
func (j *jsiiProxy_ProxyProtocolPolicy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ProxyProtocolPolicy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/resources/proxy_protocol_policy aws_proxy_protocol_policy} Resource.
...
func (j *jsiiProxy_ProxyProtocolPolicy)SetRegion(val *string) {
...
func (p *jsiiProxy_ProxyProtocolPolicy) ResetRegion() {
	_jsii_.InvokeVoid(
		p,
		"resetRegion",
		nil, // no parameters
