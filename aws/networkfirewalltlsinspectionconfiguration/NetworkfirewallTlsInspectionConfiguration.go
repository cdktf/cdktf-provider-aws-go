...
func (j *jsiiProxy_NetworkfirewallTlsInspectionConfiguration) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_NetworkfirewallTlsInspectionConfiguration) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/networkfirewall_tls_inspection_configuration aws_networkfirewall_tls_inspection_configuration} Resource.
...
func (j *jsiiProxy_NetworkfirewallTlsInspectionConfiguration)SetRegion(val *string) {
...
func (n *jsiiProxy_NetworkfirewallTlsInspectionConfiguration) ResetRegion() {
	_jsii_.InvokeVoid(
		n,
		"resetRegion",
		nil, // no parameters
