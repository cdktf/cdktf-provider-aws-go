...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v14/vpcsecuritygroupegressrule/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.63.0/docs/resources/vpc_security_group_egress_rule aws_vpc_security_group_egress_rule} Resource.
...
func (v *jsiiProxy_VpcSecurityGroupEgressRule) ResetSecurityGroupId() {
	_jsii_.InvokeVoid(
		v,
		"resetSecurityGroupId",
		nil, // no parameters
