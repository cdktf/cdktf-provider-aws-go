...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v13/vpcsecuritygroupegressrule/internal"
...
func (j *jsiiProxy_VpcSecurityGroupEgressRule) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_VpcSecurityGroupEgressRule)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
