...
func (j *jsiiProxy_SecurityhubProductSubscription) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SecurityhubProductSubscription) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/resources/securityhub_product_subscription aws_securityhub_product_subscription} Resource.
...
func (j *jsiiProxy_SecurityhubProductSubscription)SetRegion(val *string) {
...
func (s *jsiiProxy_SecurityhubProductSubscription) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
