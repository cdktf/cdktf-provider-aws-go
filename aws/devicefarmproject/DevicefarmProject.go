...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/devicefarmproject/internal"
...
func (j *jsiiProxy_DevicefarmProject) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DevicefarmProject) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/resources/devicefarm_project aws_devicefarm_project} Resource.
...
func (j *jsiiProxy_DevicefarmProject)SetRegion(val *string) {
...
func (d *jsiiProxy_DevicefarmProject) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
