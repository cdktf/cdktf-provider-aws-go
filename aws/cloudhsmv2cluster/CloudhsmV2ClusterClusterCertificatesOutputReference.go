...
func (c *jsiiProxy_CloudhsmV2ClusterClusterCertificatesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudhsmV2ClusterClusterCertificatesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
