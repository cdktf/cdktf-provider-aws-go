...
func (j *jsiiProxy_Ec2TransitGatewayPeeringAttachment) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_Ec2TransitGatewayPeeringAttachment) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Ec2TransitGatewayPeeringAttachment) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/resources/ec2_transit_gateway_peering_attachment aws_ec2_transit_gateway_peering_attachment} Resource.
...
func (j *jsiiProxy_Ec2TransitGatewayPeeringAttachment)SetRegion(val *string) {
...
func (e *jsiiProxy_Ec2TransitGatewayPeeringAttachment) ResetRegion() {
	_jsii_.InvokeVoid(
		e,
		"resetRegion",
		nil, // no parameters
