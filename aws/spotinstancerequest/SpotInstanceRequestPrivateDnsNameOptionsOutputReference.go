...
func (s *jsiiProxy_SpotInstanceRequestPrivateDnsNameOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SpotInstanceRequestPrivateDnsNameOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
