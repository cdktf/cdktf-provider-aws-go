...
type AppmeshRouteSpecGrpcRouteTimeout struct {
	...
	// per_request block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.13.0/docs/resources/appmesh_route#per_request AppmeshRoute#per_request}
