...
type AppmeshRouteSpecGrpcRoute struct {
	...
	// retry_policy block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.17.0/docs/resources/appmesh_route#retry_policy AppmeshRoute#retry_policy}
