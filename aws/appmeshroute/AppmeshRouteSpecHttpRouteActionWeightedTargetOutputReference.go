...
func (a *jsiiProxy_AppmeshRouteSpecHttpRouteActionWeightedTargetOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppmeshRouteSpecHttpRouteActionWeightedTargetOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
