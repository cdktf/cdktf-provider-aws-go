...
func (a *jsiiProxy_AppmeshRouteSpecGrpcRouteMatchMetadataOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppmeshRouteSpecGrpcRouteMatchMetadataOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
