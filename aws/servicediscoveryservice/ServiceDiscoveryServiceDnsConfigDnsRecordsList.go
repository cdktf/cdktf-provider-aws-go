...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/servicediscoveryservice/internal"
...
func (s *jsiiProxy_ServiceDiscoveryServiceDnsConfigDnsRecordsList) Resolve(context cdktf.IResolveContext) interface{} {
