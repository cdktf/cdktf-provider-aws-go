...
func (j *jsiiProxy_ServiceDiscoveryService) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ServiceDiscoveryService) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/service_discovery_service aws_service_discovery_service} Resource.
...
func (j *jsiiProxy_ServiceDiscoveryService)SetRegion(val *string) {
...
func (s *jsiiProxy_ServiceDiscoveryService) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
