...
func (b *jsiiProxy_BedrockagentAgentActionGroupActionGroupExecutorOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BedrockagentAgentActionGroupActionGroupExecutorOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
