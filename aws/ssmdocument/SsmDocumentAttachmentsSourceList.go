...
func NewSsmDocumentAttachmentsSourceList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SsmDocumentAttachmentsSourceList {
	...
	if err := validateNewSsmDocumentAttachmentsSourceListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SsmDocumentAttachmentsSourceList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SsmDocumentAttachmentsSourceList) Resolve(context cdktf.IResolveContext) interface{} {
