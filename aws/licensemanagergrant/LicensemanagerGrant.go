...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v13/licensemanagergrant/internal"
...
func (j *jsiiProxy_LicensemanagerGrant) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_LicensemanagerGrant)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
