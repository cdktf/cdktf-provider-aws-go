...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/dataawsworkspacesimage/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/data-sources/workspaces_image aws_workspaces_image}.
...
func (j *jsiiProxy_DataAwsWorkspacesImage) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsWorkspacesImage) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/data-sources/workspaces_image aws_workspaces_image} Data Source.
...
func (j *jsiiProxy_DataAwsWorkspacesImage)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsWorkspacesImage) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
