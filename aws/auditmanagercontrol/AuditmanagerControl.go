...
func (j *jsiiProxy_AuditmanagerControl) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AuditmanagerControl) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/resources/auditmanager_control aws_auditmanager_control} Resource.
...
func (j *jsiiProxy_AuditmanagerControl)SetRegion(val *string) {
...
func (a *jsiiProxy_AuditmanagerControl) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
