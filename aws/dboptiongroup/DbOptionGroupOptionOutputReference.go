...
func (d *jsiiProxy_DbOptionGroupOptionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DbOptionGroupOptionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
