...
func (d *jsiiProxy_DataAwsAvailabilityZonesTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsAvailabilityZonesTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
