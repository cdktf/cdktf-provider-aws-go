...
func NewDataAwsAvailabilityZonesFilterOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAwsAvailabilityZonesFilterOutputReference {
	...
	if err := validateNewDataAwsAvailabilityZonesFilterOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsAvailabilityZonesFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsAvailabilityZonesFilterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
