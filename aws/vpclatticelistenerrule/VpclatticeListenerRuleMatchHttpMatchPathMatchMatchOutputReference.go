...
func (v *jsiiProxy_VpclatticeListenerRuleMatchHttpMatchPathMatchMatchOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpclatticeListenerRuleMatchHttpMatchPathMatchMatchOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
