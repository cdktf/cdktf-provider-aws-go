...
func (j *jsiiProxy_KmsExternalKey) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewKmsExternalKey(scope constructs.Construct, id *string, config *KmsExternalKeyConfig) KmsExternalKey {
	...
	if err := validateNewKmsExternalKeyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (k *jsiiProxy_KmsExternalKey) ResetId() {
	_jsii_.InvokeVoid(
		k,
		"resetId",
		nil, // no parameters
