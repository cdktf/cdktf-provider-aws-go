...
type BedrockagentPromptVariantTemplateConfigurationChatToolConfigurationTool struct {
	...
	// tool_spec block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/bedrockagent_prompt#tool_spec BedrockagentPrompt#tool_spec}
