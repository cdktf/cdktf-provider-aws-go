...
func (j *jsiiProxy_BedrockagentPromptVariantTemplateConfigurationChatMessageContentList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewBedrockagentPromptVariantTemplateConfigurationChatMessageContentList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BedrockagentPromptVariantTemplateConfigurationChatMessageContentList {
	_init_.Initialize()
...
func NewBedrockagentPromptVariantTemplateConfigurationChatMessageContentList_Override(b BedrockagentPromptVariantTemplateConfigurationChatMessageContentList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BedrockagentPromptVariantTemplateConfigurationChatMessageContentList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (b *jsiiProxy_BedrockagentPromptVariantTemplateConfigurationChatMessageContentList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BedrockagentPromptVariantTemplateConfigurationChatMessageContentList) Resolve(_context cdktf.IResolveContext) interface{} {
