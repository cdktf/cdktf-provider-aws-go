...
type DbClusterSnapshotConfig struct {
	...
	// timeouts block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.6.1/docs/resources/db_cluster_snapshot#timeouts DbClusterSnapshot#timeouts}
