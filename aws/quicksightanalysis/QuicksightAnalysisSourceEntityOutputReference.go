...
func (q *jsiiProxy_QuicksightAnalysisSourceEntityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QuicksightAnalysisSourceEntityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
