...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/data-sources/qldb_ledger aws_qldb_ledger}.
...
func (j *jsiiProxy_DataAwsQldbLedger) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsQldbLedger) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/data-sources/qldb_ledger aws_qldb_ledger} Data Source.
...
func (j *jsiiProxy_DataAwsQldbLedger)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsQldbLedger) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
