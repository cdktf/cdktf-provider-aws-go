...
func (j *jsiiProxy_AthenaDatabase) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AthenaDatabase) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/athena_database aws_athena_database} Resource.
...
func (j *jsiiProxy_AthenaDatabase)SetRegion(val *string) {
...
func (a *jsiiProxy_AthenaDatabase) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
