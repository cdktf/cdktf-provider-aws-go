...
func (c *jsiiProxy_CodedeployDeploymentConfigMinimumHealthyHostsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CodedeployDeploymentConfigMinimumHealthyHostsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
