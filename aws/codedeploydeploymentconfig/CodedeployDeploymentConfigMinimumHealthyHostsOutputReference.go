...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v16/codedeploydeploymentconfig/internal"
...
func NewCodedeployDeploymentConfigMinimumHealthyHostsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CodedeployDeploymentConfigMinimumHealthyHostsOutputReference {
	...
	if err := validateNewCodedeployDeploymentConfigMinimumHealthyHostsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
