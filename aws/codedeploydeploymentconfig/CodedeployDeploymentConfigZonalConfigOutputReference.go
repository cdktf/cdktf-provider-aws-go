...
type CodedeployDeploymentConfigZonalConfigOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *CodedeployDeploymentConfigZonalConfig
	SetInternalValue(val *CodedeployDeploymentConfigZonalConfig)
	MinimumHealthyHostsPerZone() CodedeployDeploymentConfigZonalConfigMinimumHealthyHostsPerZoneOutputReference
	MinimumHealthyHostsPerZoneInput() *CodedeployDeploymentConfigZonalConfigMinimumHealthyHostsPerZone
...
func (j *jsiiProxy_CodedeployDeploymentConfigZonalConfigOutputReference) InternalValue() *CodedeployDeploymentConfigZonalConfig {
...
func (j *jsiiProxy_CodedeployDeploymentConfigZonalConfigOutputReference) MinimumHealthyHostsPerZoneInput() *CodedeployDeploymentConfigZonalConfigMinimumHealthyHostsPerZone {
...
func (j *jsiiProxy_CodedeployDeploymentConfigZonalConfigOutputReference)SetInternalValue(val *CodedeployDeploymentConfigZonalConfig) {
