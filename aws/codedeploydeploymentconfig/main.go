...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putZonalConfig", GoMethod: "PutZonalConfig"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetZonalConfig", GoMethod: "ResetZonalConfig"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "firstZoneMonitorDurationInSeconds", GoGetter: "FirstZoneMonitorDurationInSeconds"},
			_jsii_.MemberProperty{JsiiProperty: "firstZoneMonitorDurationInSecondsInput", GoGetter: "FirstZoneMonitorDurationInSecondsInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "minimumHealthyHostsPerZone", GoGetter: "MinimumHealthyHostsPerZone"},
			_jsii_.MemberProperty{JsiiProperty: "minimumHealthyHostsPerZoneInput", GoGetter: "MinimumHealthyHostsPerZoneInput"},
			_jsii_.MemberProperty{JsiiProperty: "monitorDurationInSeconds", GoGetter: "MonitorDurationInSeconds"},
			_jsii_.MemberProperty{JsiiProperty: "monitorDurationInSecondsInput", GoGetter: "MonitorDurationInSecondsInput"},
			_jsii_.MemberMethod{JsiiMethod: "putMinimumHealthyHostsPerZone", GoMethod: "PutMinimumHealthyHostsPerZone"},
			_jsii_.MemberMethod{JsiiMethod: "resetFirstZoneMonitorDurationInSeconds", GoMethod: "ResetFirstZoneMonitorDurationInSeconds"},
			_jsii_.MemberMethod{JsiiMethod: "resetMinimumHealthyHostsPerZone", GoMethod: "ResetMinimumHealthyHostsPerZone"},
			_jsii_.MemberMethod{JsiiMethod: "resetMonitorDurationInSeconds", GoMethod: "ResetMonitorDurationInSeconds"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
