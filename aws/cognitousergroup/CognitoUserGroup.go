...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v19/cognitousergroup/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.32.0/docs/resources/cognito_user_group aws_cognito_user_group}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.32.0/docs/resources/cognito_user_group aws_cognito_user_group} Resource.
...
func CognitoUserGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCognitoUserGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func CognitoUserGroup_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCognitoUserGroup_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CognitoUserGroup_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCognitoUserGroup_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CognitoUserGroup) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CognitoUserGroup) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CognitoUserGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CognitoUserGroup) MoveFromId(id *string) {
...
func (c *jsiiProxy_CognitoUserGroup) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_CognitoUserGroup) MoveToId(id *string) {
...
func (c *jsiiProxy_CognitoUserGroup) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CognitoUserGroup) ToHclTerraform() interface{} {
	var returns interface{}
