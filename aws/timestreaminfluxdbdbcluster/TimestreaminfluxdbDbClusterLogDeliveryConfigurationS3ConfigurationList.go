...
func (j *jsiiProxy_TimestreaminfluxdbDbClusterLogDeliveryConfigurationS3ConfigurationList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_TimestreaminfluxdbDbClusterLogDeliveryConfigurationS3ConfigurationList) InternalValue() interface{} {
...
func (j *jsiiProxy_TimestreaminfluxdbDbClusterLogDeliveryConfigurationS3ConfigurationList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_TimestreaminfluxdbDbClusterLogDeliveryConfigurationS3ConfigurationList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_TimestreaminfluxdbDbClusterLogDeliveryConfigurationS3ConfigurationList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_TimestreaminfluxdbDbClusterLogDeliveryConfigurationS3ConfigurationList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_TimestreaminfluxdbDbClusterLogDeliveryConfigurationS3ConfigurationList)SetWrapsSet(val *bool) {
...
func (t *jsiiProxy_TimestreaminfluxdbDbClusterLogDeliveryConfigurationS3ConfigurationList) ComputeFqn() *string {
	var returns *string
...
func (t *jsiiProxy_TimestreaminfluxdbDbClusterLogDeliveryConfigurationS3ConfigurationList) Get(index *float64) TimestreaminfluxdbDbClusterLogDeliveryConfigurationS3ConfigurationOutputReference {
	if err := t.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns TimestreaminfluxdbDbClusterLogDeliveryConfigurationS3ConfigurationOutputReference
...
func (t *jsiiProxy_TimestreaminfluxdbDbClusterLogDeliveryConfigurationS3ConfigurationList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (t *jsiiProxy_TimestreaminfluxdbDbClusterLogDeliveryConfigurationS3ConfigurationList) ToString() *string {
	var returns *string
