...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/dataawssecretsmanagersecrets/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/data-sources/secretsmanager_secrets aws_secretsmanager_secrets}.
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecrets) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecrets) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/data-sources/secretsmanager_secrets aws_secretsmanager_secrets} Data Source.
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecrets)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecrets) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
