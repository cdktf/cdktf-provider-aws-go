...
func (d *jsiiProxy_DataAwsIdentitystoreUserPhoneNumbersList) validateGetParameters(index *float64) error {
	return nil
}

func (d *jsiiProxy_DataAwsIdentitystoreUserPhoneNumbersList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}

func (j *jsiiProxy_DataAwsIdentitystoreUserPhoneNumbersList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsIdentitystoreUserPhoneNumbersList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
