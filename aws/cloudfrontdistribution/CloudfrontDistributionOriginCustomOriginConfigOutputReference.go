...
func (c *jsiiProxy_CloudfrontDistributionOriginCustomOriginConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudfrontDistributionOriginCustomOriginConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
