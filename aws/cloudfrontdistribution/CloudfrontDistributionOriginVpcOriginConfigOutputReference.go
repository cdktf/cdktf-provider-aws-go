...
func (c *jsiiProxy_CloudfrontDistributionOriginVpcOriginConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudfrontDistributionOriginVpcOriginConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
