...
func (j *jsiiProxy_CloudfrontDistributionRestrictionsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_CloudfrontDistributionRestrictionsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudfrontDistributionRestrictionsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CloudfrontDistributionRestrictionsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewCloudfrontDistributionRestrictionsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CloudfrontDistributionRestrictionsOutputReference {
	...
	if err := validateNewCloudfrontDistributionRestrictionsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CloudfrontDistributionRestrictionsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_CloudfrontDistributionRestrictionsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (c *jsiiProxy_CloudfrontDistributionRestrictionsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_CloudfrontDistributionRestrictionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudfrontDistributionRestrictionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (c *jsiiProxy_CloudfrontDistributionRestrictionsOutputReference) ToString() *string {
	var returns *string
