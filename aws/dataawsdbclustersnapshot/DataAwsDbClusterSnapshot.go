...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/data-sources/db_cluster_snapshot aws_db_cluster_snapshot}.
...
func (j *jsiiProxy_DataAwsDbClusterSnapshot) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsDbClusterSnapshot) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/data-sources/db_cluster_snapshot aws_db_cluster_snapshot} Data Source.
...
func (j *jsiiProxy_DataAwsDbClusterSnapshot)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsDbClusterSnapshot) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
