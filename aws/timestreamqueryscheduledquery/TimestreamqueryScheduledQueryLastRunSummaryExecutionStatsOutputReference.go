...
func (t *jsiiProxy_TimestreamqueryScheduledQueryLastRunSummaryExecutionStatsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TimestreamqueryScheduledQueryLastRunSummaryExecutionStatsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
