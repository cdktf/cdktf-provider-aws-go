...
func (t *jsiiProxy_TimestreamqueryScheduledQueryLastRunSummaryQueryInsightsResponseQueryTemporalRangeMaxList) Resolve(_context cdktf.IResolveContext) interface{} {
