...
func (j *jsiiProxy_CodecommitApprovalRuleTemplateAssociation) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CodecommitApprovalRuleTemplateAssociation) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/codecommit_approval_rule_template_association aws_codecommit_approval_rule_template_association} Resource.
...
func (j *jsiiProxy_CodecommitApprovalRuleTemplateAssociation)SetRegion(val *string) {
...
func (c *jsiiProxy_CodecommitApprovalRuleTemplateAssociation) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
