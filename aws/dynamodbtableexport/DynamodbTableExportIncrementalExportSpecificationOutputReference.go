...
func (d *jsiiProxy_DynamodbTableExportIncrementalExportSpecificationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DynamodbTableExportIncrementalExportSpecificationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
