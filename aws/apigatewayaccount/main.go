...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "resetOnDelete", GoGetter: "ResetOnDelete"},
			_jsii_.MemberProperty{JsiiProperty: "resetOnDeleteInput", GoGetter: "ResetOnDeleteInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetResetOnDelete", GoMethod: "ResetResetOnDelete"},
