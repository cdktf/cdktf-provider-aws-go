...
func (c *jsiiProxy_ConnectUserHierarchyGroupHierarchyPathLevelThreeList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ConnectUserHierarchyGroupHierarchyPathLevelThreeList) Resolve(context cdktf.IResolveContext) interface{} {
