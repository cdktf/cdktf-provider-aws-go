...
func (j *jsiiProxy_RedshiftAuthenticationProfile) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_RedshiftAuthenticationProfile) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/redshift_authentication_profile aws_redshift_authentication_profile} Resource.
...
func (j *jsiiProxy_RedshiftAuthenticationProfile)SetRegion(val *string) {
...
func (r *jsiiProxy_RedshiftAuthenticationProfile) ResetRegion() {
	_jsii_.InvokeVoid(
		r,
		"resetRegion",
		nil, // no parameters
