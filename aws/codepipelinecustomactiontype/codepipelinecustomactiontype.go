...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "configurationProperty", GoGetter: "ConfigurationProperty"},
			_jsii_.MemberProperty{JsiiProperty: "configurationPropertyInput", GoGetter: "ConfigurationPropertyInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "outputArtifactDetailsInput", GoGetter: "OutputArtifactDetailsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putConfigurationProperty", GoMethod: "PutConfigurationProperty"},
			_jsii_.MemberMethod{JsiiMethod: "putInputArtifactDetails", GoMethod: "PutInputArtifactDetails"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "queryable", GoGetter: "Queryable"},
			_jsii_.MemberProperty{JsiiProperty: "queryableInput", GoGetter: "QueryableInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetQueryable", GoMethod: "ResetQueryable"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "maximumCount", GoGetter: "MaximumCount"},
			_jsii_.MemberProperty{JsiiProperty: "maximumCountInput", GoGetter: "MaximumCountInput"},
			_jsii_.MemberProperty{JsiiProperty: "minimumCount", GoGetter: "MinimumCount"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "entityUrlTemplate", GoGetter: "EntityUrlTemplate"},
			_jsii_.MemberProperty{JsiiProperty: "entityUrlTemplateInput", GoGetter: "EntityUrlTemplateInput"},
			_jsii_.MemberProperty{JsiiProperty: "executionUrlTemplate", GoGetter: "ExecutionUrlTemplate"},
			_jsii_.MemberProperty{JsiiProperty: "executionUrlTemplateInput", GoGetter: "ExecutionUrlTemplateInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetEntityUrlTemplate", GoMethod: "ResetEntityUrlTemplate"},
			_jsii_.MemberMethod{JsiiMethod: "resetExecutionUrlTemplate", GoMethod: "ResetExecutionUrlTemplate"},
			_jsii_.MemberMethod{JsiiMethod: "resetRevisionUrlTemplate", GoMethod: "ResetRevisionUrlTemplate"},
			_jsii_.MemberMethod{JsiiMethod: "resetThirdPartyConfigurationUrl", GoMethod: "ResetThirdPartyConfigurationUrl"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "revisionUrlTemplate", GoGetter: "RevisionUrlTemplate"},
			_jsii_.MemberProperty{JsiiProperty: "revisionUrlTemplateInput", GoGetter: "RevisionUrlTemplateInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberProperty{JsiiProperty: "thirdPartyConfigurationUrl", GoGetter: "ThirdPartyConfigurationUrl"},
