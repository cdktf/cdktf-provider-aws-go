...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/dynamodb_global_table aws_dynamodb_global_table}.
...
func (j *jsiiProxy_DynamodbGlobalTable) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DynamodbGlobalTable) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/dynamodb_global_table aws_dynamodb_global_table} Resource.
...
func (j *jsiiProxy_DynamodbGlobalTable)SetRegion(val *string) {
...
func (d *jsiiProxy_DynamodbGlobalTable) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
