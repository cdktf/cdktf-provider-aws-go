...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v12/ec2transitgatewayconnect/internal"
...
func (j *jsiiProxy_Ec2TransitGatewayConnect) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_Ec2TransitGatewayConnect)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
