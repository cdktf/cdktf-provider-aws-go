...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.65.0/docs/resources/macie_s3_bucket_association aws_macie_s3_bucket_association}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.65.0/docs/resources/macie_s3_bucket_association aws_macie_s3_bucket_association} Resource.
...
// Experimental.
func MacieS3BucketAssociation_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMacieS3BucketAssociation_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MacieS3BucketAssociation_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMacieS3BucketAssociation_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
