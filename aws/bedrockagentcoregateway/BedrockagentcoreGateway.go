...
type BedrockagentcoreGateway interface {
	...
	WorkloadIdentityDetails() BedrockagentcoreGatewayWorkloadIdentityDetailsList
...
func (j *jsiiProxy_BedrockagentcoreGateway) AuthorizerConfiguration() BedrockagentcoreGatewayAuthorizerConfigurationList {
	var returns BedrockagentcoreGatewayAuthorizerConfigurationList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_BedrockagentcoreGateway) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_BedrockagentcoreGateway) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_BedrockagentcoreGateway) GatewayId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"gatewayId",
...
func (j *jsiiProxy_BedrockagentcoreGateway) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BedrockagentcoreGateway) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_BedrockagentcoreGateway) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_BedrockagentcoreGateway) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_BedrockagentcoreGateway) TagsAll() cdktf.StringMap {
...
func (j *jsiiProxy_BedrockagentcoreGateway) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_BedrockagentcoreGateway) Timeouts() BedrockagentcoreGatewayTimeoutsOutputReference {
	var returns BedrockagentcoreGatewayTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_BedrockagentcoreGateway) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
func (j *jsiiProxy_BedrockagentcoreGateway) WorkloadIdentityDetails() BedrockagentcoreGatewayWorkloadIdentityDetailsList {
	var returns BedrockagentcoreGatewayWorkloadIdentityDetailsList
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/bedrockagentcore_gateway aws_bedrockagentcore_gateway} Resource.
...
func (j *jsiiProxy_BedrockagentcoreGateway)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BedrockagentcoreGateway)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BedrockagentcoreGateway)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_BedrockagentcoreGateway)SetRegion(val *string) {
...
func BedrockagentcoreGateway_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BedrockagentcoreGateway) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BedrockagentcoreGateway) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (b *jsiiProxy_BedrockagentcoreGateway) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BedrockagentcoreGateway) PutAuthorizerConfiguration(value interface{}) {
...
func (b *jsiiProxy_BedrockagentcoreGateway) PutTimeouts(value *BedrockagentcoreGatewayTimeouts) {
...
func (b *jsiiProxy_BedrockagentcoreGateway) ResetRegion() {
	_jsii_.InvokeVoid(
		b,
		"resetRegion",
		nil, // no parameters
...
func (b *jsiiProxy_BedrockagentcoreGateway) ResetTimeouts() {
	_jsii_.InvokeVoid(
		b,
		"resetTimeouts",
		nil, // no parameters
