...
func (b *jsiiProxy_BedrockagentcoreGatewayProtocolConfigurationMcpOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BedrockagentcoreGatewayProtocolConfigurationMcpOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
