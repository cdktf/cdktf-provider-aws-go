...
func (d *jsiiProxy_DataAwsMskBrokerNodesNodeInfoListStructOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsMskBrokerNodesNodeInfoListStructOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
