...
func (j *jsiiProxy_CloudwatchEventPermission) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CloudwatchEventPermission) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/cloudwatch_event_permission aws_cloudwatch_event_permission} Resource.
...
func (j *jsiiProxy_CloudwatchEventPermission)SetRegion(val *string) {
...
func (c *jsiiProxy_CloudwatchEventPermission) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
