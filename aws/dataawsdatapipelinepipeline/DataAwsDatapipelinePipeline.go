...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/data-sources/datapipeline_pipeline aws_datapipeline_pipeline}.
...
func (j *jsiiProxy_DataAwsDatapipelinePipeline) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsDatapipelinePipeline) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/data-sources/datapipeline_pipeline aws_datapipeline_pipeline} Data Source.
...
func (j *jsiiProxy_DataAwsDatapipelinePipeline)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsDatapipelinePipeline) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
