...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SagemakerMlflowTrackingServer)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "arn", GoGetter: "Arn"},
			_jsii_.MemberProperty{JsiiProperty: "artifactStoreUri", GoGetter: "ArtifactStoreUri"},
			_jsii_.MemberProperty{JsiiProperty: "artifactStoreUriInput", GoGetter: "ArtifactStoreUriInput"},
			_jsii_.MemberProperty{JsiiProperty: "automaticModelRegistration", GoGetter: "AutomaticModelRegistration"},
			_jsii_.MemberProperty{JsiiProperty: "automaticModelRegistrationInput", GoGetter: "AutomaticModelRegistrationInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "mlflowVersionInput", GoGetter: "MlflowVersionInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAutomaticModelRegistration", GoMethod: "ResetAutomaticModelRegistration"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetMlflowVersion", GoMethod: "ResetMlflowVersion"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetRegion", GoMethod: "ResetRegion"},
			_jsii_.MemberMethod{JsiiMethod: "resetTags", GoMethod: "ResetTags"},
			_jsii_.MemberMethod{JsiiMethod: "resetTagsAll", GoMethod: "ResetTagsAll"},
			_jsii_.MemberMethod{JsiiMethod: "resetTrackingServerSize", GoMethod: "ResetTrackingServerSize"},
			...
			_jsii_.MemberProperty{JsiiProperty: "trackingServerNameInput", GoGetter: "TrackingServerNameInput"},
			_jsii_.MemberProperty{JsiiProperty: "trackingServerSize", GoGetter: "TrackingServerSize"},
			_jsii_.MemberProperty{JsiiProperty: "trackingServerSizeInput", GoGetter: "TrackingServerSizeInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-aws.sagemakerMlflowTrackingServer.SagemakerMlflowTrackingServerConfig",
		reflect.TypeOf((*SagemakerMlflowTrackingServerConfig)(nil)).Elem(),
	)
}
