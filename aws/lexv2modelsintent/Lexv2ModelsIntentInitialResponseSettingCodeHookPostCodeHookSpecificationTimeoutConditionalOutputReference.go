...
func (l *jsiiProxy_Lexv2ModelsIntentInitialResponseSettingCodeHookPostCodeHookSpecificationTimeoutConditionalOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (l *jsiiProxy_Lexv2ModelsIntentInitialResponseSettingCodeHookPostCodeHookSpecificationTimeoutConditionalOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
