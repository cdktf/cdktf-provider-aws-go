...
func (l *jsiiProxy_Lexv2ModelsIntentConfirmationSettingConfirmationConditionalConditionalBranchResponseMessageGroupMessageList) Resolve(context cdktf.IResolveContext) interface{} {
