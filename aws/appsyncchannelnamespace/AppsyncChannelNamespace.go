...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/appsync_channel_namespace aws_appsync_channel_namespace}.
type AppsyncChannelNamespace interface {
	...
	HandlerConfigs() AppsyncChannelNamespaceHandlerConfigsList
	...
	PublishAuthMode() AppsyncChannelNamespacePublishAuthModeList
	PublishAuthModeInput() interface{}
	// Experimental.
	RawOverrides() interface{}
	Region() *string
	SetRegion(val *string)
	RegionInput() *string
	SubscribeAuthMode() AppsyncChannelNamespaceSubscribeAuthModeList
	SubscribeAuthModeInput() interface{}
	...
	PutHandlerConfigs(value interface{})
	PutPublishAuthMode(value interface{})
	PutSubscribeAuthMode(value interface{})
	ResetCodeHandlers()
	ResetHandlerConfigs()
	// Resets a previously passed logical Id to use the auto-generated logical id again.
	// Experimental.
	ResetOverrideLogicalId()
	ResetPublishAuthMode()
	ResetRegion()
	ResetSubscribeAuthMode()
	ResetTags()
...
func (j *jsiiProxy_AppsyncChannelNamespace) HandlerConfigs() AppsyncChannelNamespaceHandlerConfigsList {
	var returns AppsyncChannelNamespaceHandlerConfigsList
	_jsii_.Get(
		j,
		"handlerConfigs",
		&returns,
...
func (j *jsiiProxy_AppsyncChannelNamespace) PublishAuthMode() AppsyncChannelNamespacePublishAuthModeList {
	var returns AppsyncChannelNamespacePublishAuthModeList
	_jsii_.Get(
		j,
		"publishAuthMode",
		&returns,
...
func (j *jsiiProxy_AppsyncChannelNamespace) PublishAuthModeInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"publishAuthModeInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_AppsyncChannelNamespace) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AppsyncChannelNamespace) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_AppsyncChannelNamespace) SubscribeAuthMode() AppsyncChannelNamespaceSubscribeAuthModeList {
	var returns AppsyncChannelNamespaceSubscribeAuthModeList
	_jsii_.Get(
		j,
		"subscribeAuthMode",
		&returns,
...
func (j *jsiiProxy_AppsyncChannelNamespace) SubscribeAuthModeInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"subscribeAuthModeInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_AppsyncChannelNamespace) Tags() *map[string]*string {
...
func (j *jsiiProxy_AppsyncChannelNamespace) TagsAll() cdktf.StringMap {
...
func (j *jsiiProxy_AppsyncChannelNamespace) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/appsync_channel_namespace aws_appsync_channel_namespace} Resource.
...
func (j *jsiiProxy_AppsyncChannelNamespace)SetRegion(val *string) {
...
func (j *jsiiProxy_AppsyncChannelNamespace)SetTags(val *map[string]*string) {
...
func (a *jsiiProxy_AppsyncChannelNamespace) PutHandlerConfigs(value interface{}) {
...
func (a *jsiiProxy_AppsyncChannelNamespace) PutPublishAuthMode(value interface{}) {
	if err := a.validatePutPublishAuthModeParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
...
func (a *jsiiProxy_AppsyncChannelNamespace) PutSubscribeAuthMode(value interface{}) {
	if err := a.validatePutSubscribeAuthModeParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
		"putSubscribeAuthMode",
		[]interface{}{value},
	)
}
...
func (a *jsiiProxy_AppsyncChannelNamespace) ResetPublishAuthMode() {
	_jsii_.InvokeVoid(
		a,
		"resetPublishAuthMode",
		nil, // no parameters
...
func (a *jsiiProxy_AppsyncChannelNamespace) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
...
func (a *jsiiProxy_AppsyncChannelNamespace) ResetSubscribeAuthMode() {
	_jsii_.InvokeVoid(
		a,
		"resetSubscribeAuthMode",
		nil, // no parameters
