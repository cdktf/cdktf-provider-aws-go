...
func (m *jsiiProxy_Macie2ClassificationJobS3JobDefinitionBucketCriteriaIncludesAndOutputReference) validateInterpolationForAttributeParameters(terraformAttribute *string) error {
	return nil
}
...
func (m *jsiiProxy_Macie2ClassificationJobS3JobDefinitionBucketCriteriaIncludesAndOutputReference) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
