...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-aws.macie2ClassificationJob.Macie2ClassificationJobTimeouts",
		reflect.TypeOf((*Macie2ClassificationJobTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-aws.macie2ClassificationJob.Macie2ClassificationJobTimeoutsOutputReference",
