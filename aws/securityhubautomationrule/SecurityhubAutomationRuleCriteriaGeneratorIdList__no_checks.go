...
func (s *jsiiProxy_SecurityhubAutomationRuleCriteriaGeneratorIdList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_SecurityhubAutomationRuleCriteriaGeneratorIdList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_SecurityhubAutomationRuleCriteriaGeneratorIdList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
