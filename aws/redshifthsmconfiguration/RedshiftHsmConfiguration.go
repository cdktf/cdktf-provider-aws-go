...
func (j *jsiiProxy_RedshiftHsmConfiguration) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_RedshiftHsmConfiguration) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/resources/redshift_hsm_configuration aws_redshift_hsm_configuration} Resource.
...
func (j *jsiiProxy_RedshiftHsmConfiguration)SetRegion(val *string) {
...
func (r *jsiiProxy_RedshiftHsmConfiguration) ResetRegion() {
	_jsii_.InvokeVoid(
		r,
		"resetRegion",
		nil, // no parameters
