...
func (j *jsiiProxy_Macie2ClassificationJobS3JobDefinitionBucketCriteriaIncludesAndOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: *Macie2ClassificationJobS3JobDefinitionBucketCriteriaIncludesAnd, cdktf.IResolvable; received %#v (a %T)", val, val)
		}
	}
