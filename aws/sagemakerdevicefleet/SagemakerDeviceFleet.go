...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v19/sagemakerdevicefleet/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.75.0/docs/resources/sagemaker_device_fleet aws_sagemaker_device_fleet} Resource.
...
func SagemakerDeviceFleet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSagemakerDeviceFleet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SagemakerDeviceFleet) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SagemakerDeviceFleet) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SagemakerDeviceFleet) MoveFromId(id *string) {
...
func (s *jsiiProxy_SagemakerDeviceFleet) MoveToId(id *string) {
