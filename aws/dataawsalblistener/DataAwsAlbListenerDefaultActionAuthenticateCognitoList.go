...
func (d *jsiiProxy_DataAwsAlbListenerDefaultActionAuthenticateCognitoList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAlbListenerDefaultActionAuthenticateCognitoList) Resolve(context cdktf.IResolveContext) interface{} {
