...
func (v *jsiiProxy_VerifiedaccessTrustProviderSseSpecificationOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VerifiedaccessTrustProviderSseSpecificationOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
