...
func (w *jsiiProxy_WorkspaceswebDataProtectionSettingsInlineRedactionConfigurationOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WorkspaceswebDataProtectionSettingsInlineRedactionConfigurationOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
