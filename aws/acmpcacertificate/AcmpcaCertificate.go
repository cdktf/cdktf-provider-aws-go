...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/acmpcacertificate/internal"
...
func (j *jsiiProxy_AcmpcaCertificate) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_AcmpcaCertificate) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/resources/acmpca_certificate aws_acmpca_certificate} Resource.
...
func (j *jsiiProxy_AcmpcaCertificate)SetRegion(val *string) {
...
func AcmpcaCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAcmpcaCertificate_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AcmpcaCertificate) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AcmpcaCertificate) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AcmpcaCertificate) MoveFromId(id *string) {
...
func (a *jsiiProxy_AcmpcaCertificate) MoveToId(id *string) {
...
func (a *jsiiProxy_AcmpcaCertificate) ResetRegion() {
	_jsii_.InvokeVoid(
		a,
		"resetRegion",
		nil, // no parameters
