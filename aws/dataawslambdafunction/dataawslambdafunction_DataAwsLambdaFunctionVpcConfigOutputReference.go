...
import (
	...
	"github.com/hashicorp/cdktf-provider-aws-go/aws/v10/dataawslambdafunction/internal"
...
func NewDataAwsLambdaFunctionVpcConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAwsLambdaFunctionVpcConfigOutputReference {
	...
	if err := validateNewDataAwsLambdaFunctionVpcConfigOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
