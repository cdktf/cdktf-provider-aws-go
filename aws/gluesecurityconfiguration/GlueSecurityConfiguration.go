...
func (j *jsiiProxy_GlueSecurityConfiguration) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_GlueSecurityConfiguration) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/resources/glue_security_configuration aws_glue_security_configuration} Resource.
...
func (j *jsiiProxy_GlueSecurityConfiguration)SetRegion(val *string) {
...
func GlueSecurityConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGlueSecurityConfiguration_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func GlueSecurityConfiguration_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateGlueSecurityConfiguration_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func GlueSecurityConfiguration_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateGlueSecurityConfiguration_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (g *jsiiProxy_GlueSecurityConfiguration) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GlueSecurityConfiguration) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GlueSecurityConfiguration) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GlueSecurityConfiguration) MoveFromId(id *string) {
...
func (g *jsiiProxy_GlueSecurityConfiguration) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GlueSecurityConfiguration) MoveToId(id *string) {
...
func (g *jsiiProxy_GlueSecurityConfiguration) ResetRegion() {
	_jsii_.InvokeVoid(
		g,
		"resetRegion",
		nil, // no parameters
...
func (g *jsiiProxy_GlueSecurityConfiguration) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GlueSecurityConfiguration) ToHclTerraform() interface{} {
	var returns interface{}
