...
func (a *jsiiProxy_AppstreamStackApplicationSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppstreamStackApplicationSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
