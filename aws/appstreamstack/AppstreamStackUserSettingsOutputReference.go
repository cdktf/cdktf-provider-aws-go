...
func (a *jsiiProxy_AppstreamStackUserSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppstreamStackUserSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
