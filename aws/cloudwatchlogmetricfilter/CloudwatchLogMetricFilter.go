...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/cloudwatch_log_metric_filter aws_cloudwatch_log_metric_filter}.
...
func (j *jsiiProxy_CloudwatchLogMetricFilter) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_CloudwatchLogMetricFilter) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/cloudwatch_log_metric_filter aws_cloudwatch_log_metric_filter} Resource.
...
func (j *jsiiProxy_CloudwatchLogMetricFilter)SetRegion(val *string) {
...
func (c *jsiiProxy_CloudwatchLogMetricFilter) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
