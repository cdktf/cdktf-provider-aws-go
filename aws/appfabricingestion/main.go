...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AppfabricIngestion)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-aws.appfabricIngestion.AppfabricIngestionConfig",
		reflect.TypeOf((*AppfabricIngestionConfig)(nil)).Elem(),
	)
}
