...
import (
	...
	"github.com/cdktf/cdktf-provider-aws-go/aws/v21/dataawsconnectlambdafunctionassociation/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/data-sources/connect_lambda_function_association aws_connect_lambda_function_association}.
...
func (j *jsiiProxy_DataAwsConnectLambdaFunctionAssociation) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataAwsConnectLambdaFunctionAssociation) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/data-sources/connect_lambda_function_association aws_connect_lambda_function_association} Data Source.
...
func (j *jsiiProxy_DataAwsConnectLambdaFunctionAssociation)SetRegion(val *string) {
...
func (d *jsiiProxy_DataAwsConnectLambdaFunctionAssociation) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
