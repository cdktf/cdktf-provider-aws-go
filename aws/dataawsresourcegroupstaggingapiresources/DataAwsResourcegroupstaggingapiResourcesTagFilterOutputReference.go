...
func NewDataAwsResourcegroupstaggingapiResourcesTagFilterOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAwsResourcegroupstaggingapiResourcesTagFilterOutputReference {
	...
	if err := validateNewDataAwsResourcegroupstaggingapiResourcesTagFilterOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsResourcegroupstaggingapiResourcesTagFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsResourcegroupstaggingapiResourcesTagFilterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
