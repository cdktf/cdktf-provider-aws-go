...
import (
	...
	"github.com/hashicorp/cdktf-provider-aws-go/aws/v10/dataawscloudfrontdistribution/internal"
...
func NewDataAwsCloudfrontDistribution(scope constructs.Construct, id *string, config *DataAwsCloudfrontDistributionConfig) DataAwsCloudfrontDistribution {
	...
	if err := validateNewDataAwsCloudfrontDistributionParameters(scope, id, config); err != nil {
		panic(err)
	}
